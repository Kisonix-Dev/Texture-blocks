...
public class Tiles81Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_81")
	public static final Block block = null;

	public Tiles81Block(TextureBlocksModElements instance) {
		super(instance, 1431);
	}
