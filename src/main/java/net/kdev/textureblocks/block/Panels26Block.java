...
public class Panels26Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_26")
	public static final Block block = null;

	public Panels26Block(TextureBlocksModElements instance) {
		super(instance, 971);
	}
