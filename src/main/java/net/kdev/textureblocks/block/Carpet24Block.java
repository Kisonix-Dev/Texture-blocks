...
public class Carpet24Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_24")
	public static final Block block = null;

	public Carpet24Block(TextureBlocksModElements instance) {
		super(instance, 652);
	}
