...
public class Concrete35Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_35")
	public static final Block block = null;

	public Concrete35Block(TextureBlocksModElements instance) {
		super(instance, 87);
	}
