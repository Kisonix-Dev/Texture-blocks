...
public class Laminate42Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_42")
	public static final Block block = null;

	public Laminate42Block(TextureBlocksModElements instance) {
		super(instance, 698);
	}
