...
public class Concrete77Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_77")
	public static final Block block = null;

	public Concrete77Block(TextureBlocksModElements instance) {
		super(instance, 129);
	}
