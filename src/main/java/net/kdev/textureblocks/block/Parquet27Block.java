...
public class Parquet27Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_27")
	public static final Block block = null;

	public Parquet27Block(TextureBlocksModElements instance) {
		super(instance, 1062);
	}
