...
public class Wood86Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_86")
	public static final Block block = null;

	public Wood86Block(TextureBlocksModElements instance) {
		super(instance, 418);
	}
