...
public class Brick92Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_92")
	public static final Block block = null;

	public Brick92Block(TextureBlocksModElements instance) {
		super(instance, 623);
	}
