...
public class Panels31Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_31")
	public static final Block block = null;

	public Panels31Block(TextureBlocksModElements instance) {
		super(instance, 976);
	}
