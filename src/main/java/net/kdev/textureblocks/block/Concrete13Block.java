...
public class Concrete13Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_13")
	public static final Block block = null;

	public Concrete13Block(TextureBlocksModElements instance) {
		super(instance, 65);
	}
