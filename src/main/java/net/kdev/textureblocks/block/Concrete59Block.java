...
public class Concrete59Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_59")
	public static final Block block = null;

	public Concrete59Block(TextureBlocksModElements instance) {
		super(instance, 111);
	}
