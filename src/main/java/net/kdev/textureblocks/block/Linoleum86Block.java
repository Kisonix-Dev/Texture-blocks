...
public class Linoleum86Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_86")
	public static final Block block = null;

	public Linoleum86Block(TextureBlocksModElements instance) {
		super(instance, 838);
	}
