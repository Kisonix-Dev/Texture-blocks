...
public class Panels68Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_68")
	public static final Block block = null;

	public Panels68Block(TextureBlocksModElements instance) {
		super(instance, 1013);
	}
