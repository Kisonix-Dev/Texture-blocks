...
public class Tiles37Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_37")
	public static final Block block = null;

	public Tiles37Block(TextureBlocksModElements instance) {
		super(instance, 1387);
	}
