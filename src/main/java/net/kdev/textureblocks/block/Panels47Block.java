...
public class Panels47Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_47")
	public static final Block block = null;

	public Panels47Block(TextureBlocksModElements instance) {
		super(instance, 992);
	}
