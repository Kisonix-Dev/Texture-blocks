...
public class Woodenplanks21Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_21")
	public static final Block block = null;

	public Woodenplanks21Block(TextureBlocksModElements instance) {
		super(instance, 449);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_21");
		}
