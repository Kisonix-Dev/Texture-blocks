...
public class Wallpapers124Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_124")
	public static final Block block = null;

	public Wallpapers124Block(TextureBlocksModElements instance) {
		super(instance, 1251);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_124");
		}
