...
public class Marbletiles63Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_63")
	public static final Block block = null;

	public Marbletiles63Block(TextureBlocksModElements instance) {
		super(instance, 921);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_63");
		}
