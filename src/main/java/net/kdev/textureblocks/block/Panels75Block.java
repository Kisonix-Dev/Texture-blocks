...
public class Panels75Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_75")
	public static final Block block = null;

	public Panels75Block(TextureBlocksModElements instance) {
		super(instance, 1020);
	}
