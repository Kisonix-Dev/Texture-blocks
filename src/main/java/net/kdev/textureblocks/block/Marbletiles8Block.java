...
public class Marbletiles8Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_8")
	public static final Block block = null;

	public Marbletiles8Block(TextureBlocksModElements instance) {
		super(instance, 866);
	}
