...
public class Concrete82Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_82")
	public static final Block block = null;

	public Concrete82Block(TextureBlocksModElements instance) {
		super(instance, 134);
	}
