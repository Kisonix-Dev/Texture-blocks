...
public class Asphalt29Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_29_1")
	public static final Block block = null;

	public Asphalt29Block(TextureBlocksModElements instance) {
		super(instance, 32);
	}
