...
public class Marbletiles32Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_32")
	public static final Block block = null;

	public Marbletiles32Block(TextureBlocksModElements instance) {
		super(instance, 890);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_32");
		}
