...
public class Brick57Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_57")
	public static final Block block = null;

	public Brick57Block(TextureBlocksModElements instance) {
		super(instance, 588);
	}
