...
public class Marbletiles28Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_28")
	public static final Block block = null;

	public Marbletiles28Block(TextureBlocksModElements instance) {
		super(instance, 886);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_28");
		}
