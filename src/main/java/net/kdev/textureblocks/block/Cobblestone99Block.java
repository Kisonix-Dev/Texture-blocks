...
public class Cobblestone99Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_99")
	public static final Block block = null;

	public Cobblestone99Block(TextureBlocksModElements instance) {
		super(instance, 246);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_99");
		}
