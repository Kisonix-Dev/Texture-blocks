...
public class Sandstone36Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_36")
	public static final Block block = null;

	public Sandstone36Block(TextureBlocksModElements instance) {
		super(instance, 1290);
	}
