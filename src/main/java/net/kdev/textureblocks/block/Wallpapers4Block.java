...
public class Wallpapers4Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_4")
	public static final Block block = null;

	public Wallpapers4Block(TextureBlocksModElements instance) {
		super(instance, 1131);
	}
