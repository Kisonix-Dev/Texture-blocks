...
public class Asphalt6Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_6_1")
	public static final Block block = null;

	public Asphalt6Block(TextureBlocksModElements instance) {
		super(instance, 7);
	}
