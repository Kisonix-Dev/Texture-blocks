...
public class Wood38Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_38")
	public static final Block block = null;

	public Wood38Block(TextureBlocksModElements instance) {
		super(instance, 370);
	}
