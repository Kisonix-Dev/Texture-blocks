...
public class Carpet18Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_18")
	public static final Block block = null;

	public Carpet18Block(TextureBlocksModElements instance) {
		super(instance, 646);
	}
