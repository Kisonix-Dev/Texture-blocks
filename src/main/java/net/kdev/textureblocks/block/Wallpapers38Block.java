...
public class Wallpapers38Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_38")
	public static final Block block = null;

	public Wallpapers38Block(TextureBlocksModElements instance) {
		super(instance, 1165);
	}
