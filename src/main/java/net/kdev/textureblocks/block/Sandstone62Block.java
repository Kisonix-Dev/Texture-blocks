...
public class Sandstone62Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_62")
	public static final Block block = null;

	public Sandstone62Block(TextureBlocksModElements instance) {
		super(instance, 1316);
	}
