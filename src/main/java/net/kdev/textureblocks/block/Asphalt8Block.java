...
public class Asphalt8Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_8_1")
	public static final Block block = null;

	public Asphalt8Block(TextureBlocksModElements instance) {
		super(instance, 9);
	}
