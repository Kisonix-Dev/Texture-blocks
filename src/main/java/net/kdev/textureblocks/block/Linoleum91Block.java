...
public class Linoleum91Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_91")
	public static final Block block = null;

	public Linoleum91Block(TextureBlocksModElements instance) {
		super(instance, 843);
	}
