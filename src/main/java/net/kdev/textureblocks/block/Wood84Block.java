...
public class Wood84Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_84")
	public static final Block block = null;

	public Wood84Block(TextureBlocksModElements instance) {
		super(instance, 416);
	}
