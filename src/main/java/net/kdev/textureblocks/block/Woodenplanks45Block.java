...
public class Woodenplanks45Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_45")
	public static final Block block = null;

	public Woodenplanks45Block(TextureBlocksModElements instance) {
		super(instance, 473);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_45");
		}
