...
public class Linoleum88Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_88")
	public static final Block block = null;

	public Linoleum88Block(TextureBlocksModElements instance) {
		super(instance, 840);
	}
