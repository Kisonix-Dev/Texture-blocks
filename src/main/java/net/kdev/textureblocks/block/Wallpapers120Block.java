...
public class Wallpapers120Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_120")
	public static final Block block = null;

	public Wallpapers120Block(TextureBlocksModElements instance) {
		super(instance, 1247);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_120");
		}
