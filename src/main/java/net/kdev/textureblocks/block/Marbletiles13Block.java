...
public class Marbletiles13Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_13")
	public static final Block block = null;

	public Marbletiles13Block(TextureBlocksModElements instance) {
		super(instance, 871);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_13");
		}
