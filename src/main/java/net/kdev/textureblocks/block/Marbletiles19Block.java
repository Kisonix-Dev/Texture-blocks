...
public class Marbletiles19Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_19")
	public static final Block block = null;

	public Marbletiles19Block(TextureBlocksModElements instance) {
		super(instance, 877);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_19");
		}
