...
public class Wallpapers52Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_52")
	public static final Block block = null;

	public Wallpapers52Block(TextureBlocksModElements instance) {
		super(instance, 1179);
	}
