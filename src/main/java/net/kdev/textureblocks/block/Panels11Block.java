...
public class Panels11Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_11")
	public static final Block block = null;

	public Panels11Block(TextureBlocksModElements instance) {
		super(instance, 956);
	}
