...
public class Woodenplanks16Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_16")
	public static final Block block = null;

	public Woodenplanks16Block(TextureBlocksModElements instance) {
		super(instance, 444);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_16");
		}
