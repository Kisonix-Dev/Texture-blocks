...
public class Stone7Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:stone_7")
	public static final Block block = null;

	public Stone7Block(TextureBlocksModElements instance) {
		super(instance, 530);
	}
