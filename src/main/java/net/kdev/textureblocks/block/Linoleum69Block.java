...
public class Linoleum69Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_69")
	public static final Block block = null;

	public Linoleum69Block(TextureBlocksModElements instance) {
		super(instance, 821);
	}
