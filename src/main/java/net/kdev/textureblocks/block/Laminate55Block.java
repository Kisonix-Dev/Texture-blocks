...
public class Laminate55Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_55")
	public static final Block block = null;

	public Laminate55Block(TextureBlocksModElements instance) {
		super(instance, 711);
	}
