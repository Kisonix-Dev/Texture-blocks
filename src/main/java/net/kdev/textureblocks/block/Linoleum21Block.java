...
public class Linoleum21Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_21")
	public static final Block block = null;

	public Linoleum21Block(TextureBlocksModElements instance) {
		super(instance, 773);
	}
