...
public class Wallpapers3Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_3")
	public static final Block block = null;

	public Wallpapers3Block(TextureBlocksModElements instance) {
		super(instance, 1130);
	}
