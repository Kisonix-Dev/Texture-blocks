...
public class Wallpapers65Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_65")
	public static final Block block = null;

	public Wallpapers65Block(TextureBlocksModElements instance) {
		super(instance, 1192);
	}
