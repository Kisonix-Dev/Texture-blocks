...
public class Wood63Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_63")
	public static final Block block = null;

	public Wood63Block(TextureBlocksModElements instance) {
		super(instance, 395);
	}
