...
public class Asphalt48Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_48_1")
	public static final Block block = null;

	public Asphalt48Block(TextureBlocksModElements instance) {
		super(instance, 51);
	}
