...
public class Laminate67Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_67")
	public static final Block block = null;

	public Laminate67Block(TextureBlocksModElements instance) {
		super(instance, 723);
	}
