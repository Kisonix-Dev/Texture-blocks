...
public class Wood85Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_85")
	public static final Block block = null;

	public Wood85Block(TextureBlocksModElements instance) {
		super(instance, 417);
	}
