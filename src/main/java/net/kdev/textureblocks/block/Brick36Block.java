...
public class Brick36Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_36")
	public static final Block block = null;

	public Brick36Block(TextureBlocksModElements instance) {
		super(instance, 567);
	}
