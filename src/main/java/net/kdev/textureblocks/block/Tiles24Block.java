...
public class Tiles24Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_24")
	public static final Block block = null;

	public Tiles24Block(TextureBlocksModElements instance) {
		super(instance, 1374);
	}
