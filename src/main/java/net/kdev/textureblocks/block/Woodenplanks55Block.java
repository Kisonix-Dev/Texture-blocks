...
public class Woodenplanks55Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_55")
	public static final Block block = null;

	public Woodenplanks55Block(TextureBlocksModElements instance) {
		super(instance, 483);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_55");
		}
