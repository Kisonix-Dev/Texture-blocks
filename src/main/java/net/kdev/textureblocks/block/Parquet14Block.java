...
public class Parquet14Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_14")
	public static final Block block = null;

	public Parquet14Block(TextureBlocksModElements instance) {
		super(instance, 1049);
	}
