...
public class Marbletiles69Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_69")
	public static final Block block = null;

	public Marbletiles69Block(TextureBlocksModElements instance) {
		super(instance, 927);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_69");
		}
