...
public class Brick69Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_69")
	public static final Block block = null;

	public Brick69Block(TextureBlocksModElements instance) {
		super(instance, 600);
	}
