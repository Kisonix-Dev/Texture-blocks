...
public class Marbletiles80Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_80")
	public static final Block block = null;

	public Marbletiles80Block(TextureBlocksModElements instance) {
		super(instance, 938);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_80");
		}
