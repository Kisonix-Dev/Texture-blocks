...
public class Linoleum2Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_2")
	public static final Block block = null;

	public Linoleum2Block(TextureBlocksModElements instance) {
		super(instance, 754);
	}
