...
public class Brick59Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_59")
	public static final Block block = null;

	public Brick59Block(TextureBlocksModElements instance) {
		super(instance, 590);
	}
