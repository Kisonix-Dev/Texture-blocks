...
public class Linoleum4Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_4")
	public static final Block block = null;

	public Linoleum4Block(TextureBlocksModElements instance) {
		super(instance, 756);
	}
