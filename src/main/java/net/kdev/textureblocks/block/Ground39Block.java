...
public class Ground39Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_39")
	public static final Block block = null;

	public Ground39Block(TextureBlocksModElements instance) {
		super(instance, 315);
	}
