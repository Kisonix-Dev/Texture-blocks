...
public class Parquet48Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_48")
	public static final Block block = null;

	public Parquet48Block(TextureBlocksModElements instance) {
		super(instance, 1083);
	}
