...
public class Cobblestone48Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_48")
	public static final Block block = null;

	public Cobblestone48Block(TextureBlocksModElements instance) {
		super(instance, 195);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_48");
		}
