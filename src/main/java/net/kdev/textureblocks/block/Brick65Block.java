...
public class Brick65Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_65")
	public static final Block block = null;

	public Brick65Block(TextureBlocksModElements instance) {
		super(instance, 596);
	}
