...
public class Wallpapers30Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_30")
	public static final Block block = null;

	public Wallpapers30Block(TextureBlocksModElements instance) {
		super(instance, 1157);
	}
