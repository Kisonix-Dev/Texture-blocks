...
public class Cobblestone63Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_63")
	public static final Block block = null;

	public Cobblestone63Block(TextureBlocksModElements instance) {
		super(instance, 210);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_63");
		}
