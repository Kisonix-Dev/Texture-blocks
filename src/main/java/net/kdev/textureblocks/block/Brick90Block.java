...
public class Brick90Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_90")
	public static final Block block = null;

	public Brick90Block(TextureBlocksModElements instance) {
		super(instance, 621);
	}
