...
public class Linoleum78Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_78")
	public static final Block block = null;

	public Linoleum78Block(TextureBlocksModElements instance) {
		super(instance, 830);
	}
