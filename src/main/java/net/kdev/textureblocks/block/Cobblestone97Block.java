...
public class Cobblestone97Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_97")
	public static final Block block = null;

	public Cobblestone97Block(TextureBlocksModElements instance) {
		super(instance, 244);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_97");
		}
