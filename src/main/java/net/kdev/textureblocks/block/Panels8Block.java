...
public class Panels8Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_8")
	public static final Block block = null;

	public Panels8Block(TextureBlocksModElements instance) {
		super(instance, 953);
	}
