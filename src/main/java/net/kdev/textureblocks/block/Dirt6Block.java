...
public class Dirt6Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:dirt_6")
	public static final Block block = null;

	public Dirt6Block(TextureBlocksModElements instance) {
		super(instance, 328);
	}
