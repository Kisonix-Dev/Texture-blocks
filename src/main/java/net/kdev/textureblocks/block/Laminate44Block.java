...
public class Laminate44Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_44")
	public static final Block block = null;

	public Laminate44Block(TextureBlocksModElements instance) {
		super(instance, 700);
	}
