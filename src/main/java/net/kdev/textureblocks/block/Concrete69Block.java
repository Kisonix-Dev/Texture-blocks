...
public class Concrete69Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_69")
	public static final Block block = null;

	public Concrete69Block(TextureBlocksModElements instance) {
		super(instance, 121);
	}
