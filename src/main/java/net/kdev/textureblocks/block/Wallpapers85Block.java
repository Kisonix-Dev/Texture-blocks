...
public class Wallpapers85Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_85")
	public static final Block block = null;

	public Wallpapers85Block(TextureBlocksModElements instance) {
		super(instance, 1212);
	}
