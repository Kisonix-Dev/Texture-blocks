...
public class Tiles8Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_8")
	public static final Block block = null;

	public Tiles8Block(TextureBlocksModElements instance) {
		super(instance, 1358);
	}
