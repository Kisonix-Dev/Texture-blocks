...
public class Panels4Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_4")
	public static final Block block = null;

	public Panels4Block(TextureBlocksModElements instance) {
		super(instance, 949);
	}
