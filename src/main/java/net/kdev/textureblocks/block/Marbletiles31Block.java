...
public class Marbletiles31Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_31")
	public static final Block block = null;

	public Marbletiles31Block(TextureBlocksModElements instance) {
		super(instance, 889);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_31");
		}
