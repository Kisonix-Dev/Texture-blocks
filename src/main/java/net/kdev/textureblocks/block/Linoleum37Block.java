...
public class Linoleum37Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_37")
	public static final Block block = null;

	public Linoleum37Block(TextureBlocksModElements instance) {
		super(instance, 789);
	}
