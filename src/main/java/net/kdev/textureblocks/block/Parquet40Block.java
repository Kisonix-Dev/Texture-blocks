...
public class Parquet40Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_40")
	public static final Block block = null;

	public Parquet40Block(TextureBlocksModElements instance) {
		super(instance, 1075);
	}
