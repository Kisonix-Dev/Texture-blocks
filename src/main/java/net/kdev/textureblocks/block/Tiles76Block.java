...
public class Tiles76Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_76")
	public static final Block block = null;

	public Tiles76Block(TextureBlocksModElements instance) {
		super(instance, 1426);
	}
