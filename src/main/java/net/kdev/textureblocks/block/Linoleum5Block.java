...
public class Linoleum5Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_5")
	public static final Block block = null;

	public Linoleum5Block(TextureBlocksModElements instance) {
		super(instance, 757);
	}
