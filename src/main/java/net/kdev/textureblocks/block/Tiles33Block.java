...
public class Tiles33Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_33")
	public static final Block block = null;

	public Tiles33Block(TextureBlocksModElements instance) {
		super(instance, 1383);
	}
