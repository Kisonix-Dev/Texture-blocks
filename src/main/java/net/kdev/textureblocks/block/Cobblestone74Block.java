...
public class Cobblestone74Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_74")
	public static final Block block = null;

	public Cobblestone74Block(TextureBlocksModElements instance) {
		super(instance, 221);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_74");
		}
