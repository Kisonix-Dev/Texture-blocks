...
public class Wallpapers62Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_62")
	public static final Block block = null;

	public Wallpapers62Block(TextureBlocksModElements instance) {
		super(instance, 1189);
	}
