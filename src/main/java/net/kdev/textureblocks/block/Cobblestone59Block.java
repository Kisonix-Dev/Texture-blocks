...
public class Cobblestone59Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_59")
	public static final Block block = null;

	public Cobblestone59Block(TextureBlocksModElements instance) {
		super(instance, 206);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_59");
		}
