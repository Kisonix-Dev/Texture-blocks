...
public class Parquet49Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_49")
	public static final Block block = null;

	public Parquet49Block(TextureBlocksModElements instance) {
		super(instance, 1084);
	}
