...
public class Linoleum65Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_65")
	public static final Block block = null;

	public Linoleum65Block(TextureBlocksModElements instance) {
		super(instance, 817);
	}
