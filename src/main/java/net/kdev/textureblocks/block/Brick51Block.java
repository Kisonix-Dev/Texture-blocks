...
public class Brick51Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_51")
	public static final Block block = null;

	public Brick51Block(TextureBlocksModElements instance) {
		super(instance, 582);
	}
