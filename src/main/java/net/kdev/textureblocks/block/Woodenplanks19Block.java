...
public class Woodenplanks19Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_19")
	public static final Block block = null;

	public Woodenplanks19Block(TextureBlocksModElements instance) {
		super(instance, 447);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_19");
		}
