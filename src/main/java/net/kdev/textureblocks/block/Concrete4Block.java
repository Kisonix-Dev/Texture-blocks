...
public class Concrete4Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_4")
	public static final Block block = null;

	public Concrete4Block(TextureBlocksModElements instance) {
		super(instance, 56);
	}
