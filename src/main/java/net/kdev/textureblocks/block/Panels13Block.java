...
public class Panels13Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_13")
	public static final Block block = null;

	public Panels13Block(TextureBlocksModElements instance) {
		super(instance, 958);
	}
