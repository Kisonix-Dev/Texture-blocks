...
public class Ground7Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_7")
	public static final Block block = null;

	public Ground7Block(TextureBlocksModElements instance) {
		super(instance, 283);
	}
