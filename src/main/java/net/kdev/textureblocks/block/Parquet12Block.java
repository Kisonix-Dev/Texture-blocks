...
public class Parquet12Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_12")
	public static final Block block = null;

	public Parquet12Block(TextureBlocksModElements instance) {
		super(instance, 1047);
	}
