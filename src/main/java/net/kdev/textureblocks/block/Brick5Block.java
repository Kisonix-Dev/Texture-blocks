...
public class Brick5Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_5")
	public static final Block block = null;

	public Brick5Block(TextureBlocksModElements instance) {
		super(instance, 536);
	}
