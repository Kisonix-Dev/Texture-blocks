...
public class Marbletiles6Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_6")
	public static final Block block = null;

	public Marbletiles6Block(TextureBlocksModElements instance) {
		super(instance, 864);
	}
