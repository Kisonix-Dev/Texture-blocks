...
public class Cobblestone26Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_26")
	public static final Block block = null;

	public Cobblestone26Block(TextureBlocksModElements instance) {
		super(instance, 173);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_26");
		}
