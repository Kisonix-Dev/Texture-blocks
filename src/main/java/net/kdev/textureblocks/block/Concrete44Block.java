...
public class Concrete44Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_44")
	public static final Block block = null;

	public Concrete44Block(TextureBlocksModElements instance) {
		super(instance, 96);
	}
