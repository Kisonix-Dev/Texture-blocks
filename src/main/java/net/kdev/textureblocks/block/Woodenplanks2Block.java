...
public class Woodenplanks2Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_2")
	public static final Block block = null;

	public Woodenplanks2Block(TextureBlocksModElements instance) {
		super(instance, 430);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_2");
		}
