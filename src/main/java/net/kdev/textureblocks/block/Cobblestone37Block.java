...
public class Cobblestone37Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_37")
	public static final Block block = null;

	public Cobblestone37Block(TextureBlocksModElements instance) {
		super(instance, 184);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_37");
		}
