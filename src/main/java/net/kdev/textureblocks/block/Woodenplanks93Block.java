...
public class Woodenplanks93Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_93")
	public static final Block block = null;

	public Woodenplanks93Block(TextureBlocksModElements instance) {
		super(instance, 521);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_93");
		}
