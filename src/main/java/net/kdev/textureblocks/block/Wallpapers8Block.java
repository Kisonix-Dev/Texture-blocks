...
public class Wallpapers8Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_8")
	public static final Block block = null;

	public Wallpapers8Block(TextureBlocksModElements instance) {
		super(instance, 1135);
	}
