...
public class Concrete14Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_14")
	public static final Block block = null;

	public Concrete14Block(TextureBlocksModElements instance) {
		super(instance, 66);
	}
