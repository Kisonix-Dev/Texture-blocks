...
public class Ground21Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_21")
	public static final Block block = null;

	public Ground21Block(TextureBlocksModElements instance) {
		super(instance, 297);
	}
