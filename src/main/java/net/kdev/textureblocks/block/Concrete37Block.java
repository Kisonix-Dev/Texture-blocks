...
public class Concrete37Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_37")
	public static final Block block = null;

	public Concrete37Block(TextureBlocksModElements instance) {
		super(instance, 89);
	}
