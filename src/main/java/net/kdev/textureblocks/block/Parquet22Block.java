...
public class Parquet22Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_22")
	public static final Block block = null;

	public Parquet22Block(TextureBlocksModElements instance) {
		super(instance, 1057);
	}
