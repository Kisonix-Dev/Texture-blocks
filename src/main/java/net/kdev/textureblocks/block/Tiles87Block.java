...
public class Tiles87Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_87")
	public static final Block block = null;

	public Tiles87Block(TextureBlocksModElements instance) {
		super(instance, 1437);
	}
