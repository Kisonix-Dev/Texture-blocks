...
public class Concrete54Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_54")
	public static final Block block = null;

	public Concrete54Block(TextureBlocksModElements instance) {
		super(instance, 106);
	}
