...
public class Parquet26Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_26")
	public static final Block block = null;

	public Parquet26Block(TextureBlocksModElements instance) {
		super(instance, 1061);
	}
