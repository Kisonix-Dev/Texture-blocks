...
public class Concrete83Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_83")
	public static final Block block = null;

	public Concrete83Block(TextureBlocksModElements instance) {
		super(instance, 135);
	}
