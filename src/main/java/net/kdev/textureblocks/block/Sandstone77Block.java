...
public class Sandstone77Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_77")
	public static final Block block = null;

	public Sandstone77Block(TextureBlocksModElements instance) {
		super(instance, 1331);
	}
