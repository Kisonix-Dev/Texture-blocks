...
public class Tiles21Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_21")
	public static final Block block = null;

	public Tiles21Block(TextureBlocksModElements instance) {
		super(instance, 1371);
	}
