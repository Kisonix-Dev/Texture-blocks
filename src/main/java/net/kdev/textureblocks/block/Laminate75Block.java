...
public class Laminate75Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_75")
	public static final Block block = null;

	public Laminate75Block(TextureBlocksModElements instance) {
		super(instance, 731);
	}
