...
public class Linoleum62Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_62")
	public static final Block block = null;

	public Linoleum62Block(TextureBlocksModElements instance) {
		super(instance, 814);
	}
