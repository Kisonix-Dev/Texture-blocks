...
public class Linoleum36Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_36")
	public static final Block block = null;

	public Linoleum36Block(TextureBlocksModElements instance) {
		super(instance, 788);
	}
