...
public class Stone3Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:stone_3")
	public static final Block block = null;

	public Stone3Block(TextureBlocksModElements instance) {
		super(instance, 526);
	}
