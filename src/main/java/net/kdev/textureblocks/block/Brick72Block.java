...
public class Brick72Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_72")
	public static final Block block = null;

	public Brick72Block(TextureBlocksModElements instance) {
		super(instance, 603);
	}
