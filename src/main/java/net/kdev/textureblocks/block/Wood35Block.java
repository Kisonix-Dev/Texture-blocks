...
public class Wood35Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_35")
	public static final Block block = null;

	public Wood35Block(TextureBlocksModElements instance) {
		super(instance, 367);
	}
