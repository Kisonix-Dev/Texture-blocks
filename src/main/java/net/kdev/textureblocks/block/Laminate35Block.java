...
public class Laminate35Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_35")
	public static final Block block = null;

	public Laminate35Block(TextureBlocksModElements instance) {
		super(instance, 691);
	}
