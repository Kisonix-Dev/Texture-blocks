...
public class Sandstone28Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_28")
	public static final Block block = null;

	public Sandstone28Block(TextureBlocksModElements instance) {
		super(instance, 1282);
	}
