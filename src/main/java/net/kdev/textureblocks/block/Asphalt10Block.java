...
public class Asphalt10Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_10_1")
	public static final Block block = null;

	public Asphalt10Block(TextureBlocksModElements instance) {
		super(instance, 11);
	}
