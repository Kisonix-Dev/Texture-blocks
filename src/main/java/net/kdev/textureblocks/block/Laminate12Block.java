...
public class Laminate12Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_12")
	public static final Block block = null;

	public Laminate12Block(TextureBlocksModElements instance) {
		super(instance, 668);
	}
