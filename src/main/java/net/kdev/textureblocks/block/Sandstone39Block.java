...
public class Sandstone39Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_39")
	public static final Block block = null;

	public Sandstone39Block(TextureBlocksModElements instance) {
		super(instance, 1293);
	}
