...
public class Wood50Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_50")
	public static final Block block = null;

	public Wood50Block(TextureBlocksModElements instance) {
		super(instance, 382);
	}
