...
public class Tiles72Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_72")
	public static final Block block = null;

	public Tiles72Block(TextureBlocksModElements instance) {
		super(instance, 1422);
	}
