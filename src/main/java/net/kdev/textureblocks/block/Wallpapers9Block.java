...
public class Wallpapers9Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_9")
	public static final Block block = null;

	public Wallpapers9Block(TextureBlocksModElements instance) {
		super(instance, 1136);
	}
