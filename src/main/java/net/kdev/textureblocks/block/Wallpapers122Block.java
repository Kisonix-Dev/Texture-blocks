...
public class Wallpapers122Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_122")
	public static final Block block = null;

	public Wallpapers122Block(TextureBlocksModElements instance) {
		super(instance, 1249);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_122");
		}
