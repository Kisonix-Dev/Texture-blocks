...
public class Woodenplanks44Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_44")
	public static final Block block = null;

	public Woodenplanks44Block(TextureBlocksModElements instance) {
		super(instance, 472);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_44");
		}
