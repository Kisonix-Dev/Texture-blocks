...
public class Brick44Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_44")
	public static final Block block = null;

	public Brick44Block(TextureBlocksModElements instance) {
		super(instance, 575);
	}
