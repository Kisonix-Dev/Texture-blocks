...
public class Dirt8Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:dirt_8")
	public static final Block block = null;

	public Dirt8Block(TextureBlocksModElements instance) {
		super(instance, 330);
	}
