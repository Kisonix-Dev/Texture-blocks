...
public class Laminate39Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_39")
	public static final Block block = null;

	public Laminate39Block(TextureBlocksModElements instance) {
		super(instance, 695);
	}
