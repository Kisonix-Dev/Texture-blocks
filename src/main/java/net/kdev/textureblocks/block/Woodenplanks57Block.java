...
public class Woodenplanks57Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_57")
	public static final Block block = null;

	public Woodenplanks57Block(TextureBlocksModElements instance) {
		super(instance, 485);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_57");
		}
