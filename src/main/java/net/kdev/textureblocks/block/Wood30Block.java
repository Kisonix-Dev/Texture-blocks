...
public class Wood30Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_30")
	public static final Block block = null;

	public Wood30Block(TextureBlocksModElements instance) {
		super(instance, 362);
	}
