...
public class Woodenplanks42Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_42")
	public static final Block block = null;

	public Woodenplanks42Block(TextureBlocksModElements instance) {
		super(instance, 470);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_42");
		}
