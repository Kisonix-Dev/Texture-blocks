...
public class Parquet77Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_77")
	public static final Block block = null;

	public Parquet77Block(TextureBlocksModElements instance) {
		super(instance, 1112);
	}
