...
public class Granite8Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_8")
	public static final Block block = null;

	public Granite8Block(TextureBlocksModElements instance) {
		super(instance, 254);
	}
