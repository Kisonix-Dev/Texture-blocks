...
public class Brick80Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_80")
	public static final Block block = null;

	public Brick80Block(TextureBlocksModElements instance) {
		super(instance, 611);
	}
