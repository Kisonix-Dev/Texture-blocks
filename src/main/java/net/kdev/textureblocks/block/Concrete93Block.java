...
public class Concrete93Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_93")
	public static final Block block = null;

	public Concrete93Block(TextureBlocksModElements instance) {
		super(instance, 145);
	}
