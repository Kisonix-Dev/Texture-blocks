...
public class Panels89Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_89")
	public static final Block block = null;

	public Panels89Block(TextureBlocksModElements instance) {
		super(instance, 1034);
	}
