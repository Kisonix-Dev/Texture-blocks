...
public class Sandstone89Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_89")
	public static final Block block = null;

	public Sandstone89Block(TextureBlocksModElements instance) {
		super(instance, 1343);
	}
