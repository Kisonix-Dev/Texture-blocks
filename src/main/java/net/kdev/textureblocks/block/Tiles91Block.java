...
public class Tiles91Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_91")
	public static final Block block = null;

	public Tiles91Block(TextureBlocksModElements instance) {
		super(instance, 1441);
	}
