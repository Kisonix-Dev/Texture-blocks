...
public class Ground24Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_24")
	public static final Block block = null;

	public Ground24Block(TextureBlocksModElements instance) {
		super(instance, 300);
	}
