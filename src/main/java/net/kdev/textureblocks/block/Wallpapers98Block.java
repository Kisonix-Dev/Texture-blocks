...
public class Wallpapers98Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_98")
	public static final Block block = null;

	public Wallpapers98Block(TextureBlocksModElements instance) {
		super(instance, 1225);
	}
