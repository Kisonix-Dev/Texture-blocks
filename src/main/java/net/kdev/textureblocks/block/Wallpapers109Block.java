...
public class Wallpapers109Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_109")
	public static final Block block = null;

	public Wallpapers109Block(TextureBlocksModElements instance) {
		super(instance, 1236);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_109");
		}
