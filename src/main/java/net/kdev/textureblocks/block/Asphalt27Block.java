...
public class Asphalt27Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_27_1")
	public static final Block block = null;

	public Asphalt27Block(TextureBlocksModElements instance) {
		super(instance, 30);
	}
