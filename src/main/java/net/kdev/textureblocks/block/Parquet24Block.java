...
public class Parquet24Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_24")
	public static final Block block = null;

	public Parquet24Block(TextureBlocksModElements instance) {
		super(instance, 1059);
	}
