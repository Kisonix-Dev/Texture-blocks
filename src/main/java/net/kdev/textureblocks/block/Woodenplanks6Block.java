...
public class Woodenplanks6Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_6")
	public static final Block block = null;

	public Woodenplanks6Block(TextureBlocksModElements instance) {
		super(instance, 434);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_6");
		}
