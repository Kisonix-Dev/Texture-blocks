...
public class Laminate47Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_47")
	public static final Block block = null;

	public Laminate47Block(TextureBlocksModElements instance) {
		super(instance, 703);
	}
