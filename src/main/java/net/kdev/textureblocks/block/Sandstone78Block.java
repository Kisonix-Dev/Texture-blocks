...
public class Sandstone78Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_78")
	public static final Block block = null;

	public Sandstone78Block(TextureBlocksModElements instance) {
		super(instance, 1332);
	}
