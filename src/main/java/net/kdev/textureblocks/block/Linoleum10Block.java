...
public class Linoleum10Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_10")
	public static final Block block = null;

	public Linoleum10Block(TextureBlocksModElements instance) {
		super(instance, 762);
	}
