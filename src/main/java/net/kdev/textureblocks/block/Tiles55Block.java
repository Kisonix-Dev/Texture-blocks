...
public class Tiles55Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_55")
	public static final Block block = null;

	public Tiles55Block(TextureBlocksModElements instance) {
		super(instance, 1405);
	}
