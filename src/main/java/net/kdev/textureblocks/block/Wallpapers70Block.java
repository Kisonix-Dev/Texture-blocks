...
public class Wallpapers70Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_70")
	public static final Block block = null;

	public Wallpapers70Block(TextureBlocksModElements instance) {
		super(instance, 1197);
	}
