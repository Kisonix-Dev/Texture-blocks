...
public class Brick96Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_96")
	public static final Block block = null;

	public Brick96Block(TextureBlocksModElements instance) {
		super(instance, 627);
	}
