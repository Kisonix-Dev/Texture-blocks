...
public class Wood15Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_15")
	public static final Block block = null;

	public Wood15Block(TextureBlocksModElements instance) {
		super(instance, 347);
	}
