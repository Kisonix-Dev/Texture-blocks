...
public class Marbletiles57Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_57")
	public static final Block block = null;

	public Marbletiles57Block(TextureBlocksModElements instance) {
		super(instance, 915);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_57");
		}
