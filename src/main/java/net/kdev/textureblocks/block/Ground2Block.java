...
public class Ground2Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_2")
	public static final Block block = null;

	public Ground2Block(TextureBlocksModElements instance) {
		super(instance, 278);
	}
