...
public class Cobblestone89Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_89")
	public static final Block block = null;

	public Cobblestone89Block(TextureBlocksModElements instance) {
		super(instance, 236);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_89");
		}
