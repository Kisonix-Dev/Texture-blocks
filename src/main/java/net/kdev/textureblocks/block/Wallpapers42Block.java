...
public class Wallpapers42Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_42")
	public static final Block block = null;

	public Wallpapers42Block(TextureBlocksModElements instance) {
		super(instance, 1169);
	}
