...
public class Parquet29Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_29")
	public static final Block block = null;

	public Parquet29Block(TextureBlocksModElements instance) {
		super(instance, 1064);
	}
