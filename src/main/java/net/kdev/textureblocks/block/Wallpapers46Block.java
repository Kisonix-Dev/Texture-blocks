...
public class Wallpapers46Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_46")
	public static final Block block = null;

	public Wallpapers46Block(TextureBlocksModElements instance) {
		super(instance, 1173);
	}
