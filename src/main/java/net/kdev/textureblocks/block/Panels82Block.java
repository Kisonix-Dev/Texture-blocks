...
public class Panels82Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_82")
	public static final Block block = null;

	public Panels82Block(TextureBlocksModElements instance) {
		super(instance, 1027);
	}
