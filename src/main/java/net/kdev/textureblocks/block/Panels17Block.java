...
public class Panels17Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_17")
	public static final Block block = null;

	public Panels17Block(TextureBlocksModElements instance) {
		super(instance, 962);
	}
