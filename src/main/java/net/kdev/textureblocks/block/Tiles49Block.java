...
public class Tiles49Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_49")
	public static final Block block = null;

	public Tiles49Block(TextureBlocksModElements instance) {
		super(instance, 1399);
	}
