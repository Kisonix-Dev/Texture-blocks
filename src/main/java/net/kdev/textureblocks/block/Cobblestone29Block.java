...
public class Cobblestone29Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_29")
	public static final Block block = null;

	public Cobblestone29Block(TextureBlocksModElements instance) {
		super(instance, 176);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_29");
		}
