...
public class Wood12Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_12")
	public static final Block block = null;

	public Wood12Block(TextureBlocksModElements instance) {
		super(instance, 344);
	}
