...
public class Parquet84Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_84")
	public static final Block block = null;

	public Parquet84Block(TextureBlocksModElements instance) {
		super(instance, 1119);
	}
