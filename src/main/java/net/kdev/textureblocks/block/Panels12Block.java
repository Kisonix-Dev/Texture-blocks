...
public class Panels12Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_12")
	public static final Block block = null;

	public Panels12Block(TextureBlocksModElements instance) {
		super(instance, 957);
	}
