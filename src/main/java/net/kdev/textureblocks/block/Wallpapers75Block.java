...
public class Wallpapers75Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_75")
	public static final Block block = null;

	public Wallpapers75Block(TextureBlocksModElements instance) {
		super(instance, 1202);
	}
