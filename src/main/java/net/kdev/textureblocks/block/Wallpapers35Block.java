...
public class Wallpapers35Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_35")
	public static final Block block = null;

	public Wallpapers35Block(TextureBlocksModElements instance) {
		super(instance, 1162);
	}
