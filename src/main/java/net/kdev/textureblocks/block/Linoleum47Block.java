...
public class Linoleum47Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_47")
	public static final Block block = null;

	public Linoleum47Block(TextureBlocksModElements instance) {
		super(instance, 799);
	}
