...
public class Wood45Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_45")
	public static final Block block = null;

	public Wood45Block(TextureBlocksModElements instance) {
		super(instance, 377);
	}
