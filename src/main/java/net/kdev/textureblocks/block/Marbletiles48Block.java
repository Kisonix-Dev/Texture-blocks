...
public class Marbletiles48Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_48")
	public static final Block block = null;

	public Marbletiles48Block(TextureBlocksModElements instance) {
		super(instance, 906);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_48");
		}
