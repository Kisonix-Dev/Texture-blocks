...
public class Wallpapers80Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_80")
	public static final Block block = null;

	public Wallpapers80Block(TextureBlocksModElements instance) {
		super(instance, 1207);
	}
