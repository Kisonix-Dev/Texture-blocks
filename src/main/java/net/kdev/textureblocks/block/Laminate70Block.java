...
public class Laminate70Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_70")
	public static final Block block = null;

	public Laminate70Block(TextureBlocksModElements instance) {
		super(instance, 726);
	}
