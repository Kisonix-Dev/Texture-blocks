...
public class Cobblestone75Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_75")
	public static final Block block = null;

	public Cobblestone75Block(TextureBlocksModElements instance) {
		super(instance, 222);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_75");
		}
