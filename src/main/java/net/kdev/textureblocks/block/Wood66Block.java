...
public class Wood66Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_66")
	public static final Block block = null;

	public Wood66Block(TextureBlocksModElements instance) {
		super(instance, 398);
	}
