...
public class Marbletiles61Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_61")
	public static final Block block = null;

	public Marbletiles61Block(TextureBlocksModElements instance) {
		super(instance, 919);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_61");
		}
