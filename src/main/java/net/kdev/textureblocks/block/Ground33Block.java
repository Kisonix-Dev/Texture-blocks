...
public class Ground33Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_33")
	public static final Block block = null;

	public Ground33Block(TextureBlocksModElements instance) {
		super(instance, 309);
	}
