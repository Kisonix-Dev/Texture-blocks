...
public class Marbletiles17Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_17")
	public static final Block block = null;

	public Marbletiles17Block(TextureBlocksModElements instance) {
		super(instance, 875);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_17");
		}
