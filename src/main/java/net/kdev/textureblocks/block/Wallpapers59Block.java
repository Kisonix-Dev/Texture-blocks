...
public class Wallpapers59Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_59")
	public static final Block block = null;

	public Wallpapers59Block(TextureBlocksModElements instance) {
		super(instance, 1186);
	}
