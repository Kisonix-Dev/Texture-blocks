...
public class Laminate53Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_53")
	public static final Block block = null;

	public Laminate53Block(TextureBlocksModElements instance) {
		super(instance, 709);
	}
