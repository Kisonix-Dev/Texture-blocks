...
public class Concrete67Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_67")
	public static final Block block = null;

	public Concrete67Block(TextureBlocksModElements instance) {
		super(instance, 119);
	}
