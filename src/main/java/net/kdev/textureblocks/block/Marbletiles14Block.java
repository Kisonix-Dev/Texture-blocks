...
public class Marbletiles14Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_14")
	public static final Block block = null;

	public Marbletiles14Block(TextureBlocksModElements instance) {
		super(instance, 872);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_14");
		}
