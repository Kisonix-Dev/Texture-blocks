...
public class Carpet9Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_9")
	public static final Block block = null;

	public Carpet9Block(TextureBlocksModElements instance) {
		super(instance, 637);
	}
