...
public class Laminate31Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_31")
	public static final Block block = null;

	public Laminate31Block(TextureBlocksModElements instance) {
		super(instance, 687);
	}
