...
public class Laminate17Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_17")
	public static final Block block = null;

	public Laminate17Block(TextureBlocksModElements instance) {
		super(instance, 673);
	}
