...
public class Carpet27Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_27")
	public static final Block block = null;

	public Carpet27Block(TextureBlocksModElements instance) {
		super(instance, 655);
	}
