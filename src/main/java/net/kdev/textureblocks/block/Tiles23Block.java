...
public class Tiles23Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_23")
	public static final Block block = null;

	public Tiles23Block(TextureBlocksModElements instance) {
		super(instance, 1373);
	}
