...
public class Concrete12Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_12")
	public static final Block block = null;

	public Concrete12Block(TextureBlocksModElements instance) {
		super(instance, 64);
	}
