...
public class Carpet1Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_1")
	public static final Block block = null;

	public Carpet1Block(TextureBlocksModElements instance) {
		super(instance, 629);
	}
