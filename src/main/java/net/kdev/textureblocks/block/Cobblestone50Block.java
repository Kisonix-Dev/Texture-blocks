...
public class Cobblestone50Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_50")
	public static final Block block = null;

	public Cobblestone50Block(TextureBlocksModElements instance) {
		super(instance, 197);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_50");
		}
