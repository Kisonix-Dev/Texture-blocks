...
public class Parquet75Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_75")
	public static final Block block = null;

	public Parquet75Block(TextureBlocksModElements instance) {
		super(instance, 1110);
	}
