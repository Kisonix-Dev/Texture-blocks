...
public class Sandstone25Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_25")
	public static final Block block = null;

	public Sandstone25Block(TextureBlocksModElements instance) {
		super(instance, 1279);
	}
