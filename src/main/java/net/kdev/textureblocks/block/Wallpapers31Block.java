...
public class Wallpapers31Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_31")
	public static final Block block = null;

	public Wallpapers31Block(TextureBlocksModElements instance) {
		super(instance, 1158);
	}
