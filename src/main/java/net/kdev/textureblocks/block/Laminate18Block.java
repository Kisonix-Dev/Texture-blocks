...
public class Laminate18Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_18")
	public static final Block block = null;

	public Laminate18Block(TextureBlocksModElements instance) {
		super(instance, 674);
	}
