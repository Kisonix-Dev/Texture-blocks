...
public class Brick85Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_85")
	public static final Block block = null;

	public Brick85Block(TextureBlocksModElements instance) {
		super(instance, 616);
	}
