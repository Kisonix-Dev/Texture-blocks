...
public class Ground12Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_12")
	public static final Block block = null;

	public Ground12Block(TextureBlocksModElements instance) {
		super(instance, 288);
	}
