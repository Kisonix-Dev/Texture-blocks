...
public class Concrete90Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_90")
	public static final Block block = null;

	public Concrete90Block(TextureBlocksModElements instance) {
		super(instance, 142);
	}
