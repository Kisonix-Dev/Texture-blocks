...
public class Parquet17Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_17")
	public static final Block block = null;

	public Parquet17Block(TextureBlocksModElements instance) {
		super(instance, 1052);
	}
