...
public class Linoleum39Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_39")
	public static final Block block = null;

	public Linoleum39Block(TextureBlocksModElements instance) {
		super(instance, 791);
	}
