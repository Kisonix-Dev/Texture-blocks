...
public class Woodenplanks94Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_94")
	public static final Block block = null;

	public Woodenplanks94Block(TextureBlocksModElements instance) {
		super(instance, 522);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_94");
		}
