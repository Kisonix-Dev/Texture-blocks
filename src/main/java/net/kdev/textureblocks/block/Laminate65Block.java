...
public class Laminate65Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_65")
	public static final Block block = null;

	public Laminate65Block(TextureBlocksModElements instance) {
		super(instance, 721);
	}
