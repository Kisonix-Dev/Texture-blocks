...
public class Laminate2Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_2")
	public static final Block block = null;

	public Laminate2Block(TextureBlocksModElements instance) {
		super(instance, 658);
	}
