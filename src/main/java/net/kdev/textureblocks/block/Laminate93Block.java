...
public class Laminate93Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_93")
	public static final Block block = null;

	public Laminate93Block(TextureBlocksModElements instance) {
		super(instance, 749);
	}
