...
public class Parquet70Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_70")
	public static final Block block = null;

	public Parquet70Block(TextureBlocksModElements instance) {
		super(instance, 1105);
	}
