...
public class Concrete66Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_66")
	public static final Block block = null;

	public Concrete66Block(TextureBlocksModElements instance) {
		super(instance, 118);
	}
