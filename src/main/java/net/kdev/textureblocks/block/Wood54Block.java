...
public class Wood54Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_54")
	public static final Block block = null;

	public Wood54Block(TextureBlocksModElements instance) {
		super(instance, 386);
	}
