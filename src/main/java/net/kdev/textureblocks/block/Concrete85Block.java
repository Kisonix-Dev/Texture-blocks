...
public class Concrete85Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_85")
	public static final Block block = null;

	public Concrete85Block(TextureBlocksModElements instance) {
		super(instance, 137);
	}
