...
public class Wallpapers82Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_82")
	public static final Block block = null;

	public Wallpapers82Block(TextureBlocksModElements instance) {
		super(instance, 1209);
	}
