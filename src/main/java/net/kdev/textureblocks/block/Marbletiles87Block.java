...
public class Marbletiles87Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_87")
	public static final Block block = null;

	public Marbletiles87Block(TextureBlocksModElements instance) {
		super(instance, 945);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_87");
		}
