...
public class Cobblestone22Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_22")
	public static final Block block = null;

	public Cobblestone22Block(TextureBlocksModElements instance) {
		super(instance, 169);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_22");
		}
