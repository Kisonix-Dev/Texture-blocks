...
public class Linoleum40Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_40")
	public static final Block block = null;

	public Linoleum40Block(TextureBlocksModElements instance) {
		super(instance, 792);
	}
