...
public class Moss8Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:moss_8")
	public static final Block block = null;

	public Moss8Block(TextureBlocksModElements instance) {
		super(instance, 853);
	}
