...
public class Parquet72Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_72")
	public static final Block block = null;

	public Parquet72Block(TextureBlocksModElements instance) {
		super(instance, 1107);
	}
