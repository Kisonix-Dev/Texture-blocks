...
public class Marbletiles54Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_54")
	public static final Block block = null;

	public Marbletiles54Block(TextureBlocksModElements instance) {
		super(instance, 912);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_54");
		}
