...
public class Wallpapers1Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_1")
	public static final Block block = null;

	public Wallpapers1Block(TextureBlocksModElements instance) {
		super(instance, 1128);
	}
