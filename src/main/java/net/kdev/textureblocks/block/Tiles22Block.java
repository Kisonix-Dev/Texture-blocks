...
public class Tiles22Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_22")
	public static final Block block = null;

	public Tiles22Block(TextureBlocksModElements instance) {
		super(instance, 1372);
	}
