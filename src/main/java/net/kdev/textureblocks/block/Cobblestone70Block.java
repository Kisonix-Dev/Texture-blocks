...
public class Cobblestone70Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_70")
	public static final Block block = null;

	public Cobblestone70Block(TextureBlocksModElements instance) {
		super(instance, 217);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_70");
		}
