...
public class Concrete15Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_15")
	public static final Block block = null;

	public Concrete15Block(TextureBlocksModElements instance) {
		super(instance, 67);
	}
