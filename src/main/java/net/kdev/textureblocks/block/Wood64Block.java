...
public class Wood64Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_64")
	public static final Block block = null;

	public Wood64Block(TextureBlocksModElements instance) {
		super(instance, 396);
	}
