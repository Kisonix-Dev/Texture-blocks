...
public class Laminate73Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_73")
	public static final Block block = null;

	public Laminate73Block(TextureBlocksModElements instance) {
		super(instance, 729);
	}
