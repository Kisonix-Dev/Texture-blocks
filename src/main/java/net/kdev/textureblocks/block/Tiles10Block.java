...
public class Tiles10Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_10")
	public static final Block block = null;

	public Tiles10Block(TextureBlocksModElements instance) {
		super(instance, 1360);
	}
