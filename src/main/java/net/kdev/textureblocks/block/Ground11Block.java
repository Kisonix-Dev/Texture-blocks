...
public class Ground11Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_11")
	public static final Block block = null;

	public Ground11Block(TextureBlocksModElements instance) {
		super(instance, 287);
	}
