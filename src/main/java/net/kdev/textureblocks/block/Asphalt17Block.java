...
public class Asphalt17Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_17_1")
	public static final Block block = null;

	public Asphalt17Block(TextureBlocksModElements instance) {
		super(instance, 20);
	}
