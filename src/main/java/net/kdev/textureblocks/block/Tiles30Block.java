...
public class Tiles30Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_30")
	public static final Block block = null;

	public Tiles30Block(TextureBlocksModElements instance) {
		super(instance, 1380);
	}
