...
public class Parquet69Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_69")
	public static final Block block = null;

	public Parquet69Block(TextureBlocksModElements instance) {
		super(instance, 1104);
	}
