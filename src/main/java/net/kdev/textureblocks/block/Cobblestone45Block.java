...
public class Cobblestone45Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_45")
	public static final Block block = null;

	public Cobblestone45Block(TextureBlocksModElements instance) {
		super(instance, 192);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_45");
		}
