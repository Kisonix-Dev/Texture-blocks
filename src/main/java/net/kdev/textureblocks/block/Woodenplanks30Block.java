...
public class Woodenplanks30Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_30")
	public static final Block block = null;

	public Woodenplanks30Block(TextureBlocksModElements instance) {
		super(instance, 458);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_30");
		}
