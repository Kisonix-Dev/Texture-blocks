...
public class Marbletiles37Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_37")
	public static final Block block = null;

	public Marbletiles37Block(TextureBlocksModElements instance) {
		super(instance, 895);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_37");
		}
