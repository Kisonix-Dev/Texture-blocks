...
public class Wallpapers69Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_69")
	public static final Block block = null;

	public Wallpapers69Block(TextureBlocksModElements instance) {
		super(instance, 1196);
	}
