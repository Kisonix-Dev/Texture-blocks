...
public class Marbletiles56Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_56")
	public static final Block block = null;

	public Marbletiles56Block(TextureBlocksModElements instance) {
		super(instance, 914);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_56");
		}
