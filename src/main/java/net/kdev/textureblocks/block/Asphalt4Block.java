...
public class Asphalt4Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_4_1")
	public static final Block block = null;

	public Asphalt4Block(TextureBlocksModElements instance) {
		super(instance, 5);
	}
