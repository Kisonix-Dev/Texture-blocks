...
public class Tiles25Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_25")
	public static final Block block = null;

	public Tiles25Block(TextureBlocksModElements instance) {
		super(instance, 1375);
	}
