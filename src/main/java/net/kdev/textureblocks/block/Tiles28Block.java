...
public class Tiles28Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_28")
	public static final Block block = null;

	public Tiles28Block(TextureBlocksModElements instance) {
		super(instance, 1378);
	}
