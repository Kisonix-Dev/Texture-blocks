...
public class Cobblestone80Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_80")
	public static final Block block = null;

	public Cobblestone80Block(TextureBlocksModElements instance) {
		super(instance, 227);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_80");
		}
