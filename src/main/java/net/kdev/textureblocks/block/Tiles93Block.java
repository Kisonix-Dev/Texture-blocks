...
public class Tiles93Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_93")
	public static final Block block = null;

	public Tiles93Block(TextureBlocksModElements instance) {
		super(instance, 1443);
	}
