...
public class Wood17Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_17")
	public static final Block block = null;

	public Wood17Block(TextureBlocksModElements instance) {
		super(instance, 349);
	}
