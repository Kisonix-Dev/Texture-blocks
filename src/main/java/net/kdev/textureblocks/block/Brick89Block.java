...
public class Brick89Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_89")
	public static final Block block = null;

	public Brick89Block(TextureBlocksModElements instance) {
		super(instance, 620);
	}
