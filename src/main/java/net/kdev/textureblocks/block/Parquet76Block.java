...
public class Parquet76Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_76")
	public static final Block block = null;

	public Parquet76Block(TextureBlocksModElements instance) {
		super(instance, 1111);
	}
