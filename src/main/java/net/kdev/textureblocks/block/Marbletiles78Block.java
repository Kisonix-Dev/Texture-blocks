...
public class Marbletiles78Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_78")
	public static final Block block = null;

	public Marbletiles78Block(TextureBlocksModElements instance) {
		super(instance, 936);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_78");
		}
