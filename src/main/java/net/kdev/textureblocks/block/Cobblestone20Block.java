...
public class Cobblestone20Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_20")
	public static final Block block = null;

	public Cobblestone20Block(TextureBlocksModElements instance) {
		super(instance, 167);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_20");
		}
