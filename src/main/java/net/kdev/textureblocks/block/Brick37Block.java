...
public class Brick37Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_37")
	public static final Block block = null;

	public Brick37Block(TextureBlocksModElements instance) {
		super(instance, 568);
	}
