...
public class Carpet23Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_23")
	public static final Block block = null;

	public Carpet23Block(TextureBlocksModElements instance) {
		super(instance, 651);
	}
