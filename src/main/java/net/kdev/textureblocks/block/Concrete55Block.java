...
public class Concrete55Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_55")
	public static final Block block = null;

	public Concrete55Block(TextureBlocksModElements instance) {
		super(instance, 107);
	}
