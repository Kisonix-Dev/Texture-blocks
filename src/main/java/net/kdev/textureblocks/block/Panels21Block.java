...
public class Panels21Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_21")
	public static final Block block = null;

	public Panels21Block(TextureBlocksModElements instance) {
		super(instance, 966);
	}
