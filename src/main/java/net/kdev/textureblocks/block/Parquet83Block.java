...
public class Parquet83Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_83")
	public static final Block block = null;

	public Parquet83Block(TextureBlocksModElements instance) {
		super(instance, 1118);
	}
