...
public class Woodenplanks34Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_34")
	public static final Block block = null;

	public Woodenplanks34Block(TextureBlocksModElements instance) {
		super(instance, 462);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_34");
		}
