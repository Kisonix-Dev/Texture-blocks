...
public class Linoleum73Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_73")
	public static final Block block = null;

	public Linoleum73Block(TextureBlocksModElements instance) {
		super(instance, 825);
	}
