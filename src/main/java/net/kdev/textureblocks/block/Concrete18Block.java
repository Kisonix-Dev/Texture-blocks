...
public class Concrete18Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_18")
	public static final Block block = null;

	public Concrete18Block(TextureBlocksModElements instance) {
		super(instance, 70);
	}
