...
public class Concrete29Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_29")
	public static final Block block = null;

	public Concrete29Block(TextureBlocksModElements instance) {
		super(instance, 81);
	}
