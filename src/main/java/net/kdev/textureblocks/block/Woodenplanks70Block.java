...
public class Woodenplanks70Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_70")
	public static final Block block = null;

	public Woodenplanks70Block(TextureBlocksModElements instance) {
		super(instance, 498);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_70");
		}
