...
public class Tiles47Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_47")
	public static final Block block = null;

	public Tiles47Block(TextureBlocksModElements instance) {
		super(instance, 1397);
	}
