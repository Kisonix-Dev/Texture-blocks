...
public class Concrete78Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_78")
	public static final Block block = null;

	public Concrete78Block(TextureBlocksModElements instance) {
		super(instance, 130);
	}
