...
public class Brick40Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_40")
	public static final Block block = null;

	public Brick40Block(TextureBlocksModElements instance) {
		super(instance, 571);
	}
