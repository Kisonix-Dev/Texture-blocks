...
public class Parquet47Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_47")
	public static final Block block = null;

	public Parquet47Block(TextureBlocksModElements instance) {
		super(instance, 1082);
	}
