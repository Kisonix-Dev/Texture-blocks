...
public class Asphalt23Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_23_1")
	public static final Block block = null;

	public Asphalt23Block(TextureBlocksModElements instance) {
		super(instance, 26);
	}
