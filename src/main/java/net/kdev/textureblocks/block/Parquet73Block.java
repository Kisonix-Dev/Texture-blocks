...
public class Parquet73Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_73")
	public static final Block block = null;

	public Parquet73Block(TextureBlocksModElements instance) {
		super(instance, 1108);
	}
