...
public class Parquet34Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_34")
	public static final Block block = null;

	public Parquet34Block(TextureBlocksModElements instance) {
		super(instance, 1069);
	}
