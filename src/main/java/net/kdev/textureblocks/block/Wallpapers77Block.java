...
public class Wallpapers77Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_77")
	public static final Block block = null;

	public Wallpapers77Block(TextureBlocksModElements instance) {
		super(instance, 1204);
	}
