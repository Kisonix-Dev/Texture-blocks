...
public class Cobblestone86Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_86")
	public static final Block block = null;

	public Cobblestone86Block(TextureBlocksModElements instance) {
		super(instance, 233);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_86");
		}
