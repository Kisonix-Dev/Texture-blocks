...
public class Parquet21Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_21")
	public static final Block block = null;

	public Parquet21Block(TextureBlocksModElements instance) {
		super(instance, 1056);
	}
