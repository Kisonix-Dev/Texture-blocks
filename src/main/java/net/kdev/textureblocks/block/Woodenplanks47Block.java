...
public class Woodenplanks47Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_47")
	public static final Block block = null;

	public Woodenplanks47Block(TextureBlocksModElements instance) {
		super(instance, 475);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_47");
		}
