...
public class Brick75Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_75")
	public static final Block block = null;

	public Brick75Block(TextureBlocksModElements instance) {
		super(instance, 606);
	}
