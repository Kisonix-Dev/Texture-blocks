...
public class Marbletiles4Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_4")
	public static final Block block = null;

	public Marbletiles4Block(TextureBlocksModElements instance) {
		super(instance, 862);
	}
