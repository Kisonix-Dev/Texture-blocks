...
public class Wood27Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_27")
	public static final Block block = null;

	public Wood27Block(TextureBlocksModElements instance) {
		super(instance, 359);
	}
