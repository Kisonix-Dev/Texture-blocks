...
public class Ground6Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_6")
	public static final Block block = null;

	public Ground6Block(TextureBlocksModElements instance) {
		super(instance, 282);
	}
