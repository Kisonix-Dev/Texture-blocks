...
public class Wood33Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_33")
	public static final Block block = null;

	public Wood33Block(TextureBlocksModElements instance) {
		super(instance, 365);
	}
