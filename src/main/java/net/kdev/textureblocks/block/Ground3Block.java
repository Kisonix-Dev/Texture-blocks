...
public class Ground3Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_3")
	public static final Block block = null;

	public Ground3Block(TextureBlocksModElements instance) {
		super(instance, 279);
	}
