...
public class Woodenplanks36Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_36")
	public static final Block block = null;

	public Woodenplanks36Block(TextureBlocksModElements instance) {
		super(instance, 464);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_36");
		}
