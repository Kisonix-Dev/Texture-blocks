...
public class Panels55Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_55")
	public static final Block block = null;

	public Panels55Block(TextureBlocksModElements instance) {
		super(instance, 1000);
	}
