...
public class Woodenplanks88Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_88")
	public static final Block block = null;

	public Woodenplanks88Block(TextureBlocksModElements instance) {
		super(instance, 516);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_88");
		}
