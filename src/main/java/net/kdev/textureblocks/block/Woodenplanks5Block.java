...
public class Woodenplanks5Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_5")
	public static final Block block = null;

	public Woodenplanks5Block(TextureBlocksModElements instance) {
		super(instance, 433);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_5");
		}
