...
public class Parquet91Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_91")
	public static final Block block = null;

	public Parquet91Block(TextureBlocksModElements instance) {
		super(instance, 1126);
	}
