...
public class Wood37Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_37")
	public static final Block block = null;

	public Wood37Block(TextureBlocksModElements instance) {
		super(instance, 369);
	}
