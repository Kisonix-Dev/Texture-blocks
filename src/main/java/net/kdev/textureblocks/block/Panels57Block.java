...
public class Panels57Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_57")
	public static final Block block = null;

	public Panels57Block(TextureBlocksModElements instance) {
		super(instance, 1002);
	}
