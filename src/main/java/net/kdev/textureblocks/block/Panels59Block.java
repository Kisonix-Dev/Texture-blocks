...
public class Panels59Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_59")
	public static final Block block = null;

	public Panels59Block(TextureBlocksModElements instance) {
		super(instance, 1004);
	}
