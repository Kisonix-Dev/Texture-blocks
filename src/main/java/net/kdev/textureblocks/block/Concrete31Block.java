...
public class Concrete31Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_31")
	public static final Block block = null;

	public Concrete31Block(TextureBlocksModElements instance) {
		super(instance, 83);
	}
