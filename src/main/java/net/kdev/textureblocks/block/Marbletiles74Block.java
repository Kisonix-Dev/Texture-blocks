...
public class Marbletiles74Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_74")
	public static final Block block = null;

	public Marbletiles74Block(TextureBlocksModElements instance) {
		super(instance, 932);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_74");
		}
