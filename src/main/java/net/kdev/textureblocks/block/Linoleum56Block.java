...
public class Linoleum56Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_56")
	public static final Block block = null;

	public Linoleum56Block(TextureBlocksModElements instance) {
		super(instance, 808);
	}
