...
public class Parquet60Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_60")
	public static final Block block = null;

	public Parquet60Block(TextureBlocksModElements instance) {
		super(instance, 1095);
	}
