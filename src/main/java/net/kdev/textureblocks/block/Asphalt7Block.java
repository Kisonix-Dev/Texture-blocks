...
public class Asphalt7Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_7_1")
	public static final Block block = null;

	public Asphalt7Block(TextureBlocksModElements instance) {
		super(instance, 8);
	}
