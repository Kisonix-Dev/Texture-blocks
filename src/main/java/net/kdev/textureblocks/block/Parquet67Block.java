...
public class Parquet67Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_67")
	public static final Block block = null;

	public Parquet67Block(TextureBlocksModElements instance) {
		super(instance, 1102);
	}
