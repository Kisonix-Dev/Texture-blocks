...
public class Laminate45Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_45")
	public static final Block block = null;

	public Laminate45Block(TextureBlocksModElements instance) {
		super(instance, 701);
	}
