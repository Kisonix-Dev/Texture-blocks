...
public class Sandstone1Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_1")
	public static final Block block = null;

	public Sandstone1Block(TextureBlocksModElements instance) {
		super(instance, 1255);
	}
