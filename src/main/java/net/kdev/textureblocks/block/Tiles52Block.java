...
public class Tiles52Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_52")
	public static final Block block = null;

	public Tiles52Block(TextureBlocksModElements instance) {
		super(instance, 1402);
	}
