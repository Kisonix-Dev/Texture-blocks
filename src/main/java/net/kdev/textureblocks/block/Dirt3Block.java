...
public class Dirt3Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:dirt_3")
	public static final Block block = null;

	public Dirt3Block(TextureBlocksModElements instance) {
		super(instance, 325);
	}
