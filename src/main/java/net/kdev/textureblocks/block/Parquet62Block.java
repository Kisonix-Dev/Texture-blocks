...
public class Parquet62Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_62")
	public static final Block block = null;

	public Parquet62Block(TextureBlocksModElements instance) {
		super(instance, 1097);
	}
