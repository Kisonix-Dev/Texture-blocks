...
public class Granite27Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_27")
	public static final Block block = null;

	public Granite27Block(TextureBlocksModElements instance) {
		super(instance, 273);
	}
