...
public class Wood92Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_92")
	public static final Block block = null;

	public Wood92Block(TextureBlocksModElements instance) {
		super(instance, 424);
	}
