...
public class Cobblestone83Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_83")
	public static final Block block = null;

	public Cobblestone83Block(TextureBlocksModElements instance) {
		super(instance, 230);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_83");
		}
