...
public class Marbletiles9Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_9")
	public static final Block block = null;

	public Marbletiles9Block(TextureBlocksModElements instance) {
		super(instance, 867);
	}
