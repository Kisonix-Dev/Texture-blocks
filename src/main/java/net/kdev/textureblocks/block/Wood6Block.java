...
public class Wood6Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_6")
	public static final Block block = null;

	public Wood6Block(TextureBlocksModElements instance) {
		super(instance, 338);
	}
