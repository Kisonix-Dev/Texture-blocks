...
public class Concrete51Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_51")
	public static final Block block = null;

	public Concrete51Block(TextureBlocksModElements instance) {
		super(instance, 103);
	}
