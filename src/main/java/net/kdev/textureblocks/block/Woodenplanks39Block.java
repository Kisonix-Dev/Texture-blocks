...
public class Woodenplanks39Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_39")
	public static final Block block = null;

	public Woodenplanks39Block(TextureBlocksModElements instance) {
		super(instance, 467);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_39");
		}
