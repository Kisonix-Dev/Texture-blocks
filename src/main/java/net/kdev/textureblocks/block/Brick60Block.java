...
public class Brick60Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_60")
	public static final Block block = null;

	public Brick60Block(TextureBlocksModElements instance) {
		super(instance, 591);
	}
