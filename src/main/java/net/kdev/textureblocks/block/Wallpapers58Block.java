...
public class Wallpapers58Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_58")
	public static final Block block = null;

	public Wallpapers58Block(TextureBlocksModElements instance) {
		super(instance, 1185);
	}
