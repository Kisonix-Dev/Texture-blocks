...
public class Panels84Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_84")
	public static final Block block = null;

	public Panels84Block(TextureBlocksModElements instance) {
		super(instance, 1029);
	}
