...
public class Sandstone27Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_27")
	public static final Block block = null;

	public Sandstone27Block(TextureBlocksModElements instance) {
		super(instance, 1281);
	}
