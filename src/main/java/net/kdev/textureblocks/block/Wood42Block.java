...
public class Wood42Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_42")
	public static final Block block = null;

	public Wood42Block(TextureBlocksModElements instance) {
		super(instance, 374);
	}
