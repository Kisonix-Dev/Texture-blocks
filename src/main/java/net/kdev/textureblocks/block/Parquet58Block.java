...
public class Parquet58Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_58")
	public static final Block block = null;

	public Parquet58Block(TextureBlocksModElements instance) {
		super(instance, 1093);
	}
