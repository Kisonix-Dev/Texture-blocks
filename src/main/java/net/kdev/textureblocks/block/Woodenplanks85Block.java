...
public class Woodenplanks85Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_85")
	public static final Block block = null;

	public Woodenplanks85Block(TextureBlocksModElements instance) {
		super(instance, 513);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_85");
		}
