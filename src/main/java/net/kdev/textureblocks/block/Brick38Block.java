...
public class Brick38Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_38")
	public static final Block block = null;

	public Brick38Block(TextureBlocksModElements instance) {
		super(instance, 569);
	}
