...
public class Wood48Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_48")
	public static final Block block = null;

	public Wood48Block(TextureBlocksModElements instance) {
		super(instance, 380);
	}
