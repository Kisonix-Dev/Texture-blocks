...
public class Sandstone24Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_24")
	public static final Block block = null;

	public Sandstone24Block(TextureBlocksModElements instance) {
		super(instance, 1278);
	}
