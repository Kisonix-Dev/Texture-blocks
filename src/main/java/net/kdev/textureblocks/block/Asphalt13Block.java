...
public class Asphalt13Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_13_1")
	public static final Block block = null;

	public Asphalt13Block(TextureBlocksModElements instance) {
		super(instance, 16);
	}
