...
public class Wallpapers61Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_61")
	public static final Block block = null;

	public Wallpapers61Block(TextureBlocksModElements instance) {
		super(instance, 1188);
	}
