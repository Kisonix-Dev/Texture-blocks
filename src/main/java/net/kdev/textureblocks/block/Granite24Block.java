...
public class Granite24Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_24")
	public static final Block block = null;

	public Granite24Block(TextureBlocksModElements instance) {
		super(instance, 270);
	}
