...
public class Sandstone22Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_22")
	public static final Block block = null;

	public Sandstone22Block(TextureBlocksModElements instance) {
		super(instance, 1276);
	}
