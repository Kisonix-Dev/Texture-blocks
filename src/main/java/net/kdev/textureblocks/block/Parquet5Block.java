...
public class Parquet5Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_5")
	public static final Block block = null;

	public Parquet5Block(TextureBlocksModElements instance) {
		super(instance, 1040);
	}
