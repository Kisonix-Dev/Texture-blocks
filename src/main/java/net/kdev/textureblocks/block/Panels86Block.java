...
public class Panels86Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_86")
	public static final Block block = null;

	public Panels86Block(TextureBlocksModElements instance) {
		super(instance, 1031);
	}
