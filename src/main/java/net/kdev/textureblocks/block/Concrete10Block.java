...
public class Concrete10Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_10")
	public static final Block block = null;

	public Concrete10Block(TextureBlocksModElements instance) {
		super(instance, 62);
	}
