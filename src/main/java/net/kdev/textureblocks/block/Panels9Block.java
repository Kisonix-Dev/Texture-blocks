...
public class Panels9Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_9")
	public static final Block block = null;

	public Panels9Block(TextureBlocksModElements instance) {
		super(instance, 954);
	}
