...
public class Asphalt47Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_47_1")
	public static final Block block = null;

	public Asphalt47Block(TextureBlocksModElements instance) {
		super(instance, 50);
	}
