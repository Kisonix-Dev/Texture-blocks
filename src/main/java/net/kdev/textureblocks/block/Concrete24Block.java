...
public class Concrete24Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_24")
	public static final Block block = null;

	public Concrete24Block(TextureBlocksModElements instance) {
		super(instance, 76);
	}
