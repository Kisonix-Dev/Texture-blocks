...
public class Marbletiles2Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_2")
	public static final Block block = null;

	public Marbletiles2Block(TextureBlocksModElements instance) {
		super(instance, 860);
	}
