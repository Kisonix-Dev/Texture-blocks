...
public class Tiles64Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_64")
	public static final Block block = null;

	public Tiles64Block(TextureBlocksModElements instance) {
		super(instance, 1414);
	}
