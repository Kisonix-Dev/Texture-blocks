...
public class Wood39Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_39")
	public static final Block block = null;

	public Wood39Block(TextureBlocksModElements instance) {
		super(instance, 371);
	}
