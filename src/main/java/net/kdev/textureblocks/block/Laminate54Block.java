...
public class Laminate54Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_54")
	public static final Block block = null;

	public Laminate54Block(TextureBlocksModElements instance) {
		super(instance, 710);
	}
