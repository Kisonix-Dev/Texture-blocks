...
public class Stone2Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:stone_2")
	public static final Block block = null;

	public Stone2Block(TextureBlocksModElements instance) {
		super(instance, 525);
	}
