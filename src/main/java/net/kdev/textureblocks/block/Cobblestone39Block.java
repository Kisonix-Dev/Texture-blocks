...
public class Cobblestone39Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_39")
	public static final Block block = null;

	public Cobblestone39Block(TextureBlocksModElements instance) {
		super(instance, 186);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_39");
		}
