...
public class Marbletiles84Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_84")
	public static final Block block = null;

	public Marbletiles84Block(TextureBlocksModElements instance) {
		super(instance, 942);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_84");
		}
