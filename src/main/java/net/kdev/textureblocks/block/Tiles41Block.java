...
public class Tiles41Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_41")
	public static final Block block = null;

	public Tiles41Block(TextureBlocksModElements instance) {
		super(instance, 1391);
	}
