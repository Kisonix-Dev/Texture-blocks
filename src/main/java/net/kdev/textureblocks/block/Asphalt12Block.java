...
public class Asphalt12Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_12_1")
	public static final Block block = null;

	public Asphalt12Block(TextureBlocksModElements instance) {
		super(instance, 15);
	}
