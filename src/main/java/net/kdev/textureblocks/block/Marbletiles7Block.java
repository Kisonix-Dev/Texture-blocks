...
public class Marbletiles7Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_7")
	public static final Block block = null;

	public Marbletiles7Block(TextureBlocksModElements instance) {
		super(instance, 865);
	}
