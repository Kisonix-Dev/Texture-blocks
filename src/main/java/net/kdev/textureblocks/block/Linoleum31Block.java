...
public class Linoleum31Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_31")
	public static final Block block = null;

	public Linoleum31Block(TextureBlocksModElements instance) {
		super(instance, 783);
	}
