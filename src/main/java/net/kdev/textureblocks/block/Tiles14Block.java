...
public class Tiles14Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_14")
	public static final Block block = null;

	public Tiles14Block(TextureBlocksModElements instance) {
		super(instance, 1364);
	}
