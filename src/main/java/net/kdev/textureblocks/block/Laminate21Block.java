...
public class Laminate21Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_21")
	public static final Block block = null;

	public Laminate21Block(TextureBlocksModElements instance) {
		super(instance, 677);
	}
