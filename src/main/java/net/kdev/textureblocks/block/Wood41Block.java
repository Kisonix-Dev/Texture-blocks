...
public class Wood41Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_41")
	public static final Block block = null;

	public Wood41Block(TextureBlocksModElements instance) {
		super(instance, 373);
	}
