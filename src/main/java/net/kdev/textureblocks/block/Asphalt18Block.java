...
public class Asphalt18Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_18_1")
	public static final Block block = null;

	public Asphalt18Block(TextureBlocksModElements instance) {
		super(instance, 21);
	}
