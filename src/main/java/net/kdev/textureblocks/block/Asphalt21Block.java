...
public class Asphalt21Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_21_1")
	public static final Block block = null;

	public Asphalt21Block(TextureBlocksModElements instance) {
		super(instance, 24);
	}
