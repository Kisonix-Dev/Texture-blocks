...
public class Sandstone55Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_55")
	public static final Block block = null;

	public Sandstone55Block(TextureBlocksModElements instance) {
		super(instance, 1309);
	}
