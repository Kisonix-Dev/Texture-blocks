...
public class Panels35Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_35")
	public static final Block block = null;

	public Panels35Block(TextureBlocksModElements instance) {
		super(instance, 980);
	}
