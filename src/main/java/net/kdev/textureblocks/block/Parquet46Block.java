...
public class Parquet46Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_46")
	public static final Block block = null;

	public Parquet46Block(TextureBlocksModElements instance) {
		super(instance, 1081);
	}
