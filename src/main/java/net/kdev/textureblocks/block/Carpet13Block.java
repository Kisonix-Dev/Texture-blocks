...
public class Carpet13Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_13")
	public static final Block block = null;

	public Carpet13Block(TextureBlocksModElements instance) {
		super(instance, 641);
	}
