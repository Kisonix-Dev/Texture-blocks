...
public class Sandstone68Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_68")
	public static final Block block = null;

	public Sandstone68Block(TextureBlocksModElements instance) {
		super(instance, 1322);
	}
