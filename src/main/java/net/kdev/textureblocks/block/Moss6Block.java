...
public class Moss6Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:moss_6")
	public static final Block block = null;

	public Moss6Block(TextureBlocksModElements instance) {
		super(instance, 851);
	}
