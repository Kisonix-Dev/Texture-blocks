...
public class Linoleum32Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_32")
	public static final Block block = null;

	public Linoleum32Block(TextureBlocksModElements instance) {
		super(instance, 784);
	}
