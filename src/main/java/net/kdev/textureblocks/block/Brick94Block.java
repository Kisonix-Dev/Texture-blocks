...
public class Brick94Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_94")
	public static final Block block = null;

	public Brick94Block(TextureBlocksModElements instance) {
		super(instance, 625);
	}
