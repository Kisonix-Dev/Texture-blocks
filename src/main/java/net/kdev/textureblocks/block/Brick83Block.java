...
public class Brick83Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_83")
	public static final Block block = null;

	public Brick83Block(TextureBlocksModElements instance) {
		super(instance, 614);
	}
