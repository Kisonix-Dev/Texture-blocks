...
public class Tiles16Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_16")
	public static final Block block = null;

	public Tiles16Block(TextureBlocksModElements instance) {
		super(instance, 1366);
	}
