...
public class Sandstone69Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_69")
	public static final Block block = null;

	public Sandstone69Block(TextureBlocksModElements instance) {
		super(instance, 1323);
	}
