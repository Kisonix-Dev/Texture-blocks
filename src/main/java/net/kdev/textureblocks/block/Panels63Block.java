...
public class Panels63Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_63")
	public static final Block block = null;

	public Panels63Block(TextureBlocksModElements instance) {
		super(instance, 1008);
	}
