...
public class Woodenplanks1Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_1")
	public static final Block block = null;

	public Woodenplanks1Block(TextureBlocksModElements instance) {
		super(instance, 429);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_1");
		}
