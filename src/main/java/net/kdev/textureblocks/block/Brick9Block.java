...
public class Brick9Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_9")
	public static final Block block = null;

	public Brick9Block(TextureBlocksModElements instance) {
		super(instance, 540);
	}
