...
public class Cobblestone57Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_57")
	public static final Block block = null;

	public Cobblestone57Block(TextureBlocksModElements instance) {
		super(instance, 204);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_57");
		}
