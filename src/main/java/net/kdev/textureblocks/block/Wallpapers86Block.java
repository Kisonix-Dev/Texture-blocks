...
public class Wallpapers86Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_86")
	public static final Block block = null;

	public Wallpapers86Block(TextureBlocksModElements instance) {
		super(instance, 1213);
	}
