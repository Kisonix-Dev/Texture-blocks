...
public class Concrete43Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_43")
	public static final Block block = null;

	public Concrete43Block(TextureBlocksModElements instance) {
		super(instance, 95);
	}
