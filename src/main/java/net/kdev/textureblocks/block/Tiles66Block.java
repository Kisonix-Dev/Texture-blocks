...
public class Tiles66Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_66")
	public static final Block block = null;

	public Tiles66Block(TextureBlocksModElements instance) {
		super(instance, 1416);
	}
