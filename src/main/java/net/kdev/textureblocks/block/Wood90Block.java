...
public class Wood90Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_90")
	public static final Block block = null;

	public Wood90Block(TextureBlocksModElements instance) {
		super(instance, 422);
	}
