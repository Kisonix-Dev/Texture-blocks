...
public class Linoleum18Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_18")
	public static final Block block = null;

	public Linoleum18Block(TextureBlocksModElements instance) {
		super(instance, 770);
	}
