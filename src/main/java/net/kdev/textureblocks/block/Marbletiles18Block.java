...
public class Marbletiles18Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_18")
	public static final Block block = null;

	public Marbletiles18Block(TextureBlocksModElements instance) {
		super(instance, 876);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_18");
		}
