...
public class Sandstone52Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_52")
	public static final Block block = null;

	public Sandstone52Block(TextureBlocksModElements instance) {
		super(instance, 1306);
	}
