...
public class Woodenplanks38Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_38")
	public static final Block block = null;

	public Woodenplanks38Block(TextureBlocksModElements instance) {
		super(instance, 466);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_38");
		}
