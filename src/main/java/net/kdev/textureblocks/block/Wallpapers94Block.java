...
public class Wallpapers94Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_94")
	public static final Block block = null;

	public Wallpapers94Block(TextureBlocksModElements instance) {
		super(instance, 1221);
	}
