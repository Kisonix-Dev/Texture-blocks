...
public class Ground34Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_34")
	public static final Block block = null;

	public Ground34Block(TextureBlocksModElements instance) {
		super(instance, 310);
	}
