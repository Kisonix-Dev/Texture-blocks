...
public class Wallpapers60Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_60")
	public static final Block block = null;

	public Wallpapers60Block(TextureBlocksModElements instance) {
		super(instance, 1187);
	}
