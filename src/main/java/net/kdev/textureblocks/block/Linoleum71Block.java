...
public class Linoleum71Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_71")
	public static final Block block = null;

	public Linoleum71Block(TextureBlocksModElements instance) {
		super(instance, 823);
	}
