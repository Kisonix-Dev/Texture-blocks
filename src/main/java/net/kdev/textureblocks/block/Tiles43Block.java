...
public class Tiles43Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_43")
	public static final Block block = null;

	public Tiles43Block(TextureBlocksModElements instance) {
		super(instance, 1393);
	}
