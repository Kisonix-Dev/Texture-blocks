...
public class Sandstone11Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_11")
	public static final Block block = null;

	public Sandstone11Block(TextureBlocksModElements instance) {
		super(instance, 1265);
	}
