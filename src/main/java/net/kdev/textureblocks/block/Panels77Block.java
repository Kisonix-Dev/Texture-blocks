...
public class Panels77Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_77")
	public static final Block block = null;

	public Panels77Block(TextureBlocksModElements instance) {
		super(instance, 1022);
	}
