...
public class Panels56Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_56")
	public static final Block block = null;

	public Panels56Block(TextureBlocksModElements instance) {
		super(instance, 1001);
	}
