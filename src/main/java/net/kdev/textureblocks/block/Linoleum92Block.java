...
public class Linoleum92Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_92")
	public static final Block block = null;

	public Linoleum92Block(TextureBlocksModElements instance) {
		super(instance, 844);
	}
