...
public class Wallpapers78Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_78")
	public static final Block block = null;

	public Wallpapers78Block(TextureBlocksModElements instance) {
		super(instance, 1205);
	}
