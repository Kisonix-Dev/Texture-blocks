...
public class Wood82Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_82")
	public static final Block block = null;

	public Wood82Block(TextureBlocksModElements instance) {
		super(instance, 414);
	}
