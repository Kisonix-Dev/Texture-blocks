...
public class Woodenplanks62Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_62")
	public static final Block block = null;

	public Woodenplanks62Block(TextureBlocksModElements instance) {
		super(instance, 490);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_62");
		}
