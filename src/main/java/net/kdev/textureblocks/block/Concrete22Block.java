...
public class Concrete22Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_22")
	public static final Block block = null;

	public Concrete22Block(TextureBlocksModElements instance) {
		super(instance, 74);
	}
