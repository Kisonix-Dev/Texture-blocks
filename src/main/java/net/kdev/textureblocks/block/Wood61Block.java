...
public class Wood61Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_61")
	public static final Block block = null;

	public Wood61Block(TextureBlocksModElements instance) {
		super(instance, 393);
	}
