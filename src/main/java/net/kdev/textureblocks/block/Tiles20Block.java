...
public class Tiles20Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_20")
	public static final Block block = null;

	public Tiles20Block(TextureBlocksModElements instance) {
		super(instance, 1370);
	}
