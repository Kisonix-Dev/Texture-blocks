...
public class Concrete62Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_62")
	public static final Block block = null;

	public Concrete62Block(TextureBlocksModElements instance) {
		super(instance, 114);
	}
