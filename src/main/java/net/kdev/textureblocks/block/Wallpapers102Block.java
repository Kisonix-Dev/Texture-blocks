...
public class Wallpapers102Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_102")
	public static final Block block = null;

	public Wallpapers102Block(TextureBlocksModElements instance) {
		super(instance, 1229);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_102");
		}
