...
public class Concrete32Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_32")
	public static final Block block = null;

	public Concrete32Block(TextureBlocksModElements instance) {
		super(instance, 84);
	}
