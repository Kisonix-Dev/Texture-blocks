...
public class Concrete23Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_23")
	public static final Block block = null;

	public Concrete23Block(TextureBlocksModElements instance) {
		super(instance, 75);
	}
