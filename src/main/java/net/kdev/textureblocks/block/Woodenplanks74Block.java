...
public class Woodenplanks74Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_74")
	public static final Block block = null;

	public Woodenplanks74Block(TextureBlocksModElements instance) {
		super(instance, 502);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_74");
		}
