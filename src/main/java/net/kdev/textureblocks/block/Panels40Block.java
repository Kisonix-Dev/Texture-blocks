...
public class Panels40Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_40")
	public static final Block block = null;

	public Panels40Block(TextureBlocksModElements instance) {
		super(instance, 985);
	}
