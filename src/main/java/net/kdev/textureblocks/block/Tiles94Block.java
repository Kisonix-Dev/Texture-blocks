...
public class Tiles94Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_84")
	public static final Block block = null;

	public Tiles94Block(TextureBlocksModElements instance) {
		super(instance, 1434);
	}
