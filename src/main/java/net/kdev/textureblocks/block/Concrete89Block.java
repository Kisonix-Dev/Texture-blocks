...
public class Concrete89Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_89")
	public static final Block block = null;

	public Concrete89Block(TextureBlocksModElements instance) {
		super(instance, 141);
	}
