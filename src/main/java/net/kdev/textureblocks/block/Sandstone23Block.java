...
public class Sandstone23Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_23")
	public static final Block block = null;

	public Sandstone23Block(TextureBlocksModElements instance) {
		super(instance, 1277);
	}
