...
public class Linoleum70Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_70")
	public static final Block block = null;

	public Linoleum70Block(TextureBlocksModElements instance) {
		super(instance, 822);
	}
