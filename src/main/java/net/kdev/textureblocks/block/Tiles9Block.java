...
public class Tiles9Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_9")
	public static final Block block = null;

	public Tiles9Block(TextureBlocksModElements instance) {
		super(instance, 1359);
	}
