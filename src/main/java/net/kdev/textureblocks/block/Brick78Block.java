...
public class Brick78Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_78")
	public static final Block block = null;

	public Brick78Block(TextureBlocksModElements instance) {
		super(instance, 609);
	}
