...
public class Parquet13Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_13")
	public static final Block block = null;

	public Parquet13Block(TextureBlocksModElements instance) {
		super(instance, 1048);
	}
