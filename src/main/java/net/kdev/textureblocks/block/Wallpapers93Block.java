...
public class Wallpapers93Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_93")
	public static final Block block = null;

	public Wallpapers93Block(TextureBlocksModElements instance) {
		super(instance, 1220);
	}
