...
public class Wood51Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_51")
	public static final Block block = null;

	public Wood51Block(TextureBlocksModElements instance) {
		super(instance, 383);
	}
