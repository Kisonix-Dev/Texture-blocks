...
public class Panels71Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_71")
	public static final Block block = null;

	public Panels71Block(TextureBlocksModElements instance) {
		super(instance, 1016);
	}
