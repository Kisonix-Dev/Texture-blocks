...
public class Marbletiles51Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_51")
	public static final Block block = null;

	public Marbletiles51Block(TextureBlocksModElements instance) {
		super(instance, 909);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_51");
		}
