...
public class Parquet80Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_80")
	public static final Block block = null;

	public Parquet80Block(TextureBlocksModElements instance) {
		super(instance, 1115);
	}
