...
public class Sandstone32Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_32")
	public static final Block block = null;

	public Sandstone32Block(TextureBlocksModElements instance) {
		super(instance, 1286);
	}
