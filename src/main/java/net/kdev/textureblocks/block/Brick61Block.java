...
public class Brick61Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_61")
	public static final Block block = null;

	public Brick61Block(TextureBlocksModElements instance) {
		super(instance, 592);
	}
