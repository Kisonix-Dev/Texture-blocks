...
public class Tiles73Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_73")
	public static final Block block = null;

	public Tiles73Block(TextureBlocksModElements instance) {
		super(instance, 1423);
	}
