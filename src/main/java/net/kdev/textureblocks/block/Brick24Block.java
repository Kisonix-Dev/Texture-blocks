...
public class Brick24Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_24")
	public static final Block block = null;

	public Brick24Block(TextureBlocksModElements instance) {
		super(instance, 555);
	}
