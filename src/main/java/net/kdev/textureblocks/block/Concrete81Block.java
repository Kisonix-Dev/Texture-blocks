...
public class Concrete81Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_81")
	public static final Block block = null;

	public Concrete81Block(TextureBlocksModElements instance) {
		super(instance, 133);
	}
