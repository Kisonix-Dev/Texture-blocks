...
public class Wallpapers63Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_63")
	public static final Block block = null;

	public Wallpapers63Block(TextureBlocksModElements instance) {
		super(instance, 1190);
	}
