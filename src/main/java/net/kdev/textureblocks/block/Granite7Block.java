...
public class Granite7Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_7")
	public static final Block block = null;

	public Granite7Block(TextureBlocksModElements instance) {
		super(instance, 253);
	}
