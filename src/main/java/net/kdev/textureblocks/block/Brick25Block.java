...
public class Brick25Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_25")
	public static final Block block = null;

	public Brick25Block(TextureBlocksModElements instance) {
		super(instance, 556);
	}
