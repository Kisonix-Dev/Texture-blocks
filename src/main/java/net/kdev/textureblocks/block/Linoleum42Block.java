...
public class Linoleum42Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_42")
	public static final Block block = null;

	public Linoleum42Block(TextureBlocksModElements instance) {
		super(instance, 794);
	}
