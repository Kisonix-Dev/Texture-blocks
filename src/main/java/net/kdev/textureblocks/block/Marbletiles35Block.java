...
public class Marbletiles35Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_35")
	public static final Block block = null;

	public Marbletiles35Block(TextureBlocksModElements instance) {
		super(instance, 893);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_35");
		}
