...
public class Cobblestone18Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_18")
	public static final Block block = null;

	public Cobblestone18Block(TextureBlocksModElements instance) {
		super(instance, 165);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_18");
		}
