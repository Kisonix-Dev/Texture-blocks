...
public class Linoleum52Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_52")
	public static final Block block = null;

	public Linoleum52Block(TextureBlocksModElements instance) {
		super(instance, 804);
	}
