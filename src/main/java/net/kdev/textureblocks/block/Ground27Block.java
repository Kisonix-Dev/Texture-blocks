...
public class Ground27Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_27")
	public static final Block block = null;

	public Ground27Block(TextureBlocksModElements instance) {
		super(instance, 303);
	}
