...
public class Cobblestone11Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_11")
	public static final Block block = null;

	public Cobblestone11Block(TextureBlocksModElements instance) {
		super(instance, 158);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_11");
		}
