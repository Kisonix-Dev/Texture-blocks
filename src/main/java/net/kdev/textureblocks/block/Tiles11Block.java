...
public class Tiles11Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_11")
	public static final Block block = null;

	public Tiles11Block(TextureBlocksModElements instance) {
		super(instance, 1361);
	}
