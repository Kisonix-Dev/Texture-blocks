...
public class Laminate36Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_36")
	public static final Block block = null;

	public Laminate36Block(TextureBlocksModElements instance) {
		super(instance, 692);
	}
