...
public class Linoleum89Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_89")
	public static final Block block = null;

	public Linoleum89Block(TextureBlocksModElements instance) {
		super(instance, 841);
	}
