...
public class Wood89Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_89")
	public static final Block block = null;

	public Wood89Block(TextureBlocksModElements instance) {
		super(instance, 421);
	}
