...
public class Wallpapers13Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_13")
	public static final Block block = null;

	public Wallpapers13Block(TextureBlocksModElements instance) {
		super(instance, 1140);
	}
