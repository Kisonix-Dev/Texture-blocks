...
public class Sandstone5Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_5")
	public static final Block block = null;

	public Sandstone5Block(TextureBlocksModElements instance) {
		super(instance, 1259);
	}
