...
public class Woodenplanks75Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_75")
	public static final Block block = null;

	public Woodenplanks75Block(TextureBlocksModElements instance) {
		super(instance, 503);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_75");
		}
