...
public class Sandstone12Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_12")
	public static final Block block = null;

	public Sandstone12Block(TextureBlocksModElements instance) {
		super(instance, 1266);
	}
