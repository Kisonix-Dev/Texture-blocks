...
public class Wallpapers81Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_81")
	public static final Block block = null;

	public Wallpapers81Block(TextureBlocksModElements instance) {
		super(instance, 1208);
	}
