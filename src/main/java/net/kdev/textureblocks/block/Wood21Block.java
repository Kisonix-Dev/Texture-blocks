...
public class Wood21Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_21")
	public static final Block block = null;

	public Wood21Block(TextureBlocksModElements instance) {
		super(instance, 353);
	}
