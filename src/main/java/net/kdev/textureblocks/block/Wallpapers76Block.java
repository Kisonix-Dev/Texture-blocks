...
public class Wallpapers76Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_76")
	public static final Block block = null;

	public Wallpapers76Block(TextureBlocksModElements instance) {
		super(instance, 1203);
	}
