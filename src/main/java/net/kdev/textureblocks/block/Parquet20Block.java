...
public class Parquet20Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_20")
	public static final Block block = null;

	public Parquet20Block(TextureBlocksModElements instance) {
		super(instance, 1055);
	}
