...
public class Wallpapers113Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_113")
	public static final Block block = null;

	public Wallpapers113Block(TextureBlocksModElements instance) {
		super(instance, 1240);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_113");
		}
