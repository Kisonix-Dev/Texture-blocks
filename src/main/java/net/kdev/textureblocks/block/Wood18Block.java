...
public class Wood18Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_18")
	public static final Block block = null;

	public Wood18Block(TextureBlocksModElements instance) {
		super(instance, 350);
	}
