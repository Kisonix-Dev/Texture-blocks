...
public class Woodenplanks12Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_12")
	public static final Block block = null;

	public Woodenplanks12Block(TextureBlocksModElements instance) {
		super(instance, 440);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_12");
		}
