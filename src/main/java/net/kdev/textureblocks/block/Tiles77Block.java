...
public class Tiles77Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_77")
	public static final Block block = null;

	public Tiles77Block(TextureBlocksModElements instance) {
		super(instance, 1427);
	}
