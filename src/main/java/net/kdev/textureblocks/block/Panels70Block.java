...
public class Panels70Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_70")
	public static final Block block = null;

	public Panels70Block(TextureBlocksModElements instance) {
		super(instance, 1015);
	}
