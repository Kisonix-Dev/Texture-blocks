...
public class Wood88Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_88")
	public static final Block block = null;

	public Wood88Block(TextureBlocksModElements instance) {
		super(instance, 420);
	}
