...
public class Laminate61Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_61")
	public static final Block block = null;

	public Laminate61Block(TextureBlocksModElements instance) {
		super(instance, 717);
	}
