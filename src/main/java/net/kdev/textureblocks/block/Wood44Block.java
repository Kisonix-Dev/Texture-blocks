...
public class Wood44Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_44")
	public static final Block block = null;

	public Wood44Block(TextureBlocksModElements instance) {
		super(instance, 376);
	}
