...
public class Panels29Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_29")
	public static final Block block = null;

	public Panels29Block(TextureBlocksModElements instance) {
		super(instance, 974);
	}
