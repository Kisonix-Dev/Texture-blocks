...
public class Tiles53Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_53")
	public static final Block block = null;

	public Tiles53Block(TextureBlocksModElements instance) {
		super(instance, 1403);
	}
