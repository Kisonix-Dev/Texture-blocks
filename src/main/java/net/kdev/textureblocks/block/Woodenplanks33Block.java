...
public class Woodenplanks33Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_33")
	public static final Block block = null;

	public Woodenplanks33Block(TextureBlocksModElements instance) {
		super(instance, 461);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_33");
		}
