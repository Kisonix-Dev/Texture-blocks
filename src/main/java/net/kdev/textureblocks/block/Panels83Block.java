...
public class Panels83Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_83")
	public static final Block block = null;

	public Panels83Block(TextureBlocksModElements instance) {
		super(instance, 1028);
	}
