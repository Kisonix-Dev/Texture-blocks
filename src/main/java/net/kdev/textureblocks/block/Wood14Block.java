...
public class Wood14Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_14")
	public static final Block block = null;

	public Wood14Block(TextureBlocksModElements instance) {
		super(instance, 346);
	}
