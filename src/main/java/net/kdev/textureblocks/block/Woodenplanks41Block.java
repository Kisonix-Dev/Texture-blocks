...
public class Woodenplanks41Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_41")
	public static final Block block = null;

	public Woodenplanks41Block(TextureBlocksModElements instance) {
		super(instance, 469);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_41");
		}
