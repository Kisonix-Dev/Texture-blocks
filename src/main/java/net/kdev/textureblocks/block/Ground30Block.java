...
public class Ground30Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_30")
	public static final Block block = null;

	public Ground30Block(TextureBlocksModElements instance) {
		super(instance, 306);
	}
