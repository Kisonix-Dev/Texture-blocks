...
public class Tiles18Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_18")
	public static final Block block = null;

	public Tiles18Block(TextureBlocksModElements instance) {
		super(instance, 1368);
	}
