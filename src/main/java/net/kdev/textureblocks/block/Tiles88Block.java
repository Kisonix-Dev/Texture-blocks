...
public class Tiles88Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_88")
	public static final Block block = null;

	public Tiles88Block(TextureBlocksModElements instance) {
		super(instance, 1438);
	}
