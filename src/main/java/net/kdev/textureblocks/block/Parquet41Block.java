...
public class Parquet41Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_41")
	public static final Block block = null;

	public Parquet41Block(TextureBlocksModElements instance) {
		super(instance, 1076);
	}
