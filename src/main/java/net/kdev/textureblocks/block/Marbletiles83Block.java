...
public class Marbletiles83Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_83")
	public static final Block block = null;

	public Marbletiles83Block(TextureBlocksModElements instance) {
		super(instance, 941);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_83");
		}
