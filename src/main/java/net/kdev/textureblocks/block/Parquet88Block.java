...
public class Parquet88Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_88")
	public static final Block block = null;

	public Parquet88Block(TextureBlocksModElements instance) {
		super(instance, 1123);
	}
