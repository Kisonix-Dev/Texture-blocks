...
public class Linoleum93Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_93")
	public static final Block block = null;

	public Linoleum93Block(TextureBlocksModElements instance) {
		super(instance, 845);
	}
