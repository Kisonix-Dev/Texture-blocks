...
public class Panels14Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_14")
	public static final Block block = null;

	public Panels14Block(TextureBlocksModElements instance) {
		super(instance, 959);
	}
