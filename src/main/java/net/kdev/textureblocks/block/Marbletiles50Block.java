...
public class Marbletiles50Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_50")
	public static final Block block = null;

	public Marbletiles50Block(TextureBlocksModElements instance) {
		super(instance, 908);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_50");
		}
