...
public class Wallpapers112Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_112")
	public static final Block block = null;

	public Wallpapers112Block(TextureBlocksModElements instance) {
		super(instance, 1239);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_112");
		}
