...
public class Sandstone45Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_45")
	public static final Block block = null;

	public Sandstone45Block(TextureBlocksModElements instance) {
		super(instance, 1299);
	}
