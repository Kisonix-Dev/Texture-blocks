...
public class Woodenplanks29Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_29")
	public static final Block block = null;

	public Woodenplanks29Block(TextureBlocksModElements instance) {
		super(instance, 457);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_29");
		}
