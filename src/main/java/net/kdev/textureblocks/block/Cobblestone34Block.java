...
public class Cobblestone34Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_34")
	public static final Block block = null;

	public Cobblestone34Block(TextureBlocksModElements instance) {
		super(instance, 181);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_34");
		}
