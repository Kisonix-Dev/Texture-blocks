...
public class Laminate57Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_57")
	public static final Block block = null;

	public Laminate57Block(TextureBlocksModElements instance) {
		super(instance, 713);
	}
