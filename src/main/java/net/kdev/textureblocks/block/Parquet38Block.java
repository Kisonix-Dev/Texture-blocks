...
public class Parquet38Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_38")
	public static final Block block = null;

	public Parquet38Block(TextureBlocksModElements instance) {
		super(instance, 1073);
	}
