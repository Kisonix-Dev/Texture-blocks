...
public class Wallpapers27Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_27")
	public static final Block block = null;

	public Wallpapers27Block(TextureBlocksModElements instance) {
		super(instance, 1154);
	}
