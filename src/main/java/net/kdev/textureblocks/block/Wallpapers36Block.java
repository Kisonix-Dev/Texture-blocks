...
public class Wallpapers36Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_36")
	public static final Block block = null;

	public Wallpapers36Block(TextureBlocksModElements instance) {
		super(instance, 1163);
	}
