...
public class Granite9Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_9")
	public static final Block block = null;

	public Granite9Block(TextureBlocksModElements instance) {
		super(instance, 255);
	}
