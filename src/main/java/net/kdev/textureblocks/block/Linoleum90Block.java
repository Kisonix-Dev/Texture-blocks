...
public class Linoleum90Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_90")
	public static final Block block = null;

	public Linoleum90Block(TextureBlocksModElements instance) {
		super(instance, 842);
	}
