...
public class Linoleum22Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_22")
	public static final Block block = null;

	public Linoleum22Block(TextureBlocksModElements instance) {
		super(instance, 774);
	}
