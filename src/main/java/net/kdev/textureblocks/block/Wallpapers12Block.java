...
public class Wallpapers12Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_12")
	public static final Block block = null;

	public Wallpapers12Block(TextureBlocksModElements instance) {
		super(instance, 1139);
	}
