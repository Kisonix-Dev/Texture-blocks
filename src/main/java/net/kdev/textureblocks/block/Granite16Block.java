...
public class Granite16Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_16")
	public static final Block block = null;

	public Granite16Block(TextureBlocksModElements instance) {
		super(instance, 262);
	}
