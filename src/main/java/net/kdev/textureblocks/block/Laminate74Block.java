...
public class Laminate74Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_74")
	public static final Block block = null;

	public Laminate74Block(TextureBlocksModElements instance) {
		super(instance, 730);
	}
