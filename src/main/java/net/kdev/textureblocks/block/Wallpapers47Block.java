...
public class Wallpapers47Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_47")
	public static final Block block = null;

	public Wallpapers47Block(TextureBlocksModElements instance) {
		super(instance, 1174);
	}
