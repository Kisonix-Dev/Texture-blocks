...
public class Panels90Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_90")
	public static final Block block = null;

	public Panels90Block(TextureBlocksModElements instance) {
		super(instance, 1035);
	}
