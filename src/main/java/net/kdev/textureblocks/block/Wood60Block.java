...
public class Wood60Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_60")
	public static final Block block = null;

	public Wood60Block(TextureBlocksModElements instance) {
		super(instance, 392);
	}
