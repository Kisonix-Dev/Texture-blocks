...
public class Cobblestone60Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_60")
	public static final Block block = null;

	public Cobblestone60Block(TextureBlocksModElements instance) {
		super(instance, 207);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_60");
		}
