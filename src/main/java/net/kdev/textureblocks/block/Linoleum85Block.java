...
public class Linoleum85Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_85")
	public static final Block block = null;

	public Linoleum85Block(TextureBlocksModElements instance) {
		super(instance, 837);
	}
