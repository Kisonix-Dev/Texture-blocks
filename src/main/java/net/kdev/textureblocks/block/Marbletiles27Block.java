...
public class Marbletiles27Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_27")
	public static final Block block = null;

	public Marbletiles27Block(TextureBlocksModElements instance) {
		super(instance, 885);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_27");
		}
