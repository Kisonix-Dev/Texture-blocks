...
public class Sandstone70Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_70")
	public static final Block block = null;

	public Sandstone70Block(TextureBlocksModElements instance) {
		super(instance, 1324);
	}
