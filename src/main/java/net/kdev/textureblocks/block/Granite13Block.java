...
public class Granite13Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_13")
	public static final Block block = null;

	public Granite13Block(TextureBlocksModElements instance) {
		super(instance, 259);
	}
