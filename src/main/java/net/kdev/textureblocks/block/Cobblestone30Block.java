...
public class Cobblestone30Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_30")
	public static final Block block = null;

	public Cobblestone30Block(TextureBlocksModElements instance) {
		super(instance, 177);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_30");
		}
