...
public class Linoleum67Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_67")
	public static final Block block = null;

	public Linoleum67Block(TextureBlocksModElements instance) {
		super(instance, 819);
	}
