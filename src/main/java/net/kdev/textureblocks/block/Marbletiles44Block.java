...
public class Marbletiles44Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_44")
	public static final Block block = null;

	public Marbletiles44Block(TextureBlocksModElements instance) {
		super(instance, 902);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_44");
		}
