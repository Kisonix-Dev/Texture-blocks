...
public class Parquet33Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_33")
	public static final Block block = null;

	public Parquet33Block(TextureBlocksModElements instance) {
		super(instance, 1068);
	}
