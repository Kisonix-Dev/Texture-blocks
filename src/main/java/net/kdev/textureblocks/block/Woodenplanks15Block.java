...
public class Woodenplanks15Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_15")
	public static final Block block = null;

	public Woodenplanks15Block(TextureBlocksModElements instance) {
		super(instance, 443);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_15");
		}
