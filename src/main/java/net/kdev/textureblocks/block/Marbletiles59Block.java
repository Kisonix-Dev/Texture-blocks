...
public class Marbletiles59Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_59")
	public static final Block block = null;

	public Marbletiles59Block(TextureBlocksModElements instance) {
		super(instance, 917);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_59");
		}
