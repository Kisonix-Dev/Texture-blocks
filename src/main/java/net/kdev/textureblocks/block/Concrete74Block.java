...
public class Concrete74Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_74")
	public static final Block block = null;

	public Concrete74Block(TextureBlocksModElements instance) {
		super(instance, 126);
	}
