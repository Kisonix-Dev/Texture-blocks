...
public class Cobblestone13Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_13")
	public static final Block block = null;

	public Cobblestone13Block(TextureBlocksModElements instance) {
		super(instance, 160);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_13");
		}
