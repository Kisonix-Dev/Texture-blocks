...
public class Laminate94Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_94")
	public static final Block block = null;

	public Laminate94Block(TextureBlocksModElements instance) {
		super(instance, 750);
	}
