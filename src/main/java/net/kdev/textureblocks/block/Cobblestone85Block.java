...
public class Cobblestone85Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_85")
	public static final Block block = null;

	public Cobblestone85Block(TextureBlocksModElements instance) {
		super(instance, 232);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_85");
		}
