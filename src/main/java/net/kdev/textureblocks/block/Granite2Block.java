...
public class Granite2Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_2")
	public static final Block block = null;

	public Granite2Block(TextureBlocksModElements instance) {
		super(instance, 248);
	}
