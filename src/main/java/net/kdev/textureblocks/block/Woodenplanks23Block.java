...
public class Woodenplanks23Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_23")
	public static final Block block = null;

	public Woodenplanks23Block(TextureBlocksModElements instance) {
		super(instance, 451);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_23");
		}
