...
public class Wallpapers32Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_32")
	public static final Block block = null;

	public Wallpapers32Block(TextureBlocksModElements instance) {
		super(instance, 1159);
	}
