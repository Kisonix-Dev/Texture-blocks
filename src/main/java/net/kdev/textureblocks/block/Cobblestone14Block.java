...
public class Cobblestone14Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_14")
	public static final Block block = null;

	public Cobblestone14Block(TextureBlocksModElements instance) {
		super(instance, 161);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_14");
		}
