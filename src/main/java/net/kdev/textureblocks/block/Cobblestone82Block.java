...
public class Cobblestone82Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_82")
	public static final Block block = null;

	public Cobblestone82Block(TextureBlocksModElements instance) {
		super(instance, 229);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_82");
		}
