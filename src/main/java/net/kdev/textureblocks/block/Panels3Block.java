...
public class Panels3Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_3")
	public static final Block block = null;

	public Panels3Block(TextureBlocksModElements instance) {
		super(instance, 948);
	}
