...
public class Granite15Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_15")
	public static final Block block = null;

	public Granite15Block(TextureBlocksModElements instance) {
		super(instance, 261);
	}
