...
public class Brick91Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_91")
	public static final Block block = null;

	public Brick91Block(TextureBlocksModElements instance) {
		super(instance, 622);
	}
