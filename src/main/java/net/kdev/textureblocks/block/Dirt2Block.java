...
public class Dirt2Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:dirt_2")
	public static final Block block = null;

	public Dirt2Block(TextureBlocksModElements instance) {
		super(instance, 324);
	}
