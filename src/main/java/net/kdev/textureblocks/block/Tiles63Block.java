...
public class Tiles63Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_63")
	public static final Block block = null;

	public Tiles63Block(TextureBlocksModElements instance) {
		super(instance, 1413);
	}
