...
public class Woodenplanks69Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_69")
	public static final Block block = null;

	public Woodenplanks69Block(TextureBlocksModElements instance) {
		super(instance, 497);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_69");
		}
