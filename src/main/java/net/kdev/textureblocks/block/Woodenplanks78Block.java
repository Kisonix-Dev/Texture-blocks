...
public class Woodenplanks78Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_78")
	public static final Block block = null;

	public Woodenplanks78Block(TextureBlocksModElements instance) {
		super(instance, 506);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_78");
		}
