...
public class Wallpapers110Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_110")
	public static final Block block = null;

	public Wallpapers110Block(TextureBlocksModElements instance) {
		super(instance, 1237);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_110");
		}
