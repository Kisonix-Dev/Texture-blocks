...
public class Granite11Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_11")
	public static final Block block = null;

	public Granite11Block(TextureBlocksModElements instance) {
		super(instance, 257);
	}
