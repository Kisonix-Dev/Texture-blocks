...
public class Laminate7Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_7")
	public static final Block block = null;

	public Laminate7Block(TextureBlocksModElements instance) {
		super(instance, 663);
	}
