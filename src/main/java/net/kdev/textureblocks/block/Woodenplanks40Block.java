...
public class Woodenplanks40Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_40")
	public static final Block block = null;

	public Woodenplanks40Block(TextureBlocksModElements instance) {
		super(instance, 468);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_40");
		}
