...
public class Ground37Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_37")
	public static final Block block = null;

	public Ground37Block(TextureBlocksModElements instance) {
		super(instance, 313);
	}
