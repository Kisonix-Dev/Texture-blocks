...
public class Brick35Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_35")
	public static final Block block = null;

	public Brick35Block(TextureBlocksModElements instance) {
		super(instance, 566);
	}
