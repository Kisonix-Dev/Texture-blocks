...
public class Parquet11Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_11")
	public static final Block block = null;

	public Parquet11Block(TextureBlocksModElements instance) {
		super(instance, 1046);
	}
