...
public class Sandstone75Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_75")
	public static final Block block = null;

	public Sandstone75Block(TextureBlocksModElements instance) {
		super(instance, 1329);
	}
