...
public class Sandstone49Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_49")
	public static final Block block = null;

	public Sandstone49Block(TextureBlocksModElements instance) {
		super(instance, 1303);
	}
