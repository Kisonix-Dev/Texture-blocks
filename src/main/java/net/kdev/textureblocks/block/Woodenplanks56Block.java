...
public class Woodenplanks56Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_56")
	public static final Block block = null;

	public Woodenplanks56Block(TextureBlocksModElements instance) {
		super(instance, 484);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_56");
		}
