...
public class Concrete87Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_87")
	public static final Block block = null;

	public Concrete87Block(TextureBlocksModElements instance) {
		super(instance, 139);
	}
