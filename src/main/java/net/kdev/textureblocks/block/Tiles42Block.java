...
public class Tiles42Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_42")
	public static final Block block = null;

	public Tiles42Block(TextureBlocksModElements instance) {
		super(instance, 1392);
	}
