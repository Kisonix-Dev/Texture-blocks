...
public class Wallpapers114Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_114")
	public static final Block block = null;

	public Wallpapers114Block(TextureBlocksModElements instance) {
		super(instance, 1241);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_114");
		}
