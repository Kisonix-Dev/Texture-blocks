...
public class Concrete41Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_41")
	public static final Block block = null;

	public Concrete41Block(TextureBlocksModElements instance) {
		super(instance, 93);
	}
