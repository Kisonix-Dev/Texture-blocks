...
public class Granite30Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_30")
	public static final Block block = null;

	public Granite30Block(TextureBlocksModElements instance) {
		super(instance, 276);
	}
