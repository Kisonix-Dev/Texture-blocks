...
public class Laminate62Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_62")
	public static final Block block = null;

	public Laminate62Block(TextureBlocksModElements instance) {
		super(instance, 718);
	}
