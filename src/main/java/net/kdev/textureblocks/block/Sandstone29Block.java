...
public class Sandstone29Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_29")
	public static final Block block = null;

	public Sandstone29Block(TextureBlocksModElements instance) {
		super(instance, 1283);
	}
