...
public class Woodenplanks9Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_9")
	public static final Block block = null;

	public Woodenplanks9Block(TextureBlocksModElements instance) {
		super(instance, 437);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_9");
		}
