...
public class Linoleum83Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_83")
	public static final Block block = null;

	public Linoleum83Block(TextureBlocksModElements instance) {
		super(instance, 835);
	}
