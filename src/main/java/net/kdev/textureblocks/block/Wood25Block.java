...
public class Wood25Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_25")
	public static final Block block = null;

	public Wood25Block(TextureBlocksModElements instance) {
		super(instance, 357);
	}
