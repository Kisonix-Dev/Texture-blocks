...
public class Asphalt45Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_45_1")
	public static final Block block = null;

	public Asphalt45Block(TextureBlocksModElements instance) {
		super(instance, 48);
	}
