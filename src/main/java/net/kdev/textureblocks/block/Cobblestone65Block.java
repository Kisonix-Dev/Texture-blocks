...
public class Cobblestone65Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_65")
	public static final Block block = null;

	public Cobblestone65Block(TextureBlocksModElements instance) {
		super(instance, 212);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_65");
		}
