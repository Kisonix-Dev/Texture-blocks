...
public class Marbletiles49Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_49")
	public static final Block block = null;

	public Marbletiles49Block(TextureBlocksModElements instance) {
		super(instance, 907);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_49");
		}
