...
public class Brick73Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_73")
	public static final Block block = null;

	public Brick73Block(TextureBlocksModElements instance) {
		super(instance, 604);
	}
