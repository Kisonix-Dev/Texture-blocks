...
public class Linoleum64Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_64")
	public static final Block block = null;

	public Linoleum64Block(TextureBlocksModElements instance) {
		super(instance, 816);
	}
