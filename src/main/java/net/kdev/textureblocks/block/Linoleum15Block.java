...
public class Linoleum15Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_15")
	public static final Block block = null;

	public Linoleum15Block(TextureBlocksModElements instance) {
		super(instance, 767);
	}
