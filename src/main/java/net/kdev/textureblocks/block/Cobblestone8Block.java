...
public class Cobblestone8Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_8")
	public static final Block block = null;

	public Cobblestone8Block(TextureBlocksModElements instance) {
		super(instance, 155);
	}
