...
public class Brick58Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_58")
	public static final Block block = null;

	public Brick58Block(TextureBlocksModElements instance) {
		super(instance, 589);
	}
