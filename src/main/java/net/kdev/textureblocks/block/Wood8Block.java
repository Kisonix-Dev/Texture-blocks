...
public class Wood8Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_8")
	public static final Block block = null;

	public Wood8Block(TextureBlocksModElements instance) {
		super(instance, 340);
	}
