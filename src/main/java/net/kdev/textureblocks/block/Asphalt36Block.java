...
public class Asphalt36Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_36_1")
	public static final Block block = null;

	public Asphalt36Block(TextureBlocksModElements instance) {
		super(instance, 39);
	}
