...
public class Panels49Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_49")
	public static final Block block = null;

	public Panels49Block(TextureBlocksModElements instance) {
		super(instance, 994);
	}
