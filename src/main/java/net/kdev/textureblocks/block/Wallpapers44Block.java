...
public class Wallpapers44Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_44")
	public static final Block block = null;

	public Wallpapers44Block(TextureBlocksModElements instance) {
		super(instance, 1171);
	}
