...
public class Woodenplanks77Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_77")
	public static final Block block = null;

	public Woodenplanks77Block(TextureBlocksModElements instance) {
		super(instance, 505);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_77");
		}
