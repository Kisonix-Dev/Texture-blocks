...
public class Sandstone48Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_48")
	public static final Block block = null;

	public Sandstone48Block(TextureBlocksModElements instance) {
		super(instance, 1302);
	}
