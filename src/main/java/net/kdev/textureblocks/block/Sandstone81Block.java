...
public class Sandstone81Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_81")
	public static final Block block = null;

	public Sandstone81Block(TextureBlocksModElements instance) {
		super(instance, 1335);
	}
