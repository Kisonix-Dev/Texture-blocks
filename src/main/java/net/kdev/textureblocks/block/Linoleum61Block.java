...
public class Linoleum61Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_61")
	public static final Block block = null;

	public Linoleum61Block(TextureBlocksModElements instance) {
		super(instance, 813);
	}
