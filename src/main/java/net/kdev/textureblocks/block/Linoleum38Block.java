...
public class Linoleum38Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_38")
	public static final Block block = null;

	public Linoleum38Block(TextureBlocksModElements instance) {
		super(instance, 790);
	}
