...
public class Sandstone47Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_47")
	public static final Block block = null;

	public Sandstone47Block(TextureBlocksModElements instance) {
		super(instance, 1301);
	}
