...
public class Wallpapers91Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_91")
	public static final Block block = null;

	public Wallpapers91Block(TextureBlocksModElements instance) {
		super(instance, 1218);
	}
