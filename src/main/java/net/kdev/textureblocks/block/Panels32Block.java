...
public class Panels32Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_32")
	public static final Block block = null;

	public Panels32Block(TextureBlocksModElements instance) {
		super(instance, 977);
	}
