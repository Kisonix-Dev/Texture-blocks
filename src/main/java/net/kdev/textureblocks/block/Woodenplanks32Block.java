...
public class Woodenplanks32Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_32")
	public static final Block block = null;

	public Woodenplanks32Block(TextureBlocksModElements instance) {
		super(instance, 460);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_32");
		}
