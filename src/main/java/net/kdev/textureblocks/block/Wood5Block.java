...
public class Wood5Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_5")
	public static final Block block = null;

	public Wood5Block(TextureBlocksModElements instance) {
		super(instance, 337);
	}
