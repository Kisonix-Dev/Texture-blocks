...
public class Concrete42Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_42")
	public static final Block block = null;

	public Concrete42Block(TextureBlocksModElements instance) {
		super(instance, 94);
	}
