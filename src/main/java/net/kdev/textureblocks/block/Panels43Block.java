...
public class Panels43Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_43")
	public static final Block block = null;

	public Panels43Block(TextureBlocksModElements instance) {
		super(instance, 988);
	}
