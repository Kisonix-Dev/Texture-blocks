...
public class Wood58Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_58")
	public static final Block block = null;

	public Wood58Block(TextureBlocksModElements instance) {
		super(instance, 390);
	}
