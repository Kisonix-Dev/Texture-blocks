...
public class Moss2Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:moss_2")
	public static final Block block = null;

	public Moss2Block(TextureBlocksModElements instance) {
		super(instance, 847);
	}
