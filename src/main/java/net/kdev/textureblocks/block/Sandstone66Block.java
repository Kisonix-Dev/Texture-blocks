...
public class Sandstone66Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_66")
	public static final Block block = null;

	public Sandstone66Block(TextureBlocksModElements instance) {
		super(instance, 1320);
	}
