...
public class Linoleum19Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_19")
	public static final Block block = null;

	public Linoleum19Block(TextureBlocksModElements instance) {
		super(instance, 771);
	}
