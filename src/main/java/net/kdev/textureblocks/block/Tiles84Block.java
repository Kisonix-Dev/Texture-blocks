...
public class Tiles84Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_94")
	public static final Block block = null;

	public Tiles84Block(TextureBlocksModElements instance) {
		super(instance, 1444);
	}
