...
public class Panels2Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_2")
	public static final Block block = null;

	public Panels2Block(TextureBlocksModElements instance) {
		super(instance, 947);
	}
