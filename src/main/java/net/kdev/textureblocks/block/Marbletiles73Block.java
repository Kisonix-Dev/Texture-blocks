...
public class Marbletiles73Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_73")
	public static final Block block = null;

	public Marbletiles73Block(TextureBlocksModElements instance) {
		super(instance, 931);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_73");
		}
