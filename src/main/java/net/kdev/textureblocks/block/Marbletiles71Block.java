...
public class Marbletiles71Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_71")
	public static final Block block = null;

	public Marbletiles71Block(TextureBlocksModElements instance) {
		super(instance, 929);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_71");
		}
