...
public class Carpet25Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_25")
	public static final Block block = null;

	public Carpet25Block(TextureBlocksModElements instance) {
		super(instance, 653);
	}
