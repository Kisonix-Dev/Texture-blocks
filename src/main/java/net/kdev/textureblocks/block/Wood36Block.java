...
public class Wood36Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_36")
	public static final Block block = null;

	public Wood36Block(TextureBlocksModElements instance) {
		super(instance, 368);
	}
