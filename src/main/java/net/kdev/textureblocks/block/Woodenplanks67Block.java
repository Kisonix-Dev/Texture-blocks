...
public class Woodenplanks67Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_67")
	public static final Block block = null;

	public Woodenplanks67Block(TextureBlocksModElements instance) {
		super(instance, 495);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_67");
		}
