...
public class Wallpapers111Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_111")
	public static final Block block = null;

	public Wallpapers111Block(TextureBlocksModElements instance) {
		super(instance, 1238);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_111");
		}
