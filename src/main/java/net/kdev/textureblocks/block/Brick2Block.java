...
public class Brick2Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_2")
	public static final Block block = null;

	public Brick2Block(TextureBlocksModElements instance) {
		super(instance, 533);
	}
