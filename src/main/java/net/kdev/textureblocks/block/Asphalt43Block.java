...
public class Asphalt43Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_43_1")
	public static final Block block = null;

	public Asphalt43Block(TextureBlocksModElements instance) {
		super(instance, 46);
	}
