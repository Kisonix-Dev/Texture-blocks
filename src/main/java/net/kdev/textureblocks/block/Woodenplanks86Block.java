...
public class Woodenplanks86Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_86")
	public static final Block block = null;

	public Woodenplanks86Block(TextureBlocksModElements instance) {
		super(instance, 514);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_86");
		}
