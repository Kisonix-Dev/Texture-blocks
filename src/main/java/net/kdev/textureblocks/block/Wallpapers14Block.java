...
public class Wallpapers14Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_14")
	public static final Block block = null;

	public Wallpapers14Block(TextureBlocksModElements instance) {
		super(instance, 1141);
	}
