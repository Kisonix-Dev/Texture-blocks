...
public class Cobblestone47Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_47")
	public static final Block block = null;

	public Cobblestone47Block(TextureBlocksModElements instance) {
		super(instance, 194);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_47");
		}
