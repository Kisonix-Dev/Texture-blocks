...
public class Tiles44Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_44")
	public static final Block block = null;

	public Tiles44Block(TextureBlocksModElements instance) {
		super(instance, 1394);
	}
