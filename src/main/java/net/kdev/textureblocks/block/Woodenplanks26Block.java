...
public class Woodenplanks26Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_26")
	public static final Block block = null;

	public Woodenplanks26Block(TextureBlocksModElements instance) {
		super(instance, 454);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_26");
		}
