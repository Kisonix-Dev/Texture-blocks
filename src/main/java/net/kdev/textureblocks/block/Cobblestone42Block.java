...
public class Cobblestone42Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_42")
	public static final Block block = null;

	public Cobblestone42Block(TextureBlocksModElements instance) {
		super(instance, 189);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_42");
		}
