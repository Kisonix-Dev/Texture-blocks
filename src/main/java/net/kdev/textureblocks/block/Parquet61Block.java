...
public class Parquet61Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_61")
	public static final Block block = null;

	public Parquet61Block(TextureBlocksModElements instance) {
		super(instance, 1096);
	}
