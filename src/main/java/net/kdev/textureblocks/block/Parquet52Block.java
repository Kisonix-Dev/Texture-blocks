...
public class Parquet52Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_52")
	public static final Block block = null;

	public Parquet52Block(TextureBlocksModElements instance) {
		super(instance, 1087);
	}
