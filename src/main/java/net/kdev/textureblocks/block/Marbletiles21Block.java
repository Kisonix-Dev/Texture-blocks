...
public class Marbletiles21Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_21")
	public static final Block block = null;

	public Marbletiles21Block(TextureBlocksModElements instance) {
		super(instance, 879);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_21");
		}
