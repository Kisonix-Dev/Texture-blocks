...
public class Wood1Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_1")
	public static final Block block = null;

	public Wood1Block(TextureBlocksModElements instance) {
		super(instance, 333);
	}
