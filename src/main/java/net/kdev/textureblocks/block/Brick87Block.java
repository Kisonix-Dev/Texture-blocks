...
public class Brick87Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_87")
	public static final Block block = null;

	public Brick87Block(TextureBlocksModElements instance) {
		super(instance, 618);
	}
