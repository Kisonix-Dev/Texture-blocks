...
public class Wood53Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_53")
	public static final Block block = null;

	public Wood53Block(TextureBlocksModElements instance) {
		super(instance, 385);
	}
