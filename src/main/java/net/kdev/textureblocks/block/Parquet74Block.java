...
public class Parquet74Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_74")
	public static final Block block = null;

	public Parquet74Block(TextureBlocksModElements instance) {
		super(instance, 1109);
	}
