...
public class Parquet15Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_15")
	public static final Block block = null;

	public Parquet15Block(TextureBlocksModElements instance) {
		super(instance, 1050);
	}
