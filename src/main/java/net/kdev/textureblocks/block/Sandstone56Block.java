...
public class Sandstone56Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_56")
	public static final Block block = null;

	public Sandstone56Block(TextureBlocksModElements instance) {
		super(instance, 1310);
	}
