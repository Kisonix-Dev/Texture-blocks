...
public class Wood76Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_76")
	public static final Block block = null;

	public Wood76Block(TextureBlocksModElements instance) {
		super(instance, 408);
	}
