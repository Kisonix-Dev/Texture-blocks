...
public class Concrete40Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_40")
	public static final Block block = null;

	public Concrete40Block(TextureBlocksModElements instance) {
		super(instance, 92);
	}
