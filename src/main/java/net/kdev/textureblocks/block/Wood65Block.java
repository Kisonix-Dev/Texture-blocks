...
public class Wood65Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_65")
	public static final Block block = null;

	public Wood65Block(TextureBlocksModElements instance) {
		super(instance, 397);
	}
