...
public class Woodenplanks52Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_52")
	public static final Block block = null;

	public Woodenplanks52Block(TextureBlocksModElements instance) {
		super(instance, 480);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_52");
		}
