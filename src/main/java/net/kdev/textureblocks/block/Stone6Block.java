...
public class Stone6Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:stone_6")
	public static final Block block = null;

	public Stone6Block(TextureBlocksModElements instance) {
		super(instance, 529);
	}
