...
public class Linoleum34Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_34")
	public static final Block block = null;

	public Linoleum34Block(TextureBlocksModElements instance) {
		super(instance, 786);
	}
