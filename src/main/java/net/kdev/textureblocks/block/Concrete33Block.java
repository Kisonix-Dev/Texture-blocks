...
public class Concrete33Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_33")
	public static final Block block = null;

	public Concrete33Block(TextureBlocksModElements instance) {
		super(instance, 85);
	}
