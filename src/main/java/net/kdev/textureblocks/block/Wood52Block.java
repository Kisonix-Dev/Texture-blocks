...
public class Wood52Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_52")
	public static final Block block = null;

	public Wood52Block(TextureBlocksModElements instance) {
		super(instance, 384);
	}
