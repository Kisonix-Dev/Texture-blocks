...
public class Concrete76Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_76")
	public static final Block block = null;

	public Concrete76Block(TextureBlocksModElements instance) {
		super(instance, 128);
	}
