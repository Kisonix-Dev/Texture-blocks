...
public class Laminate68Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_68")
	public static final Block block = null;

	public Laminate68Block(TextureBlocksModElements instance) {
		super(instance, 724);
	}
