...
public class Ground45Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_45")
	public static final Block block = null;

	public Ground45Block(TextureBlocksModElements instance) {
		super(instance, 321);
	}
