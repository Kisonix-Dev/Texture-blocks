...
public class Sandstone30Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_30")
	public static final Block block = null;

	public Sandstone30Block(TextureBlocksModElements instance) {
		super(instance, 1284);
	}
