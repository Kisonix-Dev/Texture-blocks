...
public class Woodenplanks71Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_71")
	public static final Block block = null;

	public Woodenplanks71Block(TextureBlocksModElements instance) {
		super(instance, 499);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_71");
		}
