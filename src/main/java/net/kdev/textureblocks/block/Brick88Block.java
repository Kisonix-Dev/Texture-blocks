...
public class Brick88Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_88")
	public static final Block block = null;

	public Brick88Block(TextureBlocksModElements instance) {
		super(instance, 619);
	}
