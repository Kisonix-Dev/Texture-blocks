...
public class Tiles78Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_78")
	public static final Block block = null;

	public Tiles78Block(TextureBlocksModElements instance) {
		super(instance, 1428);
	}
