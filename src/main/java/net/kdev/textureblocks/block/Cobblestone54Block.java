...
public class Cobblestone54Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_54")
	public static final Block block = null;

	public Cobblestone54Block(TextureBlocksModElements instance) {
		super(instance, 201);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_54");
		}
