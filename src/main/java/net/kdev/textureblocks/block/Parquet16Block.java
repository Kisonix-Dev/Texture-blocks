...
public class Parquet16Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_16")
	public static final Block block = null;

	public Parquet16Block(TextureBlocksModElements instance) {
		super(instance, 1051);
	}
