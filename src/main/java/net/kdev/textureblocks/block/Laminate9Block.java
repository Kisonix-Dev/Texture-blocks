...
public class Laminate9Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_9")
	public static final Block block = null;

	public Laminate9Block(TextureBlocksModElements instance) {
		super(instance, 665);
	}
