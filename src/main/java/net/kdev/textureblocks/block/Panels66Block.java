...
public class Panels66Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_66")
	public static final Block block = null;

	public Panels66Block(TextureBlocksModElements instance) {
		super(instance, 1011);
	}
