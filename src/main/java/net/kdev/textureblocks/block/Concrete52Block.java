...
public class Concrete52Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_52")
	public static final Block block = null;

	public Concrete52Block(TextureBlocksModElements instance) {
		super(instance, 104);
	}
