...
public class Marbletiles22Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_22")
	public static final Block block = null;

	public Marbletiles22Block(TextureBlocksModElements instance) {
		super(instance, 880);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_22");
		}
