...
public class Parquet92Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_92")
	public static final Block block = null;

	public Parquet92Block(TextureBlocksModElements instance) {
		super(instance, 1127);
	}
