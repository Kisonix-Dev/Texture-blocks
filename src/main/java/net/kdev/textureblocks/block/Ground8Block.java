...
public class Ground8Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_8")
	public static final Block block = null;

	public Ground8Block(TextureBlocksModElements instance) {
		super(instance, 284);
	}
