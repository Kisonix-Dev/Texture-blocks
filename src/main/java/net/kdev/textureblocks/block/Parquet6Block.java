...
public class Parquet6Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_6")
	public static final Block block = null;

	public Parquet6Block(TextureBlocksModElements instance) {
		super(instance, 1041);
	}
