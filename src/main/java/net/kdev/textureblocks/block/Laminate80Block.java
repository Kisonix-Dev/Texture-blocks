...
public class Laminate80Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_80")
	public static final Block block = null;

	public Laminate80Block(TextureBlocksModElements instance) {
		super(instance, 736);
	}
