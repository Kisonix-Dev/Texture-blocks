...
public class Laminate52Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_52")
	public static final Block block = null;

	public Laminate52Block(TextureBlocksModElements instance) {
		super(instance, 708);
	}
