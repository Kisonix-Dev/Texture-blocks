...
public class Tiles61Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_61")
	public static final Block block = null;

	public Tiles61Block(TextureBlocksModElements instance) {
		super(instance, 1411);
	}
