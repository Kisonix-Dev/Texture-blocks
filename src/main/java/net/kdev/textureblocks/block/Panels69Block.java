...
public class Panels69Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_69")
	public static final Block block = null;

	public Panels69Block(TextureBlocksModElements instance) {
		super(instance, 1014);
	}
