...
public class Brick97Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_97")
	public static final Block block = null;

	public Brick97Block(TextureBlocksModElements instance) {
		super(instance, 628);
	}
