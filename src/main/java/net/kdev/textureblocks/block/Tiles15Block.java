...
public class Tiles15Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_15")
	public static final Block block = null;

	public Tiles15Block(TextureBlocksModElements instance) {
		super(instance, 1365);
	}
