...
public class Linoleum48Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_48")
	public static final Block block = null;

	public Linoleum48Block(TextureBlocksModElements instance) {
		super(instance, 800);
	}
