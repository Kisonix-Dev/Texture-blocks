...
public class Brick16Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_16")
	public static final Block block = null;

	public Brick16Block(TextureBlocksModElements instance) {
		super(instance, 547);
	}
