...
public class Tiles45Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_45")
	public static final Block block = null;

	public Tiles45Block(TextureBlocksModElements instance) {
		super(instance, 1395);
	}
