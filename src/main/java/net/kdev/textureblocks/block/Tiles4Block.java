...
public class Tiles4Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_4")
	public static final Block block = null;

	public Tiles4Block(TextureBlocksModElements instance) {
		super(instance, 1354);
	}
