...
public class Carpet20Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_20")
	public static final Block block = null;

	public Carpet20Block(TextureBlocksModElements instance) {
		super(instance, 648);
	}
