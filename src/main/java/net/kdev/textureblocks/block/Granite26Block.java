...
public class Granite26Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_26")
	public static final Block block = null;

	public Granite26Block(TextureBlocksModElements instance) {
		super(instance, 272);
	}
