...
public class Tiles74Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_74")
	public static final Block block = null;

	public Tiles74Block(TextureBlocksModElements instance) {
		super(instance, 1424);
	}
