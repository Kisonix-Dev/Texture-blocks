...
public class Sandstone60Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_60")
	public static final Block block = null;

	public Sandstone60Block(TextureBlocksModElements instance) {
		super(instance, 1314);
	}
