...
public class Parquet19Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_19")
	public static final Block block = null;

	public Parquet19Block(TextureBlocksModElements instance) {
		super(instance, 1054);
	}
