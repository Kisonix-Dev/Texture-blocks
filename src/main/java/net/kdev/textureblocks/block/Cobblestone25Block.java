...
public class Cobblestone25Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_25")
	public static final Block block = null;

	public Cobblestone25Block(TextureBlocksModElements instance) {
		super(instance, 172);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_25");
		}
