...
public class Laminate4Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_4")
	public static final Block block = null;

	public Laminate4Block(TextureBlocksModElements instance) {
		super(instance, 660);
	}
