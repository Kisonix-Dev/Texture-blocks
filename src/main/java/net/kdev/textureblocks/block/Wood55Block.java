...
public class Wood55Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_55")
	public static final Block block = null;

	public Wood55Block(TextureBlocksModElements instance) {
		super(instance, 387);
	}
