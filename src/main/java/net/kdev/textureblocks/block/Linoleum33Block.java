...
public class Linoleum33Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_33")
	public static final Block block = null;

	public Linoleum33Block(TextureBlocksModElements instance) {
		super(instance, 785);
	}
