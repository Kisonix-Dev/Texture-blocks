...
public class Marbletiles82Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_82")
	public static final Block block = null;

	public Marbletiles82Block(TextureBlocksModElements instance) {
		super(instance, 940);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_82");
		}
