...
public class Brick62Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_62")
	public static final Block block = null;

	public Brick62Block(TextureBlocksModElements instance) {
		super(instance, 593);
	}
