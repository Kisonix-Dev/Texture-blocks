...
public class Wood74Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_74")
	public static final Block block = null;

	public Wood74Block(TextureBlocksModElements instance) {
		super(instance, 406);
	}
