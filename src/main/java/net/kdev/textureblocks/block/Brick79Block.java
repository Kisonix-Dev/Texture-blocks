...
public class Brick79Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_79")
	public static final Block block = null;

	public Brick79Block(TextureBlocksModElements instance) {
		super(instance, 610);
	}
