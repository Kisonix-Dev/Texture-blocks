...
public class Laminate89Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_89")
	public static final Block block = null;

	public Laminate89Block(TextureBlocksModElements instance) {
		super(instance, 745);
	}
