...
public class Linoleum59Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_59")
	public static final Block block = null;

	public Linoleum59Block(TextureBlocksModElements instance) {
		super(instance, 811);
	}
