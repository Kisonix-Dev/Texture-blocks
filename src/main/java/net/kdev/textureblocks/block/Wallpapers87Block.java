...
public class Wallpapers87Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_87")
	public static final Block block = null;

	public Wallpapers87Block(TextureBlocksModElements instance) {
		super(instance, 1214);
	}
