...
public class Ground31Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_31")
	public static final Block block = null;

	public Ground31Block(TextureBlocksModElements instance) {
		super(instance, 307);
	}
