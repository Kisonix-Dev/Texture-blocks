...
public class Panels65Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_65")
	public static final Block block = null;

	public Panels65Block(TextureBlocksModElements instance) {
		super(instance, 1010);
	}
