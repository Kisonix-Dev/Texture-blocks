...
public class Cobblestone3Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_3")
	public static final Block block = null;

	public Cobblestone3Block(TextureBlocksModElements instance) {
		super(instance, 150);
	}
