...
public class Parquet1Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_1")
	public static final Block block = null;

	public Parquet1Block(TextureBlocksModElements instance) {
		super(instance, 1036);
	}
