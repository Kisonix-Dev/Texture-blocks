...
public class Linoleum27Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_27")
	public static final Block block = null;

	public Linoleum27Block(TextureBlocksModElements instance) {
		super(instance, 779);
	}
