...
public class Stone8Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:stone_8")
	public static final Block block = null;

	public Stone8Block(TextureBlocksModElements instance) {
		super(instance, 531);
	}
