...
public class Cobblestone68Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_68")
	public static final Block block = null;

	public Cobblestone68Block(TextureBlocksModElements instance) {
		super(instance, 215);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_68");
		}
