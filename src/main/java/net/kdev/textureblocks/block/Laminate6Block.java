...
public class Laminate6Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_6")
	public static final Block block = null;

	public Laminate6Block(TextureBlocksModElements instance) {
		super(instance, 662);
	}
