...
public class Tiles7Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_7")
	public static final Block block = null;

	public Tiles7Block(TextureBlocksModElements instance) {
		super(instance, 1357);
	}
