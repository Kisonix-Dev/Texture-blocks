...
public class Linoleum74Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_74")
	public static final Block block = null;

	public Linoleum74Block(TextureBlocksModElements instance) {
		super(instance, 826);
	}
