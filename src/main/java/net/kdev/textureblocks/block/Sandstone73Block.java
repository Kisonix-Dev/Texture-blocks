...
public class Sandstone73Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_73")
	public static final Block block = null;

	public Sandstone73Block(TextureBlocksModElements instance) {
		super(instance, 1327);
	}
