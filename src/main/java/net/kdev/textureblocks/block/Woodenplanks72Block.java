...
public class Woodenplanks72Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_72")
	public static final Block block = null;

	public Woodenplanks72Block(TextureBlocksModElements instance) {
		super(instance, 500);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_72");
		}
