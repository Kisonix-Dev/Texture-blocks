...
public class Sandstone46Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_46")
	public static final Block block = null;

	public Sandstone46Block(TextureBlocksModElements instance) {
		super(instance, 1300);
	}
