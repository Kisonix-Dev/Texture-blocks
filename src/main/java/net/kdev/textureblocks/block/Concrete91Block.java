...
public class Concrete91Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_91")
	public static final Block block = null;

	public Concrete91Block(TextureBlocksModElements instance) {
		super(instance, 143);
	}
