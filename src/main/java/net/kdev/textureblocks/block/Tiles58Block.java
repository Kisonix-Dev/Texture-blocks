...
public class Tiles58Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_58")
	public static final Block block = null;

	public Tiles58Block(TextureBlocksModElements instance) {
		super(instance, 1408);
	}
