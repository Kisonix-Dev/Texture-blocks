...
public class Granite17Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_17")
	public static final Block block = null;

	public Granite17Block(TextureBlocksModElements instance) {
		super(instance, 263);
	}
