...
public class Brick52Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_52")
	public static final Block block = null;

	public Brick52Block(TextureBlocksModElements instance) {
		super(instance, 583);
	}
