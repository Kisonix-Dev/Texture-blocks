...
public class Linoleum54Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_54")
	public static final Block block = null;

	public Linoleum54Block(TextureBlocksModElements instance) {
		super(instance, 806);
	}
