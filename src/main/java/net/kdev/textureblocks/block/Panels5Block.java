...
public class Panels5Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_5")
	public static final Block block = null;

	public Panels5Block(TextureBlocksModElements instance) {
		super(instance, 950);
	}
