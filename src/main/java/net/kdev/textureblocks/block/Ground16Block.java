...
public class Ground16Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_16")
	public static final Block block = null;

	public Ground16Block(TextureBlocksModElements instance) {
		super(instance, 292);
	}
