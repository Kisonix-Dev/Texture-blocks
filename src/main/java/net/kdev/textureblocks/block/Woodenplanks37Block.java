...
public class Woodenplanks37Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_37")
	public static final Block block = null;

	public Woodenplanks37Block(TextureBlocksModElements instance) {
		super(instance, 465);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_37");
		}
