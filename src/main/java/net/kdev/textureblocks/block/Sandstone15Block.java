...
public class Sandstone15Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_15")
	public static final Block block = null;

	public Sandstone15Block(TextureBlocksModElements instance) {
		super(instance, 1269);
	}
