...
public class Panels61Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_61")
	public static final Block block = null;

	public Panels61Block(TextureBlocksModElements instance) {
		super(instance, 1006);
	}
