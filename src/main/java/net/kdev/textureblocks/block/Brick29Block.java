...
public class Brick29Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_29")
	public static final Block block = null;

	public Brick29Block(TextureBlocksModElements instance) {
		super(instance, 560);
	}
