...
public class Wood94Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_94")
	public static final Block block = null;

	public Wood94Block(TextureBlocksModElements instance) {
		super(instance, 426);
	}
