...
public class Concrete39Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_39")
	public static final Block block = null;

	public Concrete39Block(TextureBlocksModElements instance) {
		super(instance, 91);
	}
