...
public class Wallpapers2Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_2")
	public static final Block block = null;

	public Wallpapers2Block(TextureBlocksModElements instance) {
		super(instance, 1129);
	}
