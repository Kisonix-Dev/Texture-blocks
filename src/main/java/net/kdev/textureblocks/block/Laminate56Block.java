...
public class Laminate56Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_56")
	public static final Block block = null;

	public Laminate56Block(TextureBlocksModElements instance) {
		super(instance, 712);
	}
