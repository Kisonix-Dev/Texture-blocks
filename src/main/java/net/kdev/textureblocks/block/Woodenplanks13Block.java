...
public class Woodenplanks13Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_13")
	public static final Block block = null;

	public Woodenplanks13Block(TextureBlocksModElements instance) {
		super(instance, 441);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_13");
		}
