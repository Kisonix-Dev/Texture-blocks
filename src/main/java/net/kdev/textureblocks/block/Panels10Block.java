...
public class Panels10Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_10")
	public static final Block block = null;

	public Panels10Block(TextureBlocksModElements instance) {
		super(instance, 955);
	}
