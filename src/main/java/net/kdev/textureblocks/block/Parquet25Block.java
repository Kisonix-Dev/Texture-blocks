...
public class Parquet25Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_25")
	public static final Block block = null;

	public Parquet25Block(TextureBlocksModElements instance) {
		super(instance, 1060);
	}
