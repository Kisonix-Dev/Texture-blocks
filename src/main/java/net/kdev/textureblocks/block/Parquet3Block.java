...
public class Parquet3Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_3")
	public static final Block block = null;

	public Parquet3Block(TextureBlocksModElements instance) {
		super(instance, 1038);
	}
