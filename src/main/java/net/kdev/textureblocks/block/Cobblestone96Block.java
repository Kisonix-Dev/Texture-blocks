...
public class Cobblestone96Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_96")
	public static final Block block = null;

	public Cobblestone96Block(TextureBlocksModElements instance) {
		super(instance, 243);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_96");
		}
