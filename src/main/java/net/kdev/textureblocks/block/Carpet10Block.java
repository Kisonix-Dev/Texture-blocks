...
public class Carpet10Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_10")
	public static final Block block = null;

	public Carpet10Block(TextureBlocksModElements instance) {
		super(instance, 638);
	}
