...
public class Panels60Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_60")
	public static final Block block = null;

	public Panels60Block(TextureBlocksModElements instance) {
		super(instance, 1005);
	}
