...
public class Marbletiles85Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_85")
	public static final Block block = null;

	public Marbletiles85Block(TextureBlocksModElements instance) {
		super(instance, 943);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_85");
		}
