...
public class Concrete58Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_58")
	public static final Block block = null;

	public Concrete58Block(TextureBlocksModElements instance) {
		super(instance, 110);
	}
