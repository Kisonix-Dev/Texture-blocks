...
public class Sandstone50Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_50")
	public static final Block block = null;

	public Sandstone50Block(TextureBlocksModElements instance) {
		super(instance, 1304);
	}
