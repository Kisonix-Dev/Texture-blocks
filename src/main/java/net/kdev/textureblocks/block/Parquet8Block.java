...
public class Parquet8Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_8")
	public static final Block block = null;

	public Parquet8Block(TextureBlocksModElements instance) {
		super(instance, 1043);
	}
