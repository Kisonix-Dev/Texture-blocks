...
public class Laminate24Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_24")
	public static final Block block = null;

	public Laminate24Block(TextureBlocksModElements instance) {
		super(instance, 680);
	}
