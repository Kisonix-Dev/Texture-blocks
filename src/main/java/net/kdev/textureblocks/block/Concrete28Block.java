...
public class Concrete28Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_28")
	public static final Block block = null;

	public Concrete28Block(TextureBlocksModElements instance) {
		super(instance, 80);
	}
