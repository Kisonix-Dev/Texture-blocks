...
public class Cobblestone55Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_55")
	public static final Block block = null;

	public Cobblestone55Block(TextureBlocksModElements instance) {
		super(instance, 202);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_55");
		}
