...
public class Wood93Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_93")
	public static final Block block = null;

	public Wood93Block(TextureBlocksModElements instance) {
		super(instance, 425);
	}
