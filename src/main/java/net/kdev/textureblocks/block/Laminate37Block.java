...
public class Laminate37Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_37")
	public static final Block block = null;

	public Laminate37Block(TextureBlocksModElements instance) {
		super(instance, 693);
	}
