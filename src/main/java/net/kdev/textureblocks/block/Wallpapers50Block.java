...
public class Wallpapers50Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_50")
	public static final Block block = null;

	public Wallpapers50Block(TextureBlocksModElements instance) {
		super(instance, 1177);
	}
