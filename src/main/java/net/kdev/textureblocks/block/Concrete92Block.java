...
public class Concrete92Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_92")
	public static final Block block = null;

	public Concrete92Block(TextureBlocksModElements instance) {
		super(instance, 144);
	}
