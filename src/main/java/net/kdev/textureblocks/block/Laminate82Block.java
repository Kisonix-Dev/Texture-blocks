...
public class Laminate82Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_82")
	public static final Block block = null;

	public Laminate82Block(TextureBlocksModElements instance) {
		super(instance, 738);
	}
