...
public class Woodenplanks65Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_65")
	public static final Block block = null;

	public Woodenplanks65Block(TextureBlocksModElements instance) {
		super(instance, 493);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_65");
		}
