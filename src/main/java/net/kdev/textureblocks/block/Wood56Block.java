...
public class Wood56Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_56")
	public static final Block block = null;

	public Wood56Block(TextureBlocksModElements instance) {
		super(instance, 388);
	}
