...
public class Linoleum75Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_75")
	public static final Block block = null;

	public Linoleum75Block(TextureBlocksModElements instance) {
		super(instance, 827);
	}
