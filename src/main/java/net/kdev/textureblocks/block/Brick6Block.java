...
public class Brick6Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_6")
	public static final Block block = null;

	public Brick6Block(TextureBlocksModElements instance) {
		super(instance, 537);
	}
