...
public class Sandstone91Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_91")
	public static final Block block = null;

	public Sandstone91Block(TextureBlocksModElements instance) {
		super(instance, 1345);
	}
