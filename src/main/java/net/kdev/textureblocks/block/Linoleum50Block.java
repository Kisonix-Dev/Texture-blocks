...
public class Linoleum50Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_50")
	public static final Block block = null;

	public Linoleum50Block(TextureBlocksModElements instance) {
		super(instance, 802);
	}
