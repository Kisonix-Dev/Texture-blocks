...
public class Concrete61Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_61")
	public static final Block block = null;

	public Concrete61Block(TextureBlocksModElements instance) {
		super(instance, 113);
	}
