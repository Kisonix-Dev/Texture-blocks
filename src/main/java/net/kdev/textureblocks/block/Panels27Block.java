...
public class Panels27Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_27")
	public static final Block block = null;

	public Panels27Block(TextureBlocksModElements instance) {
		super(instance, 972);
	}
