...
public class Panels7Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_7")
	public static final Block block = null;

	public Panels7Block(TextureBlocksModElements instance) {
		super(instance, 952);
	}
