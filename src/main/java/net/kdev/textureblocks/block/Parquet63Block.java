...
public class Parquet63Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_63")
	public static final Block block = null;

	public Parquet63Block(TextureBlocksModElements instance) {
		super(instance, 1098);
	}
