...
public class Wood95Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_95")
	public static final Block block = null;

	public Wood95Block(TextureBlocksModElements instance) {
		super(instance, 427);
	}
