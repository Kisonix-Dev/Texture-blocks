...
public class Linoleum55Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_55")
	public static final Block block = null;

	public Linoleum55Block(TextureBlocksModElements instance) {
		super(instance, 807);
	}
