...
public class Brick26Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_26")
	public static final Block block = null;

	public Brick26Block(TextureBlocksModElements instance) {
		super(instance, 557);
	}
