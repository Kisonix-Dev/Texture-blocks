...
public class Wallpapers89Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_89")
	public static final Block block = null;

	public Wallpapers89Block(TextureBlocksModElements instance) {
		super(instance, 1216);
	}
