...
public class Brick68Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_68")
	public static final Block block = null;

	public Brick68Block(TextureBlocksModElements instance) {
		super(instance, 599);
	}
