...
public class Tiles90Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_90")
	public static final Block block = null;

	public Tiles90Block(TextureBlocksModElements instance) {
		super(instance, 1440);
	}
