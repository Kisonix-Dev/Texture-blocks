...
public class Wallpapers11Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_11")
	public static final Block block = null;

	public Wallpapers11Block(TextureBlocksModElements instance) {
		super(instance, 1138);
	}
