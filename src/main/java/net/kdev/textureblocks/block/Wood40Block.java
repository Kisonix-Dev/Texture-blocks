...
public class Wood40Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_40")
	public static final Block block = null;

	public Wood40Block(TextureBlocksModElements instance) {
		super(instance, 372);
	}
