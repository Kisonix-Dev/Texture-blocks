...
public class Cobblestone73Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_73")
	public static final Block block = null;

	public Cobblestone73Block(TextureBlocksModElements instance) {
		super(instance, 220);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_73");
		}
