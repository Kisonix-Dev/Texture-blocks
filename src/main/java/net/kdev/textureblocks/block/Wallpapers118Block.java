...
public class Wallpapers118Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_118")
	public static final Block block = null;

	public Wallpapers118Block(TextureBlocksModElements instance) {
		super(instance, 1245);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_118");
		}
