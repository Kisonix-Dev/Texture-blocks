...
public class Wood70Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_70")
	public static final Block block = null;

	public Wood70Block(TextureBlocksModElements instance) {
		super(instance, 402);
	}
