...
public class Concrete64Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_64")
	public static final Block block = null;

	public Concrete64Block(TextureBlocksModElements instance) {
		super(instance, 116);
	}
