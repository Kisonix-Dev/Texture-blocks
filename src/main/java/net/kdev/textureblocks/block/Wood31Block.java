...
public class Wood31Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_31")
	public static final Block block = null;

	public Wood31Block(TextureBlocksModElements instance) {
		super(instance, 363);
	}
