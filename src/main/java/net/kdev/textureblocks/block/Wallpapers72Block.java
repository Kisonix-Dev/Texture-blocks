...
public class Wallpapers72Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_72")
	public static final Block block = null;

	public Wallpapers72Block(TextureBlocksModElements instance) {
		super(instance, 1199);
	}
