...
public class Woodenplanks83Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_83")
	public static final Block block = null;

	public Woodenplanks83Block(TextureBlocksModElements instance) {
		super(instance, 511);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_83");
		}
