...
public class Cobblestone78Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_78")
	public static final Block block = null;

	public Cobblestone78Block(TextureBlocksModElements instance) {
		super(instance, 225);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_78");
		}
