...
public class Woodenplanks82Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_82")
	public static final Block block = null;

	public Woodenplanks82Block(TextureBlocksModElements instance) {
		super(instance, 510);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_82");
		}
