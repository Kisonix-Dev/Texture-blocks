...
public class Linoleum53Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_53")
	public static final Block block = null;

	public Linoleum53Block(TextureBlocksModElements instance) {
		super(instance, 805);
	}
