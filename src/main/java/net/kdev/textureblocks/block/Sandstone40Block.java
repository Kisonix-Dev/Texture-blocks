...
public class Sandstone40Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_40")
	public static final Block block = null;

	public Sandstone40Block(TextureBlocksModElements instance) {
		super(instance, 1294);
	}
