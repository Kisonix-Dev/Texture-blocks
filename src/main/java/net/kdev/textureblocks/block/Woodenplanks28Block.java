...
public class Woodenplanks28Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_28")
	public static final Block block = null;

	public Woodenplanks28Block(TextureBlocksModElements instance) {
		super(instance, 456);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_28");
		}
