...
public class Granite19Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_19")
	public static final Block block = null;

	public Granite19Block(TextureBlocksModElements instance) {
		super(instance, 265);
	}
