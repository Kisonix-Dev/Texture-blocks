...
public class Tiles26Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_26")
	public static final Block block = null;

	public Tiles26Block(TextureBlocksModElements instance) {
		super(instance, 1376);
	}
