...
public class Linoleum41Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_41")
	public static final Block block = null;

	public Linoleum41Block(TextureBlocksModElements instance) {
		super(instance, 793);
	}
