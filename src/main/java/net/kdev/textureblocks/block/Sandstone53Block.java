...
public class Sandstone53Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_53")
	public static final Block block = null;

	public Sandstone53Block(TextureBlocksModElements instance) {
		super(instance, 1307);
	}
