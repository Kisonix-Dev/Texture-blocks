...
public class Concrete2Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_2")
	public static final Block block = null;

	public Concrete2Block(TextureBlocksModElements instance) {
		super(instance, 54);
	}
