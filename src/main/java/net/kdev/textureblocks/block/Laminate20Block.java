...
public class Laminate20Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_20")
	public static final Block block = null;

	public Laminate20Block(TextureBlocksModElements instance) {
		super(instance, 676);
	}
