...
public class Laminate13Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_13")
	public static final Block block = null;

	public Laminate13Block(TextureBlocksModElements instance) {
		super(instance, 669);
	}
