...
public class Brick95Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_95")
	public static final Block block = null;

	public Brick95Block(TextureBlocksModElements instance) {
		super(instance, 626);
	}
