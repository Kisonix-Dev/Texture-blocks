...
public class Wallpapers56Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_56")
	public static final Block block = null;

	public Wallpapers56Block(TextureBlocksModElements instance) {
		super(instance, 1183);
	}
