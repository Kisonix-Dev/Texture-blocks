...
public class Cobblestone1Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_1")
	public static final Block block = null;

	public Cobblestone1Block(TextureBlocksModElements instance) {
		super(instance, 148);
	}
