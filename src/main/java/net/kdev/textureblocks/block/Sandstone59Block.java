...
public class Sandstone59Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_59")
	public static final Block block = null;

	public Sandstone59Block(TextureBlocksModElements instance) {
		super(instance, 1313);
	}
