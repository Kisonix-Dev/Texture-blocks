...
public class Woodenplanks25Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_25")
	public static final Block block = null;

	public Woodenplanks25Block(TextureBlocksModElements instance) {
		super(instance, 453);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_25");
		}
