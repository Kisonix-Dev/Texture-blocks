...
public class Ground35Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_35")
	public static final Block block = null;

	public Ground35Block(TextureBlocksModElements instance) {
		super(instance, 311);
	}
