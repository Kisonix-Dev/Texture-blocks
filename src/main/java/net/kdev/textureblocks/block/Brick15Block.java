...
public class Brick15Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_15")
	public static final Block block = null;

	public Brick15Block(TextureBlocksModElements instance) {
		super(instance, 546);
	}
