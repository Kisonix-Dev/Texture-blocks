...
public class Sandstone54Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_54")
	public static final Block block = null;

	public Sandstone54Block(TextureBlocksModElements instance) {
		super(instance, 1308);
	}
