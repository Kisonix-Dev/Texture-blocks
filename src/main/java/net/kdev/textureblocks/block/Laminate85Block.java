...
public class Laminate85Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_85")
	public static final Block block = null;

	public Laminate85Block(TextureBlocksModElements instance) {
		super(instance, 741);
	}
