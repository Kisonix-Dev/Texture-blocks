...
public class Concrete48Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_48")
	public static final Block block = null;

	public Concrete48Block(TextureBlocksModElements instance) {
		super(instance, 100);
	}
