...
public class Wallpapers41Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_41")
	public static final Block block = null;

	public Wallpapers41Block(TextureBlocksModElements instance) {
		super(instance, 1168);
	}
