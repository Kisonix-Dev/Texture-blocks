...
public class Tiles2Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_2")
	public static final Block block = null;

	public Tiles2Block(TextureBlocksModElements instance) {
		super(instance, 1352);
	}
