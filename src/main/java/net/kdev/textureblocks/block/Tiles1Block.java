...
public class Tiles1Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_1")
	public static final Block block = null;

	public Tiles1Block(TextureBlocksModElements instance) {
		super(instance, 1351);
	}
