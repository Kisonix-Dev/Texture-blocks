...
public class Linoleum29Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_29")
	public static final Block block = null;

	public Linoleum29Block(TextureBlocksModElements instance) {
		super(instance, 781);
	}
