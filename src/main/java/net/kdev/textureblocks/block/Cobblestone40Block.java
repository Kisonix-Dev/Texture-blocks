...
public class Cobblestone40Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_40")
	public static final Block block = null;

	public Cobblestone40Block(TextureBlocksModElements instance) {
		super(instance, 187);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_40");
		}
