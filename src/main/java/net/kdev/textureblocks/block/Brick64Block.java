...
public class Brick64Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_64")
	public static final Block block = null;

	public Brick64Block(TextureBlocksModElements instance) {
		super(instance, 595);
	}
