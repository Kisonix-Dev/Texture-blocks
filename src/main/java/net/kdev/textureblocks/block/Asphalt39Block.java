...
public class Asphalt39Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_39_1")
	public static final Block block = null;

	public Asphalt39Block(TextureBlocksModElements instance) {
		super(instance, 42);
	}
