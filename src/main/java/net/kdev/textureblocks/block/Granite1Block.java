...
public class Granite1Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_1")
	public static final Block block = null;

	public Granite1Block(TextureBlocksModElements instance) {
		super(instance, 247);
	}
