...
public class Parquet32Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_32")
	public static final Block block = null;

	public Parquet32Block(TextureBlocksModElements instance) {
		super(instance, 1067);
	}
