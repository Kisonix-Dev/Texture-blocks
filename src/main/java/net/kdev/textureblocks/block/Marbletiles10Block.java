...
public class Marbletiles10Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_10")
	public static final Block block = null;

	public Marbletiles10Block(TextureBlocksModElements instance) {
		super(instance, 868);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_10");
		}
