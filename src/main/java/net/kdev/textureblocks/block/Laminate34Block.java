...
public class Laminate34Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_34")
	public static final Block block = null;

	public Laminate34Block(TextureBlocksModElements instance) {
		super(instance, 690);
	}
