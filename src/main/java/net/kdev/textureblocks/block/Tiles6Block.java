...
public class Tiles6Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_6")
	public static final Block block = null;

	public Tiles6Block(TextureBlocksModElements instance) {
		super(instance, 1356);
	}
