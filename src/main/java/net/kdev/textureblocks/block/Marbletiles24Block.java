...
public class Marbletiles24Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_24")
	public static final Block block = null;

	public Marbletiles24Block(TextureBlocksModElements instance) {
		super(instance, 882);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_24");
		}
