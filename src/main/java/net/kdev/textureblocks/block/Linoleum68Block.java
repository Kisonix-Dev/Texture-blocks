...
public class Linoleum68Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_68")
	public static final Block block = null;

	public Linoleum68Block(TextureBlocksModElements instance) {
		super(instance, 820);
	}
