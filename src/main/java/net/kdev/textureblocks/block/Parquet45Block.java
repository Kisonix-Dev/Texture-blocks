...
public class Parquet45Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_45")
	public static final Block block = null;

	public Parquet45Block(TextureBlocksModElements instance) {
		super(instance, 1080);
	}
