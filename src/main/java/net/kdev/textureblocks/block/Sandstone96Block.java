...
public class Sandstone96Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_96")
	public static final Block block = null;

	public Sandstone96Block(TextureBlocksModElements instance) {
		super(instance, 1350);
	}
