...
public class Panels54Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_54")
	public static final Block block = null;

	public Panels54Block(TextureBlocksModElements instance) {
		super(instance, 999);
	}
