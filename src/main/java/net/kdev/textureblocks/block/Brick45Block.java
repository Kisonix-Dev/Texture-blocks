...
public class Brick45Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_45")
	public static final Block block = null;

	public Brick45Block(TextureBlocksModElements instance) {
		super(instance, 576);
	}
