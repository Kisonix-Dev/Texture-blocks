...
public class Wood3Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_3")
	public static final Block block = null;

	public Wood3Block(TextureBlocksModElements instance) {
		super(instance, 335);
	}
