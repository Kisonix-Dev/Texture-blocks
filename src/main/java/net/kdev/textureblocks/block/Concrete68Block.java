...
public class Concrete68Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_68")
	public static final Block block = null;

	public Concrete68Block(TextureBlocksModElements instance) {
		super(instance, 120);
	}
