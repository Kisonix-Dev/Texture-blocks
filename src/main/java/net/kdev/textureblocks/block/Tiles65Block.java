...
public class Tiles65Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_65")
	public static final Block block = null;

	public Tiles65Block(TextureBlocksModElements instance) {
		super(instance, 1415);
	}
