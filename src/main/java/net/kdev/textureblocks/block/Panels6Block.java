...
public class Panels6Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_6")
	public static final Block block = null;

	public Panels6Block(TextureBlocksModElements instance) {
		super(instance, 951);
	}
