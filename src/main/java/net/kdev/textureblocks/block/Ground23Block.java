...
public class Ground23Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_23")
	public static final Block block = null;

	public Ground23Block(TextureBlocksModElements instance) {
		super(instance, 299);
	}
