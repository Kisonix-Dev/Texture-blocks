...
public class Marbletiles45Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_45")
	public static final Block block = null;

	public Marbletiles45Block(TextureBlocksModElements instance) {
		super(instance, 903);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_45");
		}
