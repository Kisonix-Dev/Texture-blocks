...
public class Concrete38Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_38")
	public static final Block block = null;

	public Concrete38Block(TextureBlocksModElements instance) {
		super(instance, 90);
	}
