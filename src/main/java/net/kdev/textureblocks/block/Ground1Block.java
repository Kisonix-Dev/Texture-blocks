...
public class Ground1Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_1")
	public static final Block block = null;

	public Ground1Block(TextureBlocksModElements instance) {
		super(instance, 277);
	}
