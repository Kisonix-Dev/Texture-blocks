...
public class Ground25Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_25")
	public static final Block block = null;

	public Ground25Block(TextureBlocksModElements instance) {
		super(instance, 301);
	}
