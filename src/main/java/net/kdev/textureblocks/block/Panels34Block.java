...
public class Panels34Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_34")
	public static final Block block = null;

	public Panels34Block(TextureBlocksModElements instance) {
		super(instance, 979);
	}
