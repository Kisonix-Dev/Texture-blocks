...
public class Woodenplanks18Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_18")
	public static final Block block = null;

	public Woodenplanks18Block(TextureBlocksModElements instance) {
		super(instance, 446);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_18");
		}
