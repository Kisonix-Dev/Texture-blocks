...
public class Woodenplanks17Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_17")
	public static final Block block = null;

	public Woodenplanks17Block(TextureBlocksModElements instance) {
		super(instance, 445);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_17");
		}
