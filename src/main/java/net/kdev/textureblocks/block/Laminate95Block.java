...
public class Laminate95Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_95")
	public static final Block block = null;

	public Laminate95Block(TextureBlocksModElements instance) {
		super(instance, 751);
	}
