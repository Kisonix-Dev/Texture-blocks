...
public class Asphalt46Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_46_1")
	public static final Block block = null;

	public Asphalt46Block(TextureBlocksModElements instance) {
		super(instance, 49);
	}
