...
public class Cobblestone46Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_46")
	public static final Block block = null;

	public Cobblestone46Block(TextureBlocksModElements instance) {
		super(instance, 193);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_46");
		}
