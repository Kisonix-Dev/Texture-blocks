...
public class Cobblestone38Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_38")
	public static final Block block = null;

	public Cobblestone38Block(TextureBlocksModElements instance) {
		super(instance, 185);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_38");
		}
