...
public class Tiles32Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_32")
	public static final Block block = null;

	public Tiles32Block(TextureBlocksModElements instance) {
		super(instance, 1382);
	}
