...
public class Cobblestone16Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_16")
	public static final Block block = null;

	public Cobblestone16Block(TextureBlocksModElements instance) {
		super(instance, 163);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_16");
		}
