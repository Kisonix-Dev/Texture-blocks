...
public class Woodenplanks20Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_20")
	public static final Block block = null;

	public Woodenplanks20Block(TextureBlocksModElements instance) {
		super(instance, 448);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_20");
		}
