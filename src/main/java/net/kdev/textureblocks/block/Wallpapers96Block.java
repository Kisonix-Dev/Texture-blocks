...
public class Wallpapers96Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_96")
	public static final Block block = null;

	public Wallpapers96Block(TextureBlocksModElements instance) {
		super(instance, 1223);
	}
