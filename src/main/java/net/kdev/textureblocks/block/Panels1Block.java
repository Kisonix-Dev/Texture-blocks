...
public class Panels1Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_1")
	public static final Block block = null;

	public Panels1Block(TextureBlocksModElements instance) {
		super(instance, 946);
	}
