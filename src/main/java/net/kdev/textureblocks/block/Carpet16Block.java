...
public class Carpet16Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_16")
	public static final Block block = null;

	public Carpet16Block(TextureBlocksModElements instance) {
		super(instance, 644);
	}
