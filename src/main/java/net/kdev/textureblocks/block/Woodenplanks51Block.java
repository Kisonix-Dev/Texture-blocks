...
public class Woodenplanks51Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_51")
	public static final Block block = null;

	public Woodenplanks51Block(TextureBlocksModElements instance) {
		super(instance, 479);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_51");
		}
