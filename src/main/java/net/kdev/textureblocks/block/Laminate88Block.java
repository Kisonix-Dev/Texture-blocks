...
public class Laminate88Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_88")
	public static final Block block = null;

	public Laminate88Block(TextureBlocksModElements instance) {
		super(instance, 744);
	}
