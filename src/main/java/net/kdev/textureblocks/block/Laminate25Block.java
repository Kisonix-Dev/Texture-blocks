...
public class Laminate25Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_25")
	public static final Block block = null;

	public Laminate25Block(TextureBlocksModElements instance) {
		super(instance, 681);
	}
