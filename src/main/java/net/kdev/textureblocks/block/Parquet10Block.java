...
public class Parquet10Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_10")
	public static final Block block = null;

	public Parquet10Block(TextureBlocksModElements instance) {
		super(instance, 1045);
	}
