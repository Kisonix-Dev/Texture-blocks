...
public class Wallpapers7Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_7")
	public static final Block block = null;

	public Wallpapers7Block(TextureBlocksModElements instance) {
		super(instance, 1134);
	}
