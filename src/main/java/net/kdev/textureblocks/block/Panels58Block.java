...
public class Panels58Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_58")
	public static final Block block = null;

	public Panels58Block(TextureBlocksModElements instance) {
		super(instance, 1003);
	}
