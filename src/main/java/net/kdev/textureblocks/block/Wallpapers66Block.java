...
public class Wallpapers66Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_66")
	public static final Block block = null;

	public Wallpapers66Block(TextureBlocksModElements instance) {
		super(instance, 1193);
	}
