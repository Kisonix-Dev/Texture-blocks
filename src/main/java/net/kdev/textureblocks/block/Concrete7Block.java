...
public class Concrete7Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_7")
	public static final Block block = null;

	public Concrete7Block(TextureBlocksModElements instance) {
		super(instance, 59);
	}
