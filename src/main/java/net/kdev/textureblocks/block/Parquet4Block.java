...
public class Parquet4Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_4")
	public static final Block block = null;

	public Parquet4Block(TextureBlocksModElements instance) {
		super(instance, 1039);
	}
