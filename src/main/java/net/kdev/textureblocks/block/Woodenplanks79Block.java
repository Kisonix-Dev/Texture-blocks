...
public class Woodenplanks79Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_79")
	public static final Block block = null;

	public Woodenplanks79Block(TextureBlocksModElements instance) {
		super(instance, 507);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_79");
		}
