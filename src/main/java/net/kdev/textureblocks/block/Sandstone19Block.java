...
public class Sandstone19Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_19")
	public static final Block block = null;

	public Sandstone19Block(TextureBlocksModElements instance) {
		super(instance, 1273);
	}
