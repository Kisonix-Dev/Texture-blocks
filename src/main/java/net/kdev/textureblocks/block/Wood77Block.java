...
public class Wood77Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_77")
	public static final Block block = null;

	public Wood77Block(TextureBlocksModElements instance) {
		super(instance, 409);
	}
