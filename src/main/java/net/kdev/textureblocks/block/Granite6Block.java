...
public class Granite6Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_6")
	public static final Block block = null;

	public Granite6Block(TextureBlocksModElements instance) {
		super(instance, 252);
	}
