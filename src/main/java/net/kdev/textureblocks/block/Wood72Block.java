...
public class Wood72Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_72")
	public static final Block block = null;

	public Wood72Block(TextureBlocksModElements instance) {
		super(instance, 404);
	}
