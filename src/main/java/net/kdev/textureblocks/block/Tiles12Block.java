...
public class Tiles12Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_12")
	public static final Block block = null;

	public Tiles12Block(TextureBlocksModElements instance) {
		super(instance, 1362);
	}
