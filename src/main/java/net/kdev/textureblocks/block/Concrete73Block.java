...
public class Concrete73Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_73")
	public static final Block block = null;

	public Concrete73Block(TextureBlocksModElements instance) {
		super(instance, 125);
	}
