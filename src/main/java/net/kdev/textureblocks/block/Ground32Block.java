...
public class Ground32Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_32")
	public static final Block block = null;

	public Ground32Block(TextureBlocksModElements instance) {
		super(instance, 308);
	}
