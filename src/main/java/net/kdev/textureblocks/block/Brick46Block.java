...
public class Brick46Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_46")
	public static final Block block = null;

	public Brick46Block(TextureBlocksModElements instance) {
		super(instance, 577);
	}
