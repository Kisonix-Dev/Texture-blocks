...
public class Parquet59Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_59")
	public static final Block block = null;

	public Parquet59Block(TextureBlocksModElements instance) {
		super(instance, 1094);
	}
