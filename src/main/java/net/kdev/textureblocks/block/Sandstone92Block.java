...
public class Sandstone92Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_92")
	public static final Block block = null;

	public Sandstone92Block(TextureBlocksModElements instance) {
		super(instance, 1346);
	}
