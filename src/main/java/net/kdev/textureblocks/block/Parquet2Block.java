...
public class Parquet2Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_2")
	public static final Block block = null;

	public Parquet2Block(TextureBlocksModElements instance) {
		super(instance, 1037);
	}
