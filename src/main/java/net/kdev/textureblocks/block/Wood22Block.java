...
public class Wood22Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_22")
	public static final Block block = null;

	public Wood22Block(TextureBlocksModElements instance) {
		super(instance, 354);
	}
