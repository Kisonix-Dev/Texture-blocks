...
public class Laminate59Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_59")
	public static final Block block = null;

	public Laminate59Block(TextureBlocksModElements instance) {
		super(instance, 715);
	}
