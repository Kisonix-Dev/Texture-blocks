...
public class Cobblestone58Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_58")
	public static final Block block = null;

	public Cobblestone58Block(TextureBlocksModElements instance) {
		super(instance, 205);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_58");
		}
