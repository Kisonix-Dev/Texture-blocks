...
public class Concrete11Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_11")
	public static final Block block = null;

	public Concrete11Block(TextureBlocksModElements instance) {
		super(instance, 63);
	}
