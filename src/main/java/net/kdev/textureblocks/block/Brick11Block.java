...
public class Brick11Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_11")
	public static final Block block = null;

	public Brick11Block(TextureBlocksModElements instance) {
		super(instance, 542);
	}
