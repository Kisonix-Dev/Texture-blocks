...
public class Asphalt2Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_2_1")
	public static final Block block = null;

	public Asphalt2Block(TextureBlocksModElements instance) {
		super(instance, 3);
	}
