...
public class Wallpapers23Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_23")
	public static final Block block = null;

	public Wallpapers23Block(TextureBlocksModElements instance) {
		super(instance, 1150);
	}
