...
public class Tiles68Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_68")
	public static final Block block = null;

	public Tiles68Block(TextureBlocksModElements instance) {
		super(instance, 1418);
	}
