...
public class Brick63Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_63")
	public static final Block block = null;

	public Brick63Block(TextureBlocksModElements instance) {
		super(instance, 594);
	}
