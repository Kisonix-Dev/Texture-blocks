...
public class Laminate90Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_90")
	public static final Block block = null;

	public Laminate90Block(TextureBlocksModElements instance) {
		super(instance, 746);
	}
