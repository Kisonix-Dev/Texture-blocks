...
public class Wallpapers67Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_67")
	public static final Block block = null;

	public Wallpapers67Block(TextureBlocksModElements instance) {
		super(instance, 1194);
	}
