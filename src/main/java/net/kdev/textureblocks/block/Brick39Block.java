...
public class Brick39Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_39")
	public static final Block block = null;

	public Brick39Block(TextureBlocksModElements instance) {
		super(instance, 570);
	}
