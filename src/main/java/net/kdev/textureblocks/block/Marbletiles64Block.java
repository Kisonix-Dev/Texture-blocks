...
public class Marbletiles64Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_64")
	public static final Block block = null;

	public Marbletiles64Block(TextureBlocksModElements instance) {
		super(instance, 922);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_64");
		}
