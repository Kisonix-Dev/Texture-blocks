...
public class Laminate64Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_64")
	public static final Block block = null;

	public Laminate64Block(TextureBlocksModElements instance) {
		super(instance, 720);
	}
