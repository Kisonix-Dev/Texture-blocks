...
public class Cobblestone87Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_87")
	public static final Block block = null;

	public Cobblestone87Block(TextureBlocksModElements instance) {
		super(instance, 234);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_87");
		}
