...
public class Moss1Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:moss_1")
	public static final Block block = null;

	public Moss1Block(TextureBlocksModElements instance) {
		super(instance, 846);
	}
