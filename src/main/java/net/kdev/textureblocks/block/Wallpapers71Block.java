...
public class Wallpapers71Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_71")
	public static final Block block = null;

	public Wallpapers71Block(TextureBlocksModElements instance) {
		super(instance, 1198);
	}
