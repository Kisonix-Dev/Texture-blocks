...
public class Ground36Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_36")
	public static final Block block = null;

	public Ground36Block(TextureBlocksModElements instance) {
		super(instance, 312);
	}
