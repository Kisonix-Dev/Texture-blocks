...
public class Laminate69Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_69")
	public static final Block block = null;

	public Laminate69Block(TextureBlocksModElements instance) {
		super(instance, 725);
	}
