...
public class Marbletiles81Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_81")
	public static final Block block = null;

	public Marbletiles81Block(TextureBlocksModElements instance) {
		super(instance, 939);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_81");
		}
