...
public class Dirt5Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:dirt_5")
	public static final Block block = null;

	public Dirt5Block(TextureBlocksModElements instance) {
		super(instance, 327);
	}
