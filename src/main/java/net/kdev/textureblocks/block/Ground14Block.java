...
public class Ground14Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_14")
	public static final Block block = null;

	public Ground14Block(TextureBlocksModElements instance) {
		super(instance, 290);
	}
