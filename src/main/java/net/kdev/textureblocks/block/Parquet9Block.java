...
public class Parquet9Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_9")
	public static final Block block = null;

	public Parquet9Block(TextureBlocksModElements instance) {
		super(instance, 1044);
	}
