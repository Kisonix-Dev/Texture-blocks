...
public class Linoleum16Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_16")
	public static final Block block = null;

	public Linoleum16Block(TextureBlocksModElements instance) {
		super(instance, 768);
	}
