...
public class Cobblestone19Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_19")
	public static final Block block = null;

	public Cobblestone19Block(TextureBlocksModElements instance) {
		super(instance, 166);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_19");
		}
