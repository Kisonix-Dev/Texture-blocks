...
public class Sandstone21Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_21")
	public static final Block block = null;

	public Sandstone21Block(TextureBlocksModElements instance) {
		super(instance, 1275);
	}
