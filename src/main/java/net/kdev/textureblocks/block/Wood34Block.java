...
public class Wood34Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_34")
	public static final Block block = null;

	public Wood34Block(TextureBlocksModElements instance) {
		super(instance, 366);
	}
