...
public class Parquet54Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_54")
	public static final Block block = null;

	public Parquet54Block(TextureBlocksModElements instance) {
		super(instance, 1089);
	}
