...
public class Laminate86Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_86")
	public static final Block block = null;

	public Laminate86Block(TextureBlocksModElements instance) {
		super(instance, 742);
	}
