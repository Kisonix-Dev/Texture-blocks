...
public class Asphalt24Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_24")
	public static final Block block = null;

	public Asphalt24Block(TextureBlocksModElements instance) {
		super(instance, 27);
	}
