...
public class Brick53Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_53")
	public static final Block block = null;

	public Brick53Block(TextureBlocksModElements instance) {
		super(instance, 584);
	}
