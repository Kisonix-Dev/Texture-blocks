...
public class Wallpapers57Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_57")
	public static final Block block = null;

	public Wallpapers57Block(TextureBlocksModElements instance) {
		super(instance, 1184);
	}
