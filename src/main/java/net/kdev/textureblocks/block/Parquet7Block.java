...
public class Parquet7Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_7")
	public static final Block block = null;

	public Parquet7Block(TextureBlocksModElements instance) {
		super(instance, 1042);
	}
