...
public class Brick50Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_50")
	public static final Block block = null;

	public Brick50Block(TextureBlocksModElements instance) {
		super(instance, 581);
	}
