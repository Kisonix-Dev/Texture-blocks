...
public class Wallpapers107Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_107")
	public static final Block block = null;

	public Wallpapers107Block(TextureBlocksModElements instance) {
		super(instance, 1234);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_107");
		}
