...
public class Wood10Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_10")
	public static final Block block = null;

	public Wood10Block(TextureBlocksModElements instance) {
		super(instance, 342);
	}
