...
public class Laminate14Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_14")
	public static final Block block = null;

	public Laminate14Block(TextureBlocksModElements instance) {
		super(instance, 670);
	}
