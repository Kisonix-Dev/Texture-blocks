...
public class Wallpapers45Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_45")
	public static final Block block = null;

	public Wallpapers45Block(TextureBlocksModElements instance) {
		super(instance, 1172);
	}
