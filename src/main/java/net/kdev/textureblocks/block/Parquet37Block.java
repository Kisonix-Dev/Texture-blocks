...
public class Parquet37Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_37")
	public static final Block block = null;

	public Parquet37Block(TextureBlocksModElements instance) {
		super(instance, 1072);
	}
