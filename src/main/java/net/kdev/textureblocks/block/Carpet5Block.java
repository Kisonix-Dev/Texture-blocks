...
public class Carpet5Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_5")
	public static final Block block = null;

	public Carpet5Block(TextureBlocksModElements instance) {
		super(instance, 633);
	}
