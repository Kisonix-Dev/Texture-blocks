...
public class Wallpapers90Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_90")
	public static final Block block = null;

	public Wallpapers90Block(TextureBlocksModElements instance) {
		super(instance, 1217);
	}
