...
public class Sandstone84Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_84")
	public static final Block block = null;

	public Sandstone84Block(TextureBlocksModElements instance) {
		super(instance, 1338);
	}
