...
public class Panels18Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_18")
	public static final Block block = null;

	public Panels18Block(TextureBlocksModElements instance) {
		super(instance, 963);
	}
