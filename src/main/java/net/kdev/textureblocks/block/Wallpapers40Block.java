...
public class Wallpapers40Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_40")
	public static final Block block = null;

	public Wallpapers40Block(TextureBlocksModElements instance) {
		super(instance, 1167);
	}
