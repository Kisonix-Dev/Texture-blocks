...
public class Moss5Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:moss_5")
	public static final Block block = null;

	public Moss5Block(TextureBlocksModElements instance) {
		super(instance, 850);
	}
