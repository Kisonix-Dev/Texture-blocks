...
public class Asphalt19Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_19_1")
	public static final Block block = null;

	public Asphalt19Block(TextureBlocksModElements instance) {
		super(instance, 22);
	}
