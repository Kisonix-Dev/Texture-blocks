...
public class Wallpapers121Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_121")
	public static final Block block = null;

	public Wallpapers121Block(TextureBlocksModElements instance) {
		super(instance, 1248);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_121");
		}
