...
public class Dirt1Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:dirt_1")
	public static final Block block = null;

	public Dirt1Block(TextureBlocksModElements instance) {
		super(instance, 323);
	}
