...
public class Laminate76Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_76")
	public static final Block block = null;

	public Laminate76Block(TextureBlocksModElements instance) {
		super(instance, 732);
	}
