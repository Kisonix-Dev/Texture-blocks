...
public class Wallpapers104Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_104")
	public static final Block block = null;

	public Wallpapers104Block(TextureBlocksModElements instance) {
		super(instance, 1231);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_104");
		}
