...
public class Wood43Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_43")
	public static final Block block = null;

	public Wood43Block(TextureBlocksModElements instance) {
		super(instance, 375);
	}
