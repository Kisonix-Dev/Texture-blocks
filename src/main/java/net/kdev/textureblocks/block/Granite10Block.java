...
public class Granite10Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_10")
	public static final Block block = null;

	public Granite10Block(TextureBlocksModElements instance) {
		super(instance, 256);
	}
