...
public class Parquet39Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_39")
	public static final Block block = null;

	public Parquet39Block(TextureBlocksModElements instance) {
		super(instance, 1074);
	}
