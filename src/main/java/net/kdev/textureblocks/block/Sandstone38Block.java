...
public class Sandstone38Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_38")
	public static final Block block = null;

	public Sandstone38Block(TextureBlocksModElements instance) {
		super(instance, 1292);
	}
