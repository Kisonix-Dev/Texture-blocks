...
public class Parquet44Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_44")
	public static final Block block = null;

	public Parquet44Block(TextureBlocksModElements instance) {
		super(instance, 1079);
	}
