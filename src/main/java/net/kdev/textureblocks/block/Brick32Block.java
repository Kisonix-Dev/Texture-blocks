...
public class Brick32Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_32")
	public static final Block block = null;

	public Brick32Block(TextureBlocksModElements instance) {
		super(instance, 563);
	}
