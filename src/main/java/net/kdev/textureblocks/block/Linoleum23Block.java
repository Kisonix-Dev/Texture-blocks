...
public class Linoleum23Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_23")
	public static final Block block = null;

	public Linoleum23Block(TextureBlocksModElements instance) {
		super(instance, 775);
	}
