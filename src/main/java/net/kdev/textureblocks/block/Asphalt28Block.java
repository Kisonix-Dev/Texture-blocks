...
public class Asphalt28Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_28_1")
	public static final Block block = null;

	public Asphalt28Block(TextureBlocksModElements instance) {
		super(instance, 31);
	}
