...
public class Wood28Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_28")
	public static final Block block = null;

	public Wood28Block(TextureBlocksModElements instance) {
		super(instance, 360);
	}
