...
public class Asphalt16Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_16_1")
	public static final Block block = null;

	public Asphalt16Block(TextureBlocksModElements instance) {
		super(instance, 19);
	}
