...
public class Asphalt34Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_34_1")
	public static final Block block = null;

	public Asphalt34Block(TextureBlocksModElements instance) {
		super(instance, 37);
	}
