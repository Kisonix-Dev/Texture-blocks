...
public class Asphalt37Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_37_1")
	public static final Block block = null;

	public Asphalt37Block(TextureBlocksModElements instance) {
		super(instance, 40);
	}
