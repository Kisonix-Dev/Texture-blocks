...
public class Sandstone2Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_2")
	public static final Block block = null;

	public Sandstone2Block(TextureBlocksModElements instance) {
		super(instance, 1256);
	}
