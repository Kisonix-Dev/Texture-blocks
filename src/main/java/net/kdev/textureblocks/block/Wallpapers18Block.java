...
public class Wallpapers18Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_18")
	public static final Block block = null;

	public Wallpapers18Block(TextureBlocksModElements instance) {
		super(instance, 1145);
	}
