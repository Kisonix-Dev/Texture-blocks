...
public class Granite21Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_21")
	public static final Block block = null;

	public Granite21Block(TextureBlocksModElements instance) {
		super(instance, 267);
	}
