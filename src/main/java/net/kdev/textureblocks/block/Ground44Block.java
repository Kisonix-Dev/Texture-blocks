...
public class Ground44Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_44")
	public static final Block block = null;

	public Ground44Block(TextureBlocksModElements instance) {
		super(instance, 320);
	}
