...
public class Concrete53Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_53")
	public static final Block block = null;

	public Concrete53Block(TextureBlocksModElements instance) {
		super(instance, 105);
	}
