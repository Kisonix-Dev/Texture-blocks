...
public class Ground28Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_28")
	public static final Block block = null;

	public Ground28Block(TextureBlocksModElements instance) {
		super(instance, 304);
	}
