...
public class Wallpapers54Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_54")
	public static final Block block = null;

	public Wallpapers54Block(TextureBlocksModElements instance) {
		super(instance, 1181);
	}
