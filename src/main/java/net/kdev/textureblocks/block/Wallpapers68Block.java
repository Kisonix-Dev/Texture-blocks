...
public class Wallpapers68Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_68")
	public static final Block block = null;

	public Wallpapers68Block(TextureBlocksModElements instance) {
		super(instance, 1195);
	}
