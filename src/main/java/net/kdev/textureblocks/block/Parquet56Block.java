...
public class Parquet56Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_56")
	public static final Block block = null;

	public Parquet56Block(TextureBlocksModElements instance) {
		super(instance, 1091);
	}
