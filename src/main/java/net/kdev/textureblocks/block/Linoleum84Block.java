...
public class Linoleum84Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_84")
	public static final Block block = null;

	public Linoleum84Block(TextureBlocksModElements instance) {
		super(instance, 836);
	}
