...
public class Wallpapers33Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_33")
	public static final Block block = null;

	public Wallpapers33Block(TextureBlocksModElements instance) {
		super(instance, 1160);
	}
