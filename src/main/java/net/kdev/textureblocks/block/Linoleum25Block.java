...
public class Linoleum25Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_25")
	public static final Block block = null;

	public Linoleum25Block(TextureBlocksModElements instance) {
		super(instance, 777);
	}
