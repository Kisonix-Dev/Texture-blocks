...
public class Sandstone37Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_37")
	public static final Block block = null;

	public Sandstone37Block(TextureBlocksModElements instance) {
		super(instance, 1291);
	}
