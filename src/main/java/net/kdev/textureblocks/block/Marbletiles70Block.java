...
public class Marbletiles70Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_70")
	public static final Block block = null;

	public Marbletiles70Block(TextureBlocksModElements instance) {
		super(instance, 928);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_70");
		}
