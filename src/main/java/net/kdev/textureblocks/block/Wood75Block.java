...
public class Wood75Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_75")
	public static final Block block = null;

	public Wood75Block(TextureBlocksModElements instance) {
		super(instance, 407);
	}
