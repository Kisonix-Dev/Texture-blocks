...
public class Laminate92Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_92")
	public static final Block block = null;

	public Laminate92Block(TextureBlocksModElements instance) {
		super(instance, 748);
	}
