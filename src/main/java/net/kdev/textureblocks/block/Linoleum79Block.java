...
public class Linoleum79Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_79")
	public static final Block block = null;

	public Linoleum79Block(TextureBlocksModElements instance) {
		super(instance, 831);
	}
