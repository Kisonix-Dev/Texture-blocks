...
public class Wood57Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_57")
	public static final Block block = null;

	public Wood57Block(TextureBlocksModElements instance) {
		super(instance, 389);
	}
