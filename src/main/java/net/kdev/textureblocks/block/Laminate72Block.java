...
public class Laminate72Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_72")
	public static final Block block = null;

	public Laminate72Block(TextureBlocksModElements instance) {
		super(instance, 728);
	}
