...
public class Linoleum45Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_45")
	public static final Block block = null;

	public Linoleum45Block(TextureBlocksModElements instance) {
		super(instance, 797);
	}
