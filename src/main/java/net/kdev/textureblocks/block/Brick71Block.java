...
public class Brick71Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_71")
	public static final Block block = null;

	public Brick71Block(TextureBlocksModElements instance) {
		super(instance, 602);
	}
