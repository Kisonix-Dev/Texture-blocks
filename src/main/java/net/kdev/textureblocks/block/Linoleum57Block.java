...
public class Linoleum57Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_57")
	public static final Block block = null;

	public Linoleum57Block(TextureBlocksModElements instance) {
		super(instance, 809);
	}
