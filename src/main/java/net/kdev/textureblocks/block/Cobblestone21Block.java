...
public class Cobblestone21Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_21")
	public static final Block block = null;

	public Cobblestone21Block(TextureBlocksModElements instance) {
		super(instance, 168);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_21");
		}
