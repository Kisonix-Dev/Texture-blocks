...
public class Linoleum6Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_6")
	public static final Block block = null;

	public Linoleum6Block(TextureBlocksModElements instance) {
		super(instance, 758);
	}
