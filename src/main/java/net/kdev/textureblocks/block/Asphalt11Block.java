...
public class Asphalt11Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_11_1")
	public static final Block block = null;

	public Asphalt11Block(TextureBlocksModElements instance) {
		super(instance, 14);
	}
