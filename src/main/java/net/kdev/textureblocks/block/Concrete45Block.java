...
public class Concrete45Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_45")
	public static final Block block = null;

	public Concrete45Block(TextureBlocksModElements instance) {
		super(instance, 97);
	}
