...
public class Wood69Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_69")
	public static final Block block = null;

	public Wood69Block(TextureBlocksModElements instance) {
		super(instance, 401);
	}
