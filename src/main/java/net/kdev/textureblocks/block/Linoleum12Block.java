...
public class Linoleum12Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_12")
	public static final Block block = null;

	public Linoleum12Block(TextureBlocksModElements instance) {
		super(instance, 764);
	}
