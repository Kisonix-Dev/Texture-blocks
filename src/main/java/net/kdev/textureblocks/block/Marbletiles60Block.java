...
public class Marbletiles60Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_60")
	public static final Block block = null;

	public Marbletiles60Block(TextureBlocksModElements instance) {
		super(instance, 918);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_60");
		}
