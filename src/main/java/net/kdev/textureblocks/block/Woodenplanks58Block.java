...
public class Woodenplanks58Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_58")
	public static final Block block = null;

	public Woodenplanks58Block(TextureBlocksModElements instance) {
		super(instance, 486);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_58");
		}
