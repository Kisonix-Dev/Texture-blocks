...
public class Concrete34Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_34")
	public static final Block block = null;

	public Concrete34Block(TextureBlocksModElements instance) {
		super(instance, 86);
	}
