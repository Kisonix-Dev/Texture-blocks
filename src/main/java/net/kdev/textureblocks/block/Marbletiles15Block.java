...
public class Marbletiles15Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_15")
	public static final Block block = null;

	public Marbletiles15Block(TextureBlocksModElements instance) {
		super(instance, 873);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_15");
		}
