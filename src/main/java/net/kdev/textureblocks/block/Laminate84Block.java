...
public class Laminate84Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_84")
	public static final Block block = null;

	public Laminate84Block(TextureBlocksModElements instance) {
		super(instance, 740);
	}
