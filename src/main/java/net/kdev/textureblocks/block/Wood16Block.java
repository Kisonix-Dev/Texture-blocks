...
public class Wood16Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_16")
	public static final Block block = null;

	public Wood16Block(TextureBlocksModElements instance) {
		super(instance, 348);
	}
