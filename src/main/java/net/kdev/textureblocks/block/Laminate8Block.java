...
public class Laminate8Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_8")
	public static final Block block = null;

	public Laminate8Block(TextureBlocksModElements instance) {
		super(instance, 664);
	}
