...
public class Wallpapers25Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_25")
	public static final Block block = null;

	public Wallpapers25Block(TextureBlocksModElements instance) {
		super(instance, 1152);
	}
