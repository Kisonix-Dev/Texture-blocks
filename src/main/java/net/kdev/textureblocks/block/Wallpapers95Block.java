...
public class Wallpapers95Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_95")
	public static final Block block = null;

	public Wallpapers95Block(TextureBlocksModElements instance) {
		super(instance, 1222);
	}
