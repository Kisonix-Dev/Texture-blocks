...
public class Wallpapers92Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_92")
	public static final Block block = null;

	public Wallpapers92Block(TextureBlocksModElements instance) {
		super(instance, 1219);
	}
