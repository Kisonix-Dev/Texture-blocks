...
public class Brick47Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_47")
	public static final Block block = null;

	public Brick47Block(TextureBlocksModElements instance) {
		super(instance, 578);
	}
