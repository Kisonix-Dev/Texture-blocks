...
public class Wood26Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_26")
	public static final Block block = null;

	public Wood26Block(TextureBlocksModElements instance) {
		super(instance, 358);
	}
