...
public class Sandstone13Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_13")
	public static final Block block = null;

	public Sandstone13Block(TextureBlocksModElements instance) {
		super(instance, 1267);
	}
