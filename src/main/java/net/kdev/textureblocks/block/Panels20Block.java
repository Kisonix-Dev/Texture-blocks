...
public class Panels20Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_20")
	public static final Block block = null;

	public Panels20Block(TextureBlocksModElements instance) {
		super(instance, 965);
	}
