...
public class Panels30Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_30")
	public static final Block block = null;

	public Panels30Block(TextureBlocksModElements instance) {
		super(instance, 975);
	}
