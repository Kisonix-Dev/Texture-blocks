...
public class Parquet35Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_35")
	public static final Block block = null;

	public Parquet35Block(TextureBlocksModElements instance) {
		super(instance, 1070);
	}
