...
public class Sandstone31Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_31")
	public static final Block block = null;

	public Sandstone31Block(TextureBlocksModElements instance) {
		super(instance, 1285);
	}
