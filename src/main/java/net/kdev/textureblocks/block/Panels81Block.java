...
public class Panels81Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_81")
	public static final Block block = null;

	public Panels81Block(TextureBlocksModElements instance) {
		super(instance, 1026);
	}
