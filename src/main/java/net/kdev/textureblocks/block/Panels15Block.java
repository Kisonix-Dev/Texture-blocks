...
public class Panels15Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_15")
	public static final Block block = null;

	public Panels15Block(TextureBlocksModElements instance) {
		super(instance, 960);
	}
