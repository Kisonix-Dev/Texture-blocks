...
public class Dirt9Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:dirt_9")
	public static final Block block = null;

	public Dirt9Block(TextureBlocksModElements instance) {
		super(instance, 331);
	}
