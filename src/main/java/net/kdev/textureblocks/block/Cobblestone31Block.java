...
public class Cobblestone31Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_31")
	public static final Block block = null;

	public Cobblestone31Block(TextureBlocksModElements instance) {
		super(instance, 178);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_31");
		}
