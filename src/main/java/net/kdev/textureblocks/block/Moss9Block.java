...
public class Moss9Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:moss_9")
	public static final Block block = null;

	public Moss9Block(TextureBlocksModElements instance) {
		super(instance, 854);
	}
