...
public class Linoleum76Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_76")
	public static final Block block = null;

	public Linoleum76Block(TextureBlocksModElements instance) {
		super(instance, 828);
	}
