...
public class Marbletiles47Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_47")
	public static final Block block = null;

	public Marbletiles47Block(TextureBlocksModElements instance) {
		super(instance, 905);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_47");
		}
