...
public class Panels39Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_39")
	public static final Block block = null;

	public Panels39Block(TextureBlocksModElements instance) {
		super(instance, 984);
	}
