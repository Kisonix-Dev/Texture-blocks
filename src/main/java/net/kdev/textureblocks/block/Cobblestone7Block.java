...
public class Cobblestone7Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_7")
	public static final Block block = null;

	public Cobblestone7Block(TextureBlocksModElements instance) {
		super(instance, 154);
	}
