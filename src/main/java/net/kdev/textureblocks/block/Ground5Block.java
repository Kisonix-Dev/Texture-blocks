...
public class Ground5Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_5")
	public static final Block block = null;

	public Ground5Block(TextureBlocksModElements instance) {
		super(instance, 281);
	}
