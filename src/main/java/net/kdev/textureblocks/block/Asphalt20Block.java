...
public class Asphalt20Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_20_1")
	public static final Block block = null;

	public Asphalt20Block(TextureBlocksModElements instance) {
		super(instance, 23);
	}
