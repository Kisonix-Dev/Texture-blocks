...
public class Tiles86Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_86")
	public static final Block block = null;

	public Tiles86Block(TextureBlocksModElements instance) {
		super(instance, 1436);
	}
