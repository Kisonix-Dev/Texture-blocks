...
public class Tiles82Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_82")
	public static final Block block = null;

	public Tiles82Block(TextureBlocksModElements instance) {
		super(instance, 1432);
	}
