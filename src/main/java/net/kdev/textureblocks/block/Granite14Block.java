...
public class Granite14Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_14")
	public static final Block block = null;

	public Granite14Block(TextureBlocksModElements instance) {
		super(instance, 260);
	}
