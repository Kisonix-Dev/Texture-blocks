...
public class Sandstone42Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_42")
	public static final Block block = null;

	public Sandstone42Block(TextureBlocksModElements instance) {
		super(instance, 1296);
	}
