...
public class Moss7Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:moss_7")
	public static final Block block = null;

	public Moss7Block(TextureBlocksModElements instance) {
		super(instance, 852);
	}
