...
public class Cobblestone88Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_88")
	public static final Block block = null;

	public Cobblestone88Block(TextureBlocksModElements instance) {
		super(instance, 235);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_88");
		}
