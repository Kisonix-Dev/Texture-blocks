...
public class Wallpapers6Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_6")
	public static final Block block = null;

	public Wallpapers6Block(TextureBlocksModElements instance) {
		super(instance, 1133);
	}
