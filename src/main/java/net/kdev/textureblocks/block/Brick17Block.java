...
public class Brick17Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_17")
	public static final Block block = null;

	public Brick17Block(TextureBlocksModElements instance) {
		super(instance, 548);
	}
