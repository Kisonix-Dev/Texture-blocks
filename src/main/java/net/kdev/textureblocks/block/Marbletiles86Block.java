...
public class Marbletiles86Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_86")
	public static final Block block = null;

	public Marbletiles86Block(TextureBlocksModElements instance) {
		super(instance, 944);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_86");
		}
