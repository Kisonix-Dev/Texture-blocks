...
public class Concrete25Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_25")
	public static final Block block = null;

	public Concrete25Block(TextureBlocksModElements instance) {
		super(instance, 77);
	}
