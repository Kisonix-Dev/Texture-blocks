...
public class Sandstone41Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_41")
	public static final Block block = null;

	public Sandstone41Block(TextureBlocksModElements instance) {
		super(instance, 1295);
	}
