...
public class Tiles19Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_19")
	public static final Block block = null;

	public Tiles19Block(TextureBlocksModElements instance) {
		super(instance, 1369);
	}
