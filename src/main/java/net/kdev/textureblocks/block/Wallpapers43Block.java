...
public class Wallpapers43Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_43")
	public static final Block block = null;

	public Wallpapers43Block(TextureBlocksModElements instance) {
		super(instance, 1170);
	}
