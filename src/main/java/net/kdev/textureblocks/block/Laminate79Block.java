...
public class Laminate79Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_79")
	public static final Block block = null;

	public Laminate79Block(TextureBlocksModElements instance) {
		super(instance, 735);
	}
