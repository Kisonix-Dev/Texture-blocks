...
public class Linoleum17Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_17")
	public static final Block block = null;

	public Linoleum17Block(TextureBlocksModElements instance) {
		super(instance, 769);
	}
