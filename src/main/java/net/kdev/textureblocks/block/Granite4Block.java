...
public class Granite4Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_4")
	public static final Block block = null;

	public Granite4Block(TextureBlocksModElements instance) {
		super(instance, 250);
	}
