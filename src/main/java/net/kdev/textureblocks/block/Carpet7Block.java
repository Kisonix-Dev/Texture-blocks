...
public class Carpet7Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_7")
	public static final Block block = null;

	public Carpet7Block(TextureBlocksModElements instance) {
		super(instance, 635);
	}
