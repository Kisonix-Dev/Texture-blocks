...
public class Cobblestone35Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_35")
	public static final Block block = null;

	public Cobblestone35Block(TextureBlocksModElements instance) {
		super(instance, 182);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_35");
		}
