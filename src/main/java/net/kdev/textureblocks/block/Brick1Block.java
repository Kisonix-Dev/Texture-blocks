...
public class Brick1Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_1")
	public static final Block block = null;

	public Brick1Block(TextureBlocksModElements instance) {
		super(instance, 532);
	}
