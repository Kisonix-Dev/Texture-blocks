...
public class Carpet17Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_17")
	public static final Block block = null;

	public Carpet17Block(TextureBlocksModElements instance) {
		super(instance, 645);
	}
