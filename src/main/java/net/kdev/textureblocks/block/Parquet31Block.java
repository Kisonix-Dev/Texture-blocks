...
public class Parquet31Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_31")
	public static final Block block = null;

	public Parquet31Block(TextureBlocksModElements instance) {
		super(instance, 1066);
	}
