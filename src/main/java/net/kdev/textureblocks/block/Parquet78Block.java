...
public class Parquet78Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_78")
	public static final Block block = null;

	public Parquet78Block(TextureBlocksModElements instance) {
		super(instance, 1113);
	}
