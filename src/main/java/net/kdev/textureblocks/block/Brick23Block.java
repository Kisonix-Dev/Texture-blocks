...
public class Brick23Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_23")
	public static final Block block = null;

	public Brick23Block(TextureBlocksModElements instance) {
		super(instance, 554);
	}
