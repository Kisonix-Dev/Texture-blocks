...
public class Wood2Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_2")
	public static final Block block = null;

	public Wood2Block(TextureBlocksModElements instance) {
		super(instance, 334);
	}
