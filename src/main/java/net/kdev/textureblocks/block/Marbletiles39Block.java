...
public class Marbletiles39Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_39")
	public static final Block block = null;

	public Marbletiles39Block(TextureBlocksModElements instance) {
		super(instance, 897);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_39");
		}
