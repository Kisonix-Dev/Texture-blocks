...
public class Laminate11Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_11")
	public static final Block block = null;

	public Laminate11Block(TextureBlocksModElements instance) {
		super(instance, 667);
	}
