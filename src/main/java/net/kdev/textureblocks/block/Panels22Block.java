...
public class Panels22Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_22")
	public static final Block block = null;

	public Panels22Block(TextureBlocksModElements instance) {
		super(instance, 967);
	}
