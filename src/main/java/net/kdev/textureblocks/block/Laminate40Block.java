...
public class Laminate40Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_40")
	public static final Block block = null;

	public Laminate40Block(TextureBlocksModElements instance) {
		super(instance, 696);
	}
