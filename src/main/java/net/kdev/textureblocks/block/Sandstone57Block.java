...
public class Sandstone57Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_57")
	public static final Block block = null;

	public Sandstone57Block(TextureBlocksModElements instance) {
		super(instance, 1311);
	}
