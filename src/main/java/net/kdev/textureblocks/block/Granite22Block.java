...
public class Granite22Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_22")
	public static final Block block = null;

	public Granite22Block(TextureBlocksModElements instance) {
		super(instance, 268);
	}
