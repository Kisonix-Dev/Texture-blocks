...
public class Tiles46Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_46")
	public static final Block block = null;

	public Tiles46Block(TextureBlocksModElements instance) {
		super(instance, 1396);
	}
