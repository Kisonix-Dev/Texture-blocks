...
public class Brick14Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_14")
	public static final Block block = null;

	public Brick14Block(TextureBlocksModElements instance) {
		super(instance, 545);
	}
