...
public class Cobblestone95Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_95")
	public static final Block block = null;

	public Cobblestone95Block(TextureBlocksModElements instance) {
		super(instance, 242);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_95");
		}
