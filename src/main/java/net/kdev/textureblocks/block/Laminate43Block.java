...
public class Laminate43Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_43")
	public static final Block block = null;

	public Laminate43Block(TextureBlocksModElements instance) {
		super(instance, 699);
	}
