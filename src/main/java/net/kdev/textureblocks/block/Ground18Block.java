...
public class Ground18Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_18")
	public static final Block block = null;

	public Ground18Block(TextureBlocksModElements instance) {
		super(instance, 294);
	}
