...
public class Panels48Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_48")
	public static final Block block = null;

	public Panels48Block(TextureBlocksModElements instance) {
		super(instance, 993);
	}
