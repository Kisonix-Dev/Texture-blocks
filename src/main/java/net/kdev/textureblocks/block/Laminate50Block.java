...
public class Laminate50Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_50")
	public static final Block block = null;

	public Laminate50Block(TextureBlocksModElements instance) {
		super(instance, 706);
	}
