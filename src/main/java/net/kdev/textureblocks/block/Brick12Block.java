...
public class Brick12Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_12")
	public static final Block block = null;

	public Brick12Block(TextureBlocksModElements instance) {
		super(instance, 543);
	}
