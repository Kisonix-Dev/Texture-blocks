...
public class Ground10Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_10")
	public static final Block block = null;

	public Ground10Block(TextureBlocksModElements instance) {
		super(instance, 286);
	}
