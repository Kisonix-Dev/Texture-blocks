...
public class Panels72Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_72")
	public static final Block block = null;

	public Panels72Block(TextureBlocksModElements instance) {
		super(instance, 1017);
	}
