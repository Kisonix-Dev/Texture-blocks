...
public class Marbletiles41Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_41")
	public static final Block block = null;

	public Marbletiles41Block(TextureBlocksModElements instance) {
		super(instance, 899);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_41");
		}
