...
public class Cobblestone67Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_67")
	public static final Block block = null;

	public Cobblestone67Block(TextureBlocksModElements instance) {
		super(instance, 214);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_67");
		}
