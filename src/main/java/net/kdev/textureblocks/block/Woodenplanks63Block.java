...
public class Woodenplanks63Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_63")
	public static final Block block = null;

	public Woodenplanks63Block(TextureBlocksModElements instance) {
		super(instance, 491);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_63");
		}
