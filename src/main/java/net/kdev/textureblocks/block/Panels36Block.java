...
public class Panels36Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_36")
	public static final Block block = null;

	public Panels36Block(TextureBlocksModElements instance) {
		super(instance, 981);
	}
