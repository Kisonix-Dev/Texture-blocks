...
public class Panels85Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_85")
	public static final Block block = null;

	public Panels85Block(TextureBlocksModElements instance) {
		super(instance, 1030);
	}
