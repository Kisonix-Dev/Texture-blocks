...
public class Cobblestone72Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_72")
	public static final Block block = null;

	public Cobblestone72Block(TextureBlocksModElements instance) {
		super(instance, 219);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_72");
		}
