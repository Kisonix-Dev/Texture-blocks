...
public class Linoleum58Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_58")
	public static final Block block = null;

	public Linoleum58Block(TextureBlocksModElements instance) {
		super(instance, 810);
	}
