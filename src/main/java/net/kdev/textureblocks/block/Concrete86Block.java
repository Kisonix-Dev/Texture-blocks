...
public class Concrete86Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_86")
	public static final Block block = null;

	public Concrete86Block(TextureBlocksModElements instance) {
		super(instance, 138);
	}
