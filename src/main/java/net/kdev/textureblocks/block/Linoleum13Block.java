...
public class Linoleum13Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_13")
	public static final Block block = null;

	public Linoleum13Block(TextureBlocksModElements instance) {
		super(instance, 765);
	}
