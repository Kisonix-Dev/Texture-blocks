...
public class Brick33Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_33")
	public static final Block block = null;

	public Brick33Block(TextureBlocksModElements instance) {
		super(instance, 564);
	}
