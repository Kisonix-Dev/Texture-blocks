...
public class Asphalt44Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_44_1")
	public static final Block block = null;

	public Asphalt44Block(TextureBlocksModElements instance) {
		super(instance, 47);
	}
