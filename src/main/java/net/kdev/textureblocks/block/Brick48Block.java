...
public class Brick48Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_48")
	public static final Block block = null;

	public Brick48Block(TextureBlocksModElements instance) {
		super(instance, 579);
	}
