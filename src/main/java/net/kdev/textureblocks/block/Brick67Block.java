...
public class Brick67Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_67")
	public static final Block block = null;

	public Brick67Block(TextureBlocksModElements instance) {
		super(instance, 598);
	}
