...
public class Brick55Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_55")
	public static final Block block = null;

	public Brick55Block(TextureBlocksModElements instance) {
		super(instance, 586);
	}
