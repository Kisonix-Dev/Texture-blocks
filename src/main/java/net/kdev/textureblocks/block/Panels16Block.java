...
public class Panels16Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_16")
	public static final Block block = null;

	public Panels16Block(TextureBlocksModElements instance) {
		super(instance, 961);
	}
