...
public class Marbletiles3Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_3")
	public static final Block block = null;

	public Marbletiles3Block(TextureBlocksModElements instance) {
		super(instance, 861);
	}
