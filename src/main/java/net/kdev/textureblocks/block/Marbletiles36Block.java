...
public class Marbletiles36Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_36")
	public static final Block block = null;

	public Marbletiles36Block(TextureBlocksModElements instance) {
		super(instance, 894);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_36");
		}
