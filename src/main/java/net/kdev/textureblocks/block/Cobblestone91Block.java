...
public class Cobblestone91Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_91")
	public static final Block block = null;

	public Cobblestone91Block(TextureBlocksModElements instance) {
		super(instance, 238);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_91");
		}
