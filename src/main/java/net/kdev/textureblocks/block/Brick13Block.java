...
public class Brick13Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_13")
	public static final Block block = null;

	public Brick13Block(TextureBlocksModElements instance) {
		super(instance, 544);
	}
