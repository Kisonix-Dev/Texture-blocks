...
public class Brick77Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_77")
	public static final Block block = null;

	public Brick77Block(TextureBlocksModElements instance) {
		super(instance, 608);
	}
