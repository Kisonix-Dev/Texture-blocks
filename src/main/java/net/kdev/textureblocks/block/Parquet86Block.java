...
public class Parquet86Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_86")
	public static final Block block = null;

	public Parquet86Block(TextureBlocksModElements instance) {
		super(instance, 1121);
	}
