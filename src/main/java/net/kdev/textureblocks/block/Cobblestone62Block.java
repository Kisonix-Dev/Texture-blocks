...
public class Cobblestone62Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_62")
	public static final Block block = null;

	public Cobblestone62Block(TextureBlocksModElements instance) {
		super(instance, 209);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_62");
		}
