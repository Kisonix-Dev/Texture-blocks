...
public class Panels25Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_25")
	public static final Block block = null;

	public Panels25Block(TextureBlocksModElements instance) {
		super(instance, 970);
	}
