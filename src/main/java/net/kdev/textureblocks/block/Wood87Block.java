...
public class Wood87Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_87")
	public static final Block block = null;

	public Wood87Block(TextureBlocksModElements instance) {
		super(instance, 419);
	}
