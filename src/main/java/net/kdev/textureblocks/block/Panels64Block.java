...
public class Panels64Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_64")
	public static final Block block = null;

	public Panels64Block(TextureBlocksModElements instance) {
		super(instance, 1009);
	}
