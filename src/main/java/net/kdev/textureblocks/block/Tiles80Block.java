...
public class Tiles80Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_80")
	public static final Block block = null;

	public Tiles80Block(TextureBlocksModElements instance) {
		super(instance, 1430);
	}
