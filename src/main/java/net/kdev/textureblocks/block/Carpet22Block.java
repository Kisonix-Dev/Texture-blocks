...
public class Carpet22Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_22")
	public static final Block block = null;

	public Carpet22Block(TextureBlocksModElements instance) {
		super(instance, 650);
	}
