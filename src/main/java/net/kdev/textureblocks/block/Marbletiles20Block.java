...
public class Marbletiles20Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_20")
	public static final Block block = null;

	public Marbletiles20Block(TextureBlocksModElements instance) {
		super(instance, 878);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_20");
		}
