...
public class Parquet66Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_66")
	public static final Block block = null;

	public Parquet66Block(TextureBlocksModElements instance) {
		super(instance, 1101);
	}
