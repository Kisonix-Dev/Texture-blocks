...
public class Linoleum81Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_81")
	public static final Block block = null;

	public Linoleum81Block(TextureBlocksModElements instance) {
		super(instance, 833);
	}
