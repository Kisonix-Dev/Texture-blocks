...
public class Tiles75Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_75")
	public static final Block block = null;

	public Tiles75Block(TextureBlocksModElements instance) {
		super(instance, 1425);
	}
