...
public class Concrete79Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_79")
	public static final Block block = null;

	public Concrete79Block(TextureBlocksModElements instance) {
		super(instance, 131);
	}
