...
public class Tiles89Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_89")
	public static final Block block = null;

	public Tiles89Block(TextureBlocksModElements instance) {
		super(instance, 1439);
	}
