...
public class Marbletiles16Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_16")
	public static final Block block = null;

	public Marbletiles16Block(TextureBlocksModElements instance) {
		super(instance, 874);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_16");
		}
