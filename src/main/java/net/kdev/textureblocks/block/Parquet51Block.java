...
public class Parquet51Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_51")
	public static final Block block = null;

	public Parquet51Block(TextureBlocksModElements instance) {
		super(instance, 1086);
	}
