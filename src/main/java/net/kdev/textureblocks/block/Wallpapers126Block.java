...
public class Wallpapers126Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_126")
	public static final Block block = null;

	public Wallpapers126Block(TextureBlocksModElements instance) {
		super(instance, 1253);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_126");
		}
