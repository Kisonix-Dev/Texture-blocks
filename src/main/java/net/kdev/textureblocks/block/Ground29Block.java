...
public class Ground29Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_29")
	public static final Block block = null;

	public Ground29Block(TextureBlocksModElements instance) {
		super(instance, 305);
	}
