...
public class Cobblestone5Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_5")
	public static final Block block = null;

	public Cobblestone5Block(TextureBlocksModElements instance) {
		super(instance, 152);
	}
