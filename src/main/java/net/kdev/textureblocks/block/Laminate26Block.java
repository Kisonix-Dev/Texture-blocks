...
public class Laminate26Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_26")
	public static final Block block = null;

	public Laminate26Block(TextureBlocksModElements instance) {
		super(instance, 682);
	}
