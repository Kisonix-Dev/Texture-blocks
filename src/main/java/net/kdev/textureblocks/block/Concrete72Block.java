...
public class Concrete72Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_72")
	public static final Block block = null;

	public Concrete72Block(TextureBlocksModElements instance) {
		super(instance, 124);
	}
