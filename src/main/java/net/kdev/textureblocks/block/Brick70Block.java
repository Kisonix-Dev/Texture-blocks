...
public class Brick70Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_70")
	public static final Block block = null;

	public Brick70Block(TextureBlocksModElements instance) {
		super(instance, 601);
	}
