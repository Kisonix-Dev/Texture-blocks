...
public class Granite28Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_28")
	public static final Block block = null;

	public Granite28Block(TextureBlocksModElements instance) {
		super(instance, 274);
	}
