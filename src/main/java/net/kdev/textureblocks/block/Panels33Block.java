...
public class Panels33Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_33")
	public static final Block block = null;

	public Panels33Block(TextureBlocksModElements instance) {
		super(instance, 978);
	}
