...
public class Brick8Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_8")
	public static final Block block = null;

	public Brick8Block(TextureBlocksModElements instance) {
		super(instance, 539);
	}
