...
public class Linoleum77Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_77")
	public static final Block block = null;

	public Linoleum77Block(TextureBlocksModElements instance) {
		super(instance, 829);
	}
