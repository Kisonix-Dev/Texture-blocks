...
public class Laminate46Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_46")
	public static final Block block = null;

	public Laminate46Block(TextureBlocksModElements instance) {
		super(instance, 702);
	}
