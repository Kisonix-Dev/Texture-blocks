...
public class Parquet50Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_50")
	public static final Block block = null;

	public Parquet50Block(TextureBlocksModElements instance) {
		super(instance, 1085);
	}
