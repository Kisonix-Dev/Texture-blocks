...
public class Woodenplanks80Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_80")
	public static final Block block = null;

	public Woodenplanks80Block(TextureBlocksModElements instance) {
		super(instance, 508);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_80");
		}
