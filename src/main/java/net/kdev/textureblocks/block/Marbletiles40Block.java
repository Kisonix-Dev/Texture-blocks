...
public class Marbletiles40Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_40")
	public static final Block block = null;

	public Marbletiles40Block(TextureBlocksModElements instance) {
		super(instance, 898);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_40");
		}
