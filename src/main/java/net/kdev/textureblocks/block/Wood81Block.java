...
public class Wood81Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_81")
	public static final Block block = null;

	public Wood81Block(TextureBlocksModElements instance) {
		super(instance, 413);
	}
