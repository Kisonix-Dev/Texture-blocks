...
public class Marbletiles38Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_38")
	public static final Block block = null;

	public Marbletiles38Block(TextureBlocksModElements instance) {
		super(instance, 896);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_38");
		}
