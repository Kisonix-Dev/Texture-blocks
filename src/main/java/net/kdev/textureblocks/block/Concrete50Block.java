...
public class Concrete50Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_50")
	public static final Block block = null;

	public Concrete50Block(TextureBlocksModElements instance) {
		super(instance, 102);
	}
