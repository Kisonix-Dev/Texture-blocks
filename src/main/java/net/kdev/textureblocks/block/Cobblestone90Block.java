...
public class Cobblestone90Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_90")
	public static final Block block = null;

	public Cobblestone90Block(TextureBlocksModElements instance) {
		super(instance, 237);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_90");
		}
