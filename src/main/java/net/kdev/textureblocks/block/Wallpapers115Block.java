...
public class Wallpapers115Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_115")
	public static final Block block = null;

	public Wallpapers115Block(TextureBlocksModElements instance) {
		super(instance, 1242);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_115");
		}
