...
public class Woodenplanks87Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_87")
	public static final Block block = null;

	public Woodenplanks87Block(TextureBlocksModElements instance) {
		super(instance, 515);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_87");
		}
