...
public class Parquet64Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_64")
	public static final Block block = null;

	public Parquet64Block(TextureBlocksModElements instance) {
		super(instance, 1099);
	}
