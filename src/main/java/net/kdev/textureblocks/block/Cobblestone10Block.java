...
public class Cobblestone10Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_10")
	public static final Block block = null;

	public Cobblestone10Block(TextureBlocksModElements instance) {
		super(instance, 157);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_10");
		}
