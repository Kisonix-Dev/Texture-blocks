...
public class Cobblestone81Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_81")
	public static final Block block = null;

	public Cobblestone81Block(TextureBlocksModElements instance) {
		super(instance, 228);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_81");
		}
