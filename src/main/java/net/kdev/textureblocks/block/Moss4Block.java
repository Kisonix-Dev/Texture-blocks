...
public class Moss4Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:moss_4")
	public static final Block block = null;

	public Moss4Block(TextureBlocksModElements instance) {
		super(instance, 849);
	}
