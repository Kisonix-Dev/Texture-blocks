...
public class Brick56Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_56")
	public static final Block block = null;

	public Brick56Block(TextureBlocksModElements instance) {
		super(instance, 587);
	}
