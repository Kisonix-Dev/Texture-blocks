...
public class Panels24Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_24")
	public static final Block block = null;

	public Panels24Block(TextureBlocksModElements instance) {
		super(instance, 969);
	}
