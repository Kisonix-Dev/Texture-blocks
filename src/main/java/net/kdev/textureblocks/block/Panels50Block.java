...
public class Panels50Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_50")
	public static final Block block = null;

	public Panels50Block(TextureBlocksModElements instance) {
		super(instance, 995);
	}
