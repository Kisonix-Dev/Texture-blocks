...
public class Marbletiles26Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_26")
	public static final Block block = null;

	public Marbletiles26Block(TextureBlocksModElements instance) {
		super(instance, 884);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_26");
		}
