...
public class Panels19Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_19")
	public static final Block block = null;

	public Panels19Block(TextureBlocksModElements instance) {
		super(instance, 964);
	}
