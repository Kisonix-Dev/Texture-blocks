...
public class Wallpapers83Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_83")
	public static final Block block = null;

	public Wallpapers83Block(TextureBlocksModElements instance) {
		super(instance, 1210);
	}
