...
public class Wallpapers103Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_103")
	public static final Block block = null;

	public Wallpapers103Block(TextureBlocksModElements instance) {
		super(instance, 1230);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_103");
		}
