...
public class Sandstone86Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_86")
	public static final Block block = null;

	public Sandstone86Block(TextureBlocksModElements instance) {
		super(instance, 1340);
	}
