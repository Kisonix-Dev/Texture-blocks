...
public class Brick66Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_66")
	public static final Block block = null;

	public Brick66Block(TextureBlocksModElements instance) {
		super(instance, 597);
	}
