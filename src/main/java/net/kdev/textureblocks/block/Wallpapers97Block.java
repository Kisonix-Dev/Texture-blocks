...
public class Wallpapers97Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_97")
	public static final Block block = null;

	public Wallpapers97Block(TextureBlocksModElements instance) {
		super(instance, 1224);
	}
