...
public class Woodenplanks73Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_73")
	public static final Block block = null;

	public Woodenplanks73Block(TextureBlocksModElements instance) {
		super(instance, 501);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_73");
		}
