...
public class Sandstone95Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_95")
	public static final Block block = null;

	public Sandstone95Block(TextureBlocksModElements instance) {
		super(instance, 1349);
	}
