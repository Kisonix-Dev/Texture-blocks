...
public class Cobblestone64Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_64")
	public static final Block block = null;

	public Cobblestone64Block(TextureBlocksModElements instance) {
		super(instance, 211);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_64");
		}
