...
public class Linoleum8Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_8")
	public static final Block block = null;

	public Linoleum8Block(TextureBlocksModElements instance) {
		super(instance, 760);
	}
