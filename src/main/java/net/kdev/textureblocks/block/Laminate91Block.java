...
public class Laminate91Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_91")
	public static final Block block = null;

	public Laminate91Block(TextureBlocksModElements instance) {
		super(instance, 747);
	}
