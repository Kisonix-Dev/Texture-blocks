...
public class Laminate58Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_58")
	public static final Block block = null;

	public Laminate58Block(TextureBlocksModElements instance) {
		super(instance, 714);
	}
