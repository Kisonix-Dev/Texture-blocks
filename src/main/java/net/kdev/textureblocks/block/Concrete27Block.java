...
public class Concrete27Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_27")
	public static final Block block = null;

	public Concrete27Block(TextureBlocksModElements instance) {
		super(instance, 79);
	}
