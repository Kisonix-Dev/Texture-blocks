...
public class Wallpapers106Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_106")
	public static final Block block = null;

	public Wallpapers106Block(TextureBlocksModElements instance) {
		super(instance, 1233);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_106");
		}
