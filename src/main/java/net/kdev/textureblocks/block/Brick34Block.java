...
public class Brick34Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_34")
	public static final Block block = null;

	public Brick34Block(TextureBlocksModElements instance) {
		super(instance, 565);
	}
