...
public class Wood80Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_80")
	public static final Block block = null;

	public Wood80Block(TextureBlocksModElements instance) {
		super(instance, 412);
	}
