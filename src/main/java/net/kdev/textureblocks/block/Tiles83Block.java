...
public class Tiles83Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_83")
	public static final Block block = null;

	public Tiles83Block(TextureBlocksModElements instance) {
		super(instance, 1433);
	}
