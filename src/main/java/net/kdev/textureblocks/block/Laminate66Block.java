...
public class Laminate66Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_66")
	public static final Block block = null;

	public Laminate66Block(TextureBlocksModElements instance) {
		super(instance, 722);
	}
