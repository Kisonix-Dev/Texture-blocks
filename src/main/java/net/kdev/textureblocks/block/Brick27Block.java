...
public class Brick27Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_27")
	public static final Block block = null;

	public Brick27Block(TextureBlocksModElements instance) {
		super(instance, 558);
	}
