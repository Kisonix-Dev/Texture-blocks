...
public class Stone5Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:stone_5")
	public static final Block block = null;

	public Stone5Block(TextureBlocksModElements instance) {
		super(instance, 528);
	}
