...
public class Panels38Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_38")
	public static final Block block = null;

	public Panels38Block(TextureBlocksModElements instance) {
		super(instance, 983);
	}
