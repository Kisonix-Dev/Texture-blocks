...
public class Panels46Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_46")
	public static final Block block = null;

	public Panels46Block(TextureBlocksModElements instance) {
		super(instance, 991);
	}
