...
public class Panels79Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_79")
	public static final Block block = null;

	public Panels79Block(TextureBlocksModElements instance) {
		super(instance, 1024);
	}
