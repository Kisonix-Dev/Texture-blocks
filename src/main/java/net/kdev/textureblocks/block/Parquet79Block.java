...
public class Parquet79Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_79")
	public static final Block block = null;

	public Parquet79Block(TextureBlocksModElements instance) {
		super(instance, 1114);
	}
