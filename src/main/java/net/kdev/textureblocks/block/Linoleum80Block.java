...
public class Linoleum80Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_80")
	public static final Block block = null;

	public Linoleum80Block(TextureBlocksModElements instance) {
		super(instance, 832);
	}
