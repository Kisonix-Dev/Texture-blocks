...
public class Parquet36Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_36")
	public static final Block block = null;

	public Parquet36Block(TextureBlocksModElements instance) {
		super(instance, 1071);
	}
