...
public class Linoleum87Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_87")
	public static final Block block = null;

	public Linoleum87Block(TextureBlocksModElements instance) {
		super(instance, 839);
	}
