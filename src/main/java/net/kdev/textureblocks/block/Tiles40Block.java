...
public class Tiles40Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_40")
	public static final Block block = null;

	public Tiles40Block(TextureBlocksModElements instance) {
		super(instance, 1390);
	}
