...
public class Parquet57Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_57")
	public static final Block block = null;

	public Parquet57Block(TextureBlocksModElements instance) {
		super(instance, 1092);
	}
