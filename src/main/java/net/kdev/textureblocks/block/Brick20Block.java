...
public class Brick20Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_20")
	public static final Block block = null;

	public Brick20Block(TextureBlocksModElements instance) {
		super(instance, 551);
	}
