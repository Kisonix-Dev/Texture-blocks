...
public class Linoleum66Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_66")
	public static final Block block = null;

	public Linoleum66Block(TextureBlocksModElements instance) {
		super(instance, 818);
	}
