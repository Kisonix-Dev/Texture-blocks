...
public class Asphalt14Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_14_1")
	public static final Block block = null;

	public Asphalt14Block(TextureBlocksModElements instance) {
		super(instance, 17);
	}
