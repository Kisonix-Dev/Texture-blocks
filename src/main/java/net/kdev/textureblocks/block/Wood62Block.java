...
public class Wood62Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_62")
	public static final Block block = null;

	public Wood62Block(TextureBlocksModElements instance) {
		super(instance, 394);
	}
