...
public class Linoleum26Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_26")
	public static final Block block = null;

	public Linoleum26Block(TextureBlocksModElements instance) {
		super(instance, 778);
	}
