...
public class Asphalt38Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_38_1")
	public static final Block block = null;

	public Asphalt38Block(TextureBlocksModElements instance) {
		super(instance, 41);
	}
