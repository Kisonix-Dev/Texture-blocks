...
public class Brick74Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_74")
	public static final Block block = null;

	public Brick74Block(TextureBlocksModElements instance) {
		super(instance, 605);
	}
