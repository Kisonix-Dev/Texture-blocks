...
public class Laminate27Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_27")
	public static final Block block = null;

	public Laminate27Block(TextureBlocksModElements instance) {
		super(instance, 683);
	}
