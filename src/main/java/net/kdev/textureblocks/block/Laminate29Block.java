...
public class Laminate29Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_29")
	public static final Block block = null;

	public Laminate29Block(TextureBlocksModElements instance) {
		super(instance, 685);
	}
