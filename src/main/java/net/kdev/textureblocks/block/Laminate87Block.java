...
public class Laminate87Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_87")
	public static final Block block = null;

	public Laminate87Block(TextureBlocksModElements instance) {
		super(instance, 743);
	}
