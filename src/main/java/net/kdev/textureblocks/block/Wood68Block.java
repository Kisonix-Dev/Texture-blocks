...
public class Wood68Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_68")
	public static final Block block = null;

	public Wood68Block(TextureBlocksModElements instance) {
		super(instance, 400);
	}
