...
public class Parquet81Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_81")
	public static final Block block = null;

	public Parquet81Block(TextureBlocksModElements instance) {
		super(instance, 1116);
	}
