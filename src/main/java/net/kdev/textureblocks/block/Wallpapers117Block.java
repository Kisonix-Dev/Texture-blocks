...
public class Wallpapers117Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_117")
	public static final Block block = null;

	public Wallpapers117Block(TextureBlocksModElements instance) {
		super(instance, 1244);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_117");
		}
