...
public class Tiles79Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_79")
	public static final Block block = null;

	public Tiles79Block(TextureBlocksModElements instance) {
		super(instance, 1429);
	}
