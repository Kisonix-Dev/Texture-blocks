...
public class Panels76Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_76")
	public static final Block block = null;

	public Panels76Block(TextureBlocksModElements instance) {
		super(instance, 1021);
	}
