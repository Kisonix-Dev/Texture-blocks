...
public class Linoleum1Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_1")
	public static final Block block = null;

	public Linoleum1Block(TextureBlocksModElements instance) {
		super(instance, 753);
	}
