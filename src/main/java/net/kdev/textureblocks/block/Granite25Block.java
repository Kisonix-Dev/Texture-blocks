...
public class Granite25Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_25")
	public static final Block block = null;

	public Granite25Block(TextureBlocksModElements instance) {
		super(instance, 271);
	}
