...
public class Woodenplanks46Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_46")
	public static final Block block = null;

	public Woodenplanks46Block(TextureBlocksModElements instance) {
		super(instance, 474);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_46");
		}
