...
public class Laminate38Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_38")
	public static final Block block = null;

	public Laminate38Block(TextureBlocksModElements instance) {
		super(instance, 694);
	}
