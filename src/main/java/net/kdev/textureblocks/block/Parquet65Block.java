...
public class Parquet65Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_65")
	public static final Block block = null;

	public Parquet65Block(TextureBlocksModElements instance) {
		super(instance, 1100);
	}
