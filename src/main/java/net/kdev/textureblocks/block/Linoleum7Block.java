...
public class Linoleum7Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_7")
	public static final Block block = null;

	public Linoleum7Block(TextureBlocksModElements instance) {
		super(instance, 759);
	}
