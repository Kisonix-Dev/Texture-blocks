...
public class Tiles34Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_34")
	public static final Block block = null;

	public Tiles34Block(TextureBlocksModElements instance) {
		super(instance, 1384);
	}
