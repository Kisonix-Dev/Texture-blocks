...
public class Laminate3Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_3")
	public static final Block block = null;

	public Laminate3Block(TextureBlocksModElements instance) {
		super(instance, 659);
	}
