...
public class Panels28Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_28")
	public static final Block block = null;

	public Panels28Block(TextureBlocksModElements instance) {
		super(instance, 973);
	}
