...
public class Tiles13Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_13")
	public static final Block block = null;

	public Tiles13Block(TextureBlocksModElements instance) {
		super(instance, 1363);
	}
