...
public class Dirt4Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:dirt_4")
	public static final Block block = null;

	public Dirt4Block(TextureBlocksModElements instance) {
		super(instance, 326);
	}
