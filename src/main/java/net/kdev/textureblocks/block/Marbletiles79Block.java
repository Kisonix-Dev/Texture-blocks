...
public class Marbletiles79Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_79")
	public static final Block block = null;

	public Marbletiles79Block(TextureBlocksModElements instance) {
		super(instance, 937);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_79");
		}
