...
public class Linoleum63Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_63")
	public static final Block block = null;

	public Linoleum63Block(TextureBlocksModElements instance) {
		super(instance, 815);
	}
