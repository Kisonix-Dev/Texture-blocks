...
public class Panels78Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_78")
	public static final Block block = null;

	public Panels78Block(TextureBlocksModElements instance) {
		super(instance, 1023);
	}
