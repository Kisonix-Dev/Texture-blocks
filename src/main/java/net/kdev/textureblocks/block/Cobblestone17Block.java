...
public class Cobblestone17Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_17")
	public static final Block block = null;

	public Cobblestone17Block(TextureBlocksModElements instance) {
		super(instance, 164);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_17");
		}
