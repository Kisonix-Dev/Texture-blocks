...
public class Wallpapers37Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_37")
	public static final Block block = null;

	public Wallpapers37Block(TextureBlocksModElements instance) {
		super(instance, 1164);
	}
