...
public class Sandstone93Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_93")
	public static final Block block = null;

	public Sandstone93Block(TextureBlocksModElements instance) {
		super(instance, 1347);
	}
