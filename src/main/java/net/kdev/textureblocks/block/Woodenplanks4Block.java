...
public class Woodenplanks4Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_4")
	public static final Block block = null;

	public Woodenplanks4Block(TextureBlocksModElements instance) {
		super(instance, 432);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_4");
		}
