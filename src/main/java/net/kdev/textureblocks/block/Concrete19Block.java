...
public class Concrete19Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_19")
	public static final Block block = null;

	public Concrete19Block(TextureBlocksModElements instance) {
		super(instance, 71);
	}
