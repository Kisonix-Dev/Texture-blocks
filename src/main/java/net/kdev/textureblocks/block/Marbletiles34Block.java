...
public class Marbletiles34Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_34")
	public static final Block block = null;

	public Marbletiles34Block(TextureBlocksModElements instance) {
		super(instance, 892);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_34");
		}
