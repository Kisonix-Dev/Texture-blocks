...
public class Wallpapers55Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_55")
	public static final Block block = null;

	public Wallpapers55Block(TextureBlocksModElements instance) {
		super(instance, 1182);
	}
