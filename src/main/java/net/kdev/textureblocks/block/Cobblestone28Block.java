...
public class Cobblestone28Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_28")
	public static final Block block = null;

	public Cobblestone28Block(TextureBlocksModElements instance) {
		super(instance, 175);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_28");
		}
