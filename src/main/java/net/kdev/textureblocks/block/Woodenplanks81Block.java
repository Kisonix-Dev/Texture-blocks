...
public class Woodenplanks81Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_81")
	public static final Block block = null;

	public Woodenplanks81Block(TextureBlocksModElements instance) {
		super(instance, 509);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_81");
		}
