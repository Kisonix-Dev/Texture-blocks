...
public class Brick31Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_31")
	public static final Block block = null;

	public Brick31Block(TextureBlocksModElements instance) {
		super(instance, 562);
	}
