...
public class Carpet14Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_14")
	public static final Block block = null;

	public Carpet14Block(TextureBlocksModElements instance) {
		super(instance, 642);
	}
