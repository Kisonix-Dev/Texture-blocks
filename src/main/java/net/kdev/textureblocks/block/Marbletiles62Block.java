...
public class Marbletiles62Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_62")
	public static final Block block = null;

	public Marbletiles62Block(TextureBlocksModElements instance) {
		super(instance, 920);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_62");
		}
