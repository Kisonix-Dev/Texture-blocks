...
public class Granite3Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_3")
	public static final Block block = null;

	public Granite3Block(TextureBlocksModElements instance) {
		super(instance, 249);
	}
