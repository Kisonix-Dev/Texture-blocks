...
public class Concrete47Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_47")
	public static final Block block = null;

	public Concrete47Block(TextureBlocksModElements instance) {
		super(instance, 99);
	}
