...
public class Tiles50Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_50")
	public static final Block block = null;

	public Tiles50Block(TextureBlocksModElements instance) {
		super(instance, 1400);
	}
