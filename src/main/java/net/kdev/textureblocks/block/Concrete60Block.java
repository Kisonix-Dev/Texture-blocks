...
public class Concrete60Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_60")
	public static final Block block = null;

	public Concrete60Block(TextureBlocksModElements instance) {
		super(instance, 112);
	}
