...
public class Wood20Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_20")
	public static final Block block = null;

	public Wood20Block(TextureBlocksModElements instance) {
		super(instance, 352);
	}
