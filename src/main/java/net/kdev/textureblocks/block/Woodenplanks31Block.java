...
public class Woodenplanks31Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_31")
	public static final Block block = null;

	public Woodenplanks31Block(TextureBlocksModElements instance) {
		super(instance, 459);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_31");
		}
