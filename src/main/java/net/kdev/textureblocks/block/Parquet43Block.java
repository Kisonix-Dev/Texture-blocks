...
public class Parquet43Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_43")
	public static final Block block = null;

	public Parquet43Block(TextureBlocksModElements instance) {
		super(instance, 1078);
	}
