...
public class Sandstone20Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_20")
	public static final Block block = null;

	public Sandstone20Block(TextureBlocksModElements instance) {
		super(instance, 1274);
	}
