...
public class Marbletiles66Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_66")
	public static final Block block = null;

	public Marbletiles66Block(TextureBlocksModElements instance) {
		super(instance, 924);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_66");
		}
