...
public class Marbletiles11Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_11")
	public static final Block block = null;

	public Marbletiles11Block(TextureBlocksModElements instance) {
		super(instance, 869);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_11");
		}
