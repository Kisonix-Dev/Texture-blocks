...
public class Concrete36Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_36")
	public static final Block block = null;

	public Concrete36Block(TextureBlocksModElements instance) {
		super(instance, 88);
	}
