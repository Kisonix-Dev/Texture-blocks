...
public class Woodenplanks48Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_48")
	public static final Block block = null;

	public Woodenplanks48Block(TextureBlocksModElements instance) {
		super(instance, 476);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_48");
		}
