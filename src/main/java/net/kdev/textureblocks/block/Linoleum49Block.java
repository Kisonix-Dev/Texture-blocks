...
public class Linoleum49Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_49")
	public static final Block block = null;

	public Linoleum49Block(TextureBlocksModElements instance) {
		super(instance, 801);
	}
