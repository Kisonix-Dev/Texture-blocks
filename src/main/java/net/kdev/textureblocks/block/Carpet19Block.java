...
public class Carpet19Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_19")
	public static final Block block = null;

	public Carpet19Block(TextureBlocksModElements instance) {
		super(instance, 647);
	}
