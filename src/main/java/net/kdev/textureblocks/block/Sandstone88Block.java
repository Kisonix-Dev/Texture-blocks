...
public class Sandstone88Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_88")
	public static final Block block = null;

	public Sandstone88Block(TextureBlocksModElements instance) {
		super(instance, 1342);
	}
