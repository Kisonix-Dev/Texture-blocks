...
public class Tiles69Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_69")
	public static final Block block = null;

	public Tiles69Block(TextureBlocksModElements instance) {
		super(instance, 1419);
	}
