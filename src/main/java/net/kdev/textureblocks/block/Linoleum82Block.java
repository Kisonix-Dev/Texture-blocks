...
public class Linoleum82Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_82")
	public static final Block block = null;

	public Linoleum82Block(TextureBlocksModElements instance) {
		super(instance, 834);
	}
