...
public class Wood29Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_29")
	public static final Block block = null;

	public Wood29Block(TextureBlocksModElements instance) {
		super(instance, 361);
	}
