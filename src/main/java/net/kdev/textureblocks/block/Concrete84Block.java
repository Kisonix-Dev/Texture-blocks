...
public class Concrete84Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_84")
	public static final Block block = null;

	public Concrete84Block(TextureBlocksModElements instance) {
		super(instance, 136);
	}
