...
public class Wood32Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_32")
	public static final Block block = null;

	public Wood32Block(TextureBlocksModElements instance) {
		super(instance, 364);
	}
