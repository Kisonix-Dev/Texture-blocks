...
public class Marbletiles77Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_77")
	public static final Block block = null;

	public Marbletiles77Block(TextureBlocksModElements instance) {
		super(instance, 935);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_77");
		}
