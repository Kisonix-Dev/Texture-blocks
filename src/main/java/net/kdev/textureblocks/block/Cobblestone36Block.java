...
public class Cobblestone36Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_36")
	public static final Block block = null;

	public Cobblestone36Block(TextureBlocksModElements instance) {
		super(instance, 183);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_36");
		}
