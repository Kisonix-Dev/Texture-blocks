...
public class Ground26Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_26")
	public static final Block block = null;

	public Ground26Block(TextureBlocksModElements instance) {
		super(instance, 302);
	}
