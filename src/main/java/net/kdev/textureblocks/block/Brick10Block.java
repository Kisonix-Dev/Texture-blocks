...
public class Brick10Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_10")
	public static final Block block = null;

	public Brick10Block(TextureBlocksModElements instance) {
		super(instance, 541);
	}
