...
public class Brick41Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_41")
	public static final Block block = null;

	public Brick41Block(TextureBlocksModElements instance) {
		super(instance, 572);
	}
