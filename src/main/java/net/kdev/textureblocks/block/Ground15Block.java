...
public class Ground15Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_15")
	public static final Block block = null;

	public Ground15Block(TextureBlocksModElements instance) {
		super(instance, 291);
	}
