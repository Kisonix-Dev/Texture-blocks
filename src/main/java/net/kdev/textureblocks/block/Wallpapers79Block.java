...
public class Wallpapers79Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_79")
	public static final Block block = null;

	public Wallpapers79Block(TextureBlocksModElements instance) {
		super(instance, 1206);
	}
