...
public class Woodenplanks91Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_91")
	public static final Block block = null;

	public Woodenplanks91Block(TextureBlocksModElements instance) {
		super(instance, 519);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_91");
		}
