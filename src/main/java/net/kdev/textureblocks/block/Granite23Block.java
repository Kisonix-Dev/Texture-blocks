...
public class Granite23Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_23")
	public static final Block block = null;

	public Granite23Block(TextureBlocksModElements instance) {
		super(instance, 269);
	}
