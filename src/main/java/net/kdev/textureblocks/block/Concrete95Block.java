...
public class Concrete95Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_95")
	public static final Block block = null;

	public Concrete95Block(TextureBlocksModElements instance) {
		super(instance, 147);
	}
