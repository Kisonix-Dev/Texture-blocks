...
public class Wallpapers39Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_39")
	public static final Block block = null;

	public Wallpapers39Block(TextureBlocksModElements instance) {
		super(instance, 1166);
	}
