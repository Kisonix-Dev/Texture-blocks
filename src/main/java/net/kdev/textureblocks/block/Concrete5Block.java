...
public class Concrete5Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_5")
	public static final Block block = null;

	public Concrete5Block(TextureBlocksModElements instance) {
		super(instance, 57);
	}
