...
public class Sandstone87Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_87")
	public static final Block block = null;

	public Sandstone87Block(TextureBlocksModElements instance) {
		super(instance, 1341);
	}
