...
public class Tiles92Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_92")
	public static final Block block = null;

	public Tiles92Block(TextureBlocksModElements instance) {
		super(instance, 1442);
	}
