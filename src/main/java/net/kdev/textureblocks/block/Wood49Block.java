...
public class Wood49Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_49")
	public static final Block block = null;

	public Wood49Block(TextureBlocksModElements instance) {
		super(instance, 381);
	}
