...
public class Brick42Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_42")
	public static final Block block = null;

	public Brick42Block(TextureBlocksModElements instance) {
		super(instance, 573);
	}
