...
public class Granite12Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_12")
	public static final Block block = null;

	public Granite12Block(TextureBlocksModElements instance) {
		super(instance, 258);
	}
