...
public class Sandstone6Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_6")
	public static final Block block = null;

	public Sandstone6Block(TextureBlocksModElements instance) {
		super(instance, 1260);
	}
