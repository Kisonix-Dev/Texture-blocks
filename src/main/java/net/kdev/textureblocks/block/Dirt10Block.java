...
public class Dirt10Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:dirt_10")
	public static final Block block = null;

	public Dirt10Block(TextureBlocksModElements instance) {
		super(instance, 332);
	}
