...
public class Linoleum60Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_60")
	public static final Block block = null;

	public Linoleum60Block(TextureBlocksModElements instance) {
		super(instance, 812);
	}
