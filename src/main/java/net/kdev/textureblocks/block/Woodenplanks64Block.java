...
public class Woodenplanks64Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_64")
	public static final Block block = null;

	public Woodenplanks64Block(TextureBlocksModElements instance) {
		super(instance, 492);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_64");
		}
