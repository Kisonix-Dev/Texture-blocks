...
public class Laminate83Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_83")
	public static final Block block = null;

	public Laminate83Block(TextureBlocksModElements instance) {
		super(instance, 739);
	}
