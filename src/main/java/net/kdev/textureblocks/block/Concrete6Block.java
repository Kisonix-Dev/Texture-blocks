...
public class Concrete6Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_6")
	public static final Block block = null;

	public Concrete6Block(TextureBlocksModElements instance) {
		super(instance, 58);
	}
