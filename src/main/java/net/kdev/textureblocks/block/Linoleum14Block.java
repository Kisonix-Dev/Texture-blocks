...
public class Linoleum14Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_14")
	public static final Block block = null;

	public Linoleum14Block(TextureBlocksModElements instance) {
		super(instance, 766);
	}
