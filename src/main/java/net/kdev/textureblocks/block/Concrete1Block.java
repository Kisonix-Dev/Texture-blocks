...
public class Concrete1Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_1")
	public static final Block block = null;

	public Concrete1Block(TextureBlocksModElements instance) {
		super(instance, 53);
	}
