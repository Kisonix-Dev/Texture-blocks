...
public class Laminate5Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_5")
	public static final Block block = null;

	public Laminate5Block(TextureBlocksModElements instance) {
		super(instance, 661);
	}
