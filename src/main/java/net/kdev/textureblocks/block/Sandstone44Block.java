...
public class Sandstone44Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_44")
	public static final Block block = null;

	public Sandstone44Block(TextureBlocksModElements instance) {
		super(instance, 1298);
	}
