...
public class Carpet12Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_12")
	public static final Block block = null;

	public Carpet12Block(TextureBlocksModElements instance) {
		super(instance, 640);
	}
