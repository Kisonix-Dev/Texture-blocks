...
public class Ground46Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_46")
	public static final Block block = null;

	public Ground46Block(TextureBlocksModElements instance) {
		super(instance, 322);
	}
