...
public class Concrete21Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_21")
	public static final Block block = null;

	public Concrete21Block(TextureBlocksModElements instance) {
		super(instance, 73);
	}
