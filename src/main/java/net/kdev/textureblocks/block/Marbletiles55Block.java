...
public class Marbletiles55Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_55")
	public static final Block block = null;

	public Marbletiles55Block(TextureBlocksModElements instance) {
		super(instance, 913);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_55");
		}
