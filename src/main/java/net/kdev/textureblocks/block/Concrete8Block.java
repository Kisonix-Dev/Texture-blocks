...
public class Concrete8Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_8")
	public static final Block block = null;

	public Concrete8Block(TextureBlocksModElements instance) {
		super(instance, 60);
	}
