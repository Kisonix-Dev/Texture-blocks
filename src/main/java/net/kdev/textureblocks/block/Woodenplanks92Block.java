...
public class Woodenplanks92Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_92")
	public static final Block block = null;

	public Woodenplanks92Block(TextureBlocksModElements instance) {
		super(instance, 520);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_92");
		}
