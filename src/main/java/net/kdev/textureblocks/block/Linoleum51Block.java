...
public class Linoleum51Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_51")
	public static final Block block = null;

	public Linoleum51Block(TextureBlocksModElements instance) {
		super(instance, 803);
	}
