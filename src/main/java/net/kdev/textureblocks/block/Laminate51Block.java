...
public class Laminate51Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_51")
	public static final Block block = null;

	public Laminate51Block(TextureBlocksModElements instance) {
		super(instance, 707);
	}
