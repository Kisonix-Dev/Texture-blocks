...
public class Carpet3Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_3")
	public static final Block block = null;

	public Carpet3Block(TextureBlocksModElements instance) {
		super(instance, 631);
	}
