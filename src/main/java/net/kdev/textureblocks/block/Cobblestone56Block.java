...
public class Cobblestone56Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_56")
	public static final Block block = null;

	public Cobblestone56Block(TextureBlocksModElements instance) {
		super(instance, 203);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_56");
		}
