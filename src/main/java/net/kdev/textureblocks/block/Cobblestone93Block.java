...
public class Cobblestone93Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_93")
	public static final Block block = null;

	public Cobblestone93Block(TextureBlocksModElements instance) {
		super(instance, 240);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_93");
		}
