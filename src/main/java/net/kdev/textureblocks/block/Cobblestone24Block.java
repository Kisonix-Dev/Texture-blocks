...
public class Cobblestone24Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_24")
	public static final Block block = null;

	public Cobblestone24Block(TextureBlocksModElements instance) {
		super(instance, 171);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_24");
		}
