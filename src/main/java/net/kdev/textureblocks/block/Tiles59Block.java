...
public class Tiles59Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_59")
	public static final Block block = null;

	public Tiles59Block(TextureBlocksModElements instance) {
		super(instance, 1409);
	}
