...
public class Panels42Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_42")
	public static final Block block = null;

	public Panels42Block(TextureBlocksModElements instance) {
		super(instance, 987);
	}
