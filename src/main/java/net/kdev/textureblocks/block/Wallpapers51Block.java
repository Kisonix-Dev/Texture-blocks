...
public class Wallpapers51Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_51")
	public static final Block block = null;

	public Wallpapers51Block(TextureBlocksModElements instance) {
		super(instance, 1178);
	}
