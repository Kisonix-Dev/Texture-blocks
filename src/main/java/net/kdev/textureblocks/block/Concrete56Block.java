...
public class Concrete56Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_56")
	public static final Block block = null;

	public Concrete56Block(TextureBlocksModElements instance) {
		super(instance, 108);
	}
