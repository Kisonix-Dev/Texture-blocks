...
public class Wood13Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_13")
	public static final Block block = null;

	public Wood13Block(TextureBlocksModElements instance) {
		super(instance, 345);
	}
