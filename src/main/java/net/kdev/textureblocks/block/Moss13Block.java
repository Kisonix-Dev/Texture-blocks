...
public class Moss13Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:moss_13")
	public static final Block block = null;

	public Moss13Block(TextureBlocksModElements instance) {
		super(instance, 858);
	}
