...
public class Asphalt3Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_3_1")
	public static final Block block = null;

	public Asphalt3Block(TextureBlocksModElements instance) {
		super(instance, 4);
	}
