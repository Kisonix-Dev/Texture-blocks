...
public class Moss11Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:moss_11")
	public static final Block block = null;

	public Moss11Block(TextureBlocksModElements instance) {
		super(instance, 856);
	}
