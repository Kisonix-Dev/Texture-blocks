...
public class Sandstone94Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_94")
	public static final Block block = null;

	public Sandstone94Block(TextureBlocksModElements instance) {
		super(instance, 1348);
	}
