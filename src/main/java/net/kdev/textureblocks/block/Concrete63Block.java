...
public class Concrete63Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_63")
	public static final Block block = null;

	public Concrete63Block(TextureBlocksModElements instance) {
		super(instance, 115);
	}
