...
public class Woodenplanks14Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_14")
	public static final Block block = null;

	public Woodenplanks14Block(TextureBlocksModElements instance) {
		super(instance, 442);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_14");
		}
