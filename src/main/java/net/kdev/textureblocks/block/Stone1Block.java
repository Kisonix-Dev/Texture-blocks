...
public class Stone1Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:stone_1")
	public static final Block block = null;

	public Stone1Block(TextureBlocksModElements instance) {
		super(instance, 524);
	}
