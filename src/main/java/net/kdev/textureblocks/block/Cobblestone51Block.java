...
public class Cobblestone51Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_51")
	public static final Block block = null;

	public Cobblestone51Block(TextureBlocksModElements instance) {
		super(instance, 198);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_51");
		}
