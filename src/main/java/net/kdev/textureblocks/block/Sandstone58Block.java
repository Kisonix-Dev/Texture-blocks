...
public class Sandstone58Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_58")
	public static final Block block = null;

	public Sandstone58Block(TextureBlocksModElements instance) {
		super(instance, 1312);
	}
