...
public class Cobblestone69Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_69")
	public static final Block block = null;

	public Cobblestone69Block(TextureBlocksModElements instance) {
		super(instance, 216);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_69");
		}
