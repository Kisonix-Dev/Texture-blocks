...
public class Laminate48Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_48")
	public static final Block block = null;

	public Laminate48Block(TextureBlocksModElements instance) {
		super(instance, 704);
	}
