...
public class Laminate23Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_23")
	public static final Block block = null;

	public Laminate23Block(TextureBlocksModElements instance) {
		super(instance, 679);
	}
