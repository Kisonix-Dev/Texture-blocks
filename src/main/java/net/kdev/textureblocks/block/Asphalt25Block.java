...
public class Asphalt25Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_25_1")
	public static final Block block = null;

	public Asphalt25Block(TextureBlocksModElements instance) {
		super(instance, 28);
	}
