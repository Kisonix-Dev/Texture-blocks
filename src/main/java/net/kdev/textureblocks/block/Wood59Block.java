...
public class Wood59Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_59")
	public static final Block block = null;

	public Wood59Block(TextureBlocksModElements instance) {
		super(instance, 391);
	}
