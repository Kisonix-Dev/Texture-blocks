...
public class Asphalt22Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_22_1")
	public static final Block block = null;

	public Asphalt22Block(TextureBlocksModElements instance) {
		super(instance, 25);
	}
