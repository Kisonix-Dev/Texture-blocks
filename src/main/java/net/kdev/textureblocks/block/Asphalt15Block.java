...
public class Asphalt15Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_15_1")
	public static final Block block = null;

	public Asphalt15Block(TextureBlocksModElements instance) {
		super(instance, 18);
	}
