...
public class Tiles36Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_36")
	public static final Block block = null;

	public Tiles36Block(TextureBlocksModElements instance) {
		super(instance, 1386);
	}
