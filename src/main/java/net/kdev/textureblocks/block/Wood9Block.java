...
public class Wood9Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_9")
	public static final Block block = null;

	public Wood9Block(TextureBlocksModElements instance) {
		super(instance, 341);
	}
