...
public class Parquet42Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_42")
	public static final Block block = null;

	public Parquet42Block(TextureBlocksModElements instance) {
		super(instance, 1077);
	}
