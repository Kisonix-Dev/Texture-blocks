...
public class Woodenplanks43Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_43")
	public static final Block block = null;

	public Woodenplanks43Block(TextureBlocksModElements instance) {
		super(instance, 471);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_43");
		}
