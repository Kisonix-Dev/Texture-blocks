...
public class Wood19Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_19")
	public static final Block block = null;

	public Wood19Block(TextureBlocksModElements instance) {
		super(instance, 351);
	}
