...
public class Laminate60Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_60")
	public static final Block block = null;

	public Laminate60Block(TextureBlocksModElements instance) {
		super(instance, 716);
	}
