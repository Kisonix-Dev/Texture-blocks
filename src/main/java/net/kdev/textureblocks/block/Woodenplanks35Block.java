...
public class Woodenplanks35Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_35")
	public static final Block block = null;

	public Woodenplanks35Block(TextureBlocksModElements instance) {
		super(instance, 463);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_35");
		}
