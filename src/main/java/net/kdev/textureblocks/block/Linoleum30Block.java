...
public class Linoleum30Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_30")
	public static final Block block = null;

	public Linoleum30Block(TextureBlocksModElements instance) {
		super(instance, 782);
	}
