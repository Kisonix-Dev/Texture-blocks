...
public class Wallpapers64Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_64")
	public static final Block block = null;

	public Wallpapers64Block(TextureBlocksModElements instance) {
		super(instance, 1191);
	}
