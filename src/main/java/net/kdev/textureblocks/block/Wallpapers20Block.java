...
public class Wallpapers20Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_20")
	public static final Block block = null;

	public Wallpapers20Block(TextureBlocksModElements instance) {
		super(instance, 1147);
	}
