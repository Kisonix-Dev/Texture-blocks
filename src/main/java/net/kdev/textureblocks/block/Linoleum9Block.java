...
public class Linoleum9Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_9")
	public static final Block block = null;

	public Linoleum9Block(TextureBlocksModElements instance) {
		super(instance, 761);
	}
