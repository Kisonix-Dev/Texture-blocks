...
public class Parquet82Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_82")
	public static final Block block = null;

	public Parquet82Block(TextureBlocksModElements instance) {
		super(instance, 1117);
	}
