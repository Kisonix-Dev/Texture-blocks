...
public class Woodenplanks10Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_10")
	public static final Block block = null;

	public Woodenplanks10Block(TextureBlocksModElements instance) {
		super(instance, 438);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_10");
		}
