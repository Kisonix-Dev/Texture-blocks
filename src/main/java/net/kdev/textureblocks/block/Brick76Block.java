...
public class Brick76Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_76")
	public static final Block block = null;

	public Brick76Block(TextureBlocksModElements instance) {
		super(instance, 607);
	}
