...
public class Sandstone90Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_90")
	public static final Block block = null;

	public Sandstone90Block(TextureBlocksModElements instance) {
		super(instance, 1344);
	}
