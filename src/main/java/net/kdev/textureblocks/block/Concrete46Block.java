...
public class Concrete46Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_46")
	public static final Block block = null;

	public Concrete46Block(TextureBlocksModElements instance) {
		super(instance, 98);
	}
