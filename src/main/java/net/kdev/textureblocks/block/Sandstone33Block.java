...
public class Sandstone33Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_33")
	public static final Block block = null;

	public Sandstone33Block(TextureBlocksModElements instance) {
		super(instance, 1287);
	}
