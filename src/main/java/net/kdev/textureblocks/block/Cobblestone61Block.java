...
public class Cobblestone61Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_61")
	public static final Block block = null;

	public Cobblestone61Block(TextureBlocksModElements instance) {
		super(instance, 208);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_61");
		}
