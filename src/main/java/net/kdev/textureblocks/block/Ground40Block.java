...
public class Ground40Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_40")
	public static final Block block = null;

	public Ground40Block(TextureBlocksModElements instance) {
		super(instance, 316);
	}
