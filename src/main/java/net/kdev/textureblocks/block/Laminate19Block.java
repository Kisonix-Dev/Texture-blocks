...
public class Laminate19Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_19")
	public static final Block block = null;

	public Laminate19Block(TextureBlocksModElements instance) {
		super(instance, 675);
	}
