...
public class Laminate41Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_41")
	public static final Block block = null;

	public Laminate41Block(TextureBlocksModElements instance) {
		super(instance, 697);
	}
