...
public class Panels51Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_51")
	public static final Block block = null;

	public Panels51Block(TextureBlocksModElements instance) {
		super(instance, 996);
	}
