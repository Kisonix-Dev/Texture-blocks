...
public class Panels23Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_23")
	public static final Block block = null;

	public Panels23Block(TextureBlocksModElements instance) {
		super(instance, 968);
	}
