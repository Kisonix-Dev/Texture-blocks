...
public class Woodenplanks90Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_90")
	public static final Block block = null;

	public Woodenplanks90Block(TextureBlocksModElements instance) {
		super(instance, 518);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_90");
		}
