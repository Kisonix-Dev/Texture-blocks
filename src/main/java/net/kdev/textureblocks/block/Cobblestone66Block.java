...
public class Cobblestone66Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_66")
	public static final Block block = null;

	public Cobblestone66Block(TextureBlocksModElements instance) {
		super(instance, 213);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_66");
		}
