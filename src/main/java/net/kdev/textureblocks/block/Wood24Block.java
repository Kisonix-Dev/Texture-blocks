...
public class Wood24Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_24")
	public static final Block block = null;

	public Wood24Block(TextureBlocksModElements instance) {
		super(instance, 356);
	}
