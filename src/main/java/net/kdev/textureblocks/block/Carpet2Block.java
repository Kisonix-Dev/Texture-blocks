...
public class Carpet2Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_2")
	public static final Block block = null;

	public Carpet2Block(TextureBlocksModElements instance) {
		super(instance, 630);
	}
