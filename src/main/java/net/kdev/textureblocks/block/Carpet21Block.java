...
public class Carpet21Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_21")
	public static final Block block = null;

	public Carpet21Block(TextureBlocksModElements instance) {
		super(instance, 649);
	}
