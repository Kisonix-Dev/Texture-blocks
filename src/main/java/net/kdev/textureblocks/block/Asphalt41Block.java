...
public class Asphalt41Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_41_1")
	public static final Block block = null;

	public Asphalt41Block(TextureBlocksModElements instance) {
		super(instance, 44);
	}
