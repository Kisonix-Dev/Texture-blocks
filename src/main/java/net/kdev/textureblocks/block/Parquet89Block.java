...
public class Parquet89Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_89")
	public static final Block block = null;

	public Parquet89Block(TextureBlocksModElements instance) {
		super(instance, 1124);
	}
