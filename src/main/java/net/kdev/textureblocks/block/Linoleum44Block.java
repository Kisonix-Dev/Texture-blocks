...
public class Linoleum44Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_44")
	public static final Block block = null;

	public Linoleum44Block(TextureBlocksModElements instance) {
		super(instance, 796);
	}
