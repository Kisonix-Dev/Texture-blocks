...
public class Asphalt1Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_1_1")
	public static final Block block = null;

	public Asphalt1Block(TextureBlocksModElements instance) {
		super(instance, 2);
	}
