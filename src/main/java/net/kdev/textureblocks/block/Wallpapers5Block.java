...
public class Wallpapers5Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_5")
	public static final Block block = null;

	public Wallpapers5Block(TextureBlocksModElements instance) {
		super(instance, 1132);
	}
