...
public class Sandstone9Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_9")
	public static final Block block = null;

	public Sandstone9Block(TextureBlocksModElements instance) {
		super(instance, 1263);
	}
