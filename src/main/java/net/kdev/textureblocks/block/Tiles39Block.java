...
public class Tiles39Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_39")
	public static final Block block = null;

	public Tiles39Block(TextureBlocksModElements instance) {
		super(instance, 1389);
	}
