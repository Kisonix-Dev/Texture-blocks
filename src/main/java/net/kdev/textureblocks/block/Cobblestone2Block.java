...
public class Cobblestone2Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_2")
	public static final Block block = null;

	public Cobblestone2Block(TextureBlocksModElements instance) {
		super(instance, 149);
	}
