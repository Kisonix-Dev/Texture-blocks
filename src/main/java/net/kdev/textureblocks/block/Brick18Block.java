...
public class Brick18Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_18")
	public static final Block block = null;

	public Brick18Block(TextureBlocksModElements instance) {
		super(instance, 549);
	}
