...
public class Concrete16Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_16")
	public static final Block block = null;

	public Concrete16Block(TextureBlocksModElements instance) {
		super(instance, 68);
	}
