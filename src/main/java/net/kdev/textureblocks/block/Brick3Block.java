...
public class Brick3Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_3")
	public static final Block block = null;

	public Brick3Block(TextureBlocksModElements instance) {
		super(instance, 534);
	}
