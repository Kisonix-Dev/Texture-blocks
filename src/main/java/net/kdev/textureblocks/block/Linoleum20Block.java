...
public class Linoleum20Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_20")
	public static final Block block = null;

	public Linoleum20Block(TextureBlocksModElements instance) {
		super(instance, 772);
	}
