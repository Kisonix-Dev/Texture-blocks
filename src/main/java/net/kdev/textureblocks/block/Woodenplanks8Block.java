...
public class Woodenplanks8Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_8")
	public static final Block block = null;

	public Woodenplanks8Block(TextureBlocksModElements instance) {
		super(instance, 436);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_8");
		}
