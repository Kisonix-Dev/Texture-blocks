...
public class Sandstone63Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_63")
	public static final Block block = null;

	public Sandstone63Block(TextureBlocksModElements instance) {
		super(instance, 1317);
	}
