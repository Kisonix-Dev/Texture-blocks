...
public class Laminate96Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_96")
	public static final Block block = null;

	public Laminate96Block(TextureBlocksModElements instance) {
		super(instance, 752);
	}
