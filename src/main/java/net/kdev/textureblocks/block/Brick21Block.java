...
public class Brick21Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_21")
	public static final Block block = null;

	public Brick21Block(TextureBlocksModElements instance) {
		super(instance, 552);
	}
