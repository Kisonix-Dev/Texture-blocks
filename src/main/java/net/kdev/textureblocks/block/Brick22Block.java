...
public class Brick22Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_22")
	public static final Block block = null;

	public Brick22Block(TextureBlocksModElements instance) {
		super(instance, 553);
	}
