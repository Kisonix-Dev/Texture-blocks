...
public class Tiles62Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_62")
	public static final Block block = null;

	public Tiles62Block(TextureBlocksModElements instance) {
		super(instance, 1412);
	}
