...
public class Wallpapers16Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_16")
	public static final Block block = null;

	public Wallpapers16Block(TextureBlocksModElements instance) {
		super(instance, 1143);
	}
