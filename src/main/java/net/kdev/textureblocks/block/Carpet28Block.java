...
public class Carpet28Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_28")
	public static final Block block = null;

	public Carpet28Block(TextureBlocksModElements instance) {
		super(instance, 656);
	}
