...
public class Granite29Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_29")
	public static final Block block = null;

	public Granite29Block(TextureBlocksModElements instance) {
		super(instance, 275);
	}
