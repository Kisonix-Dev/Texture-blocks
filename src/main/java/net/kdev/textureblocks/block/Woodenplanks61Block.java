...
public class Woodenplanks61Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_61")
	public static final Block block = null;

	public Woodenplanks61Block(TextureBlocksModElements instance) {
		super(instance, 489);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_61");
		}
