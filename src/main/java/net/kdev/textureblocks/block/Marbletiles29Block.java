...
public class Marbletiles29Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_29")
	public static final Block block = null;

	public Marbletiles29Block(TextureBlocksModElements instance) {
		super(instance, 887);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_29");
		}
