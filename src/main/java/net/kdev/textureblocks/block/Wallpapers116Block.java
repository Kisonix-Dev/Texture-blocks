...
public class Wallpapers116Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_116")
	public static final Block block = null;

	public Wallpapers116Block(TextureBlocksModElements instance) {
		super(instance, 1243);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_116");
		}
