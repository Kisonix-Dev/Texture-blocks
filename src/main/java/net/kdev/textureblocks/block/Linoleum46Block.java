...
public class Linoleum46Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_46")
	public static final Block block = null;

	public Linoleum46Block(TextureBlocksModElements instance) {
		super(instance, 798);
	}
