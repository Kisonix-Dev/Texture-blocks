...
public class Laminate33Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_33")
	public static final Block block = null;

	public Laminate33Block(TextureBlocksModElements instance) {
		super(instance, 689);
	}
