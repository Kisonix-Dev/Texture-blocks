...
public class Ground22Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_22")
	public static final Block block = null;

	public Ground22Block(TextureBlocksModElements instance) {
		super(instance, 298);
	}
