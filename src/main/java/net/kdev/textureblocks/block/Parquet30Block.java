...
public class Parquet30Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_30")
	public static final Block block = null;

	public Parquet30Block(TextureBlocksModElements instance) {
		super(instance, 1065);
	}
