...
public class Wallpapers105Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_105")
	public static final Block block = null;

	public Wallpapers105Block(TextureBlocksModElements instance) {
		super(instance, 1232);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_105");
		}
