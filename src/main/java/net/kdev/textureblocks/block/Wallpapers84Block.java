...
public class Wallpapers84Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_84")
	public static final Block block = null;

	public Wallpapers84Block(TextureBlocksModElements instance) {
		super(instance, 1211);
	}
