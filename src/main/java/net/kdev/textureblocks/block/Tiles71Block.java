...
public class Tiles71Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_71")
	public static final Block block = null;

	public Tiles71Block(TextureBlocksModElements instance) {
		super(instance, 1421);
	}
