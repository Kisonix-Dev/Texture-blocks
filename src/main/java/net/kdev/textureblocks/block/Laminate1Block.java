...
public class Laminate1Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_1")
	public static final Block block = null;

	public Laminate1Block(TextureBlocksModElements instance) {
		super(instance, 657);
	}
