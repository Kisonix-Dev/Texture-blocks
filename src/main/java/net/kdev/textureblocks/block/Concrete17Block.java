...
public class Concrete17Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_17")
	public static final Block block = null;

	public Concrete17Block(TextureBlocksModElements instance) {
		super(instance, 69);
	}
