...
public class Wallpapers119Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_119")
	public static final Block block = null;

	public Wallpapers119Block(TextureBlocksModElements instance) {
		super(instance, 1246);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_119");
		}
