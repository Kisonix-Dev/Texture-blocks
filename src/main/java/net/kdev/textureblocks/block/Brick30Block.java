...
public class Brick30Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_30")
	public static final Block block = null;

	public Brick30Block(TextureBlocksModElements instance) {
		super(instance, 561);
	}
