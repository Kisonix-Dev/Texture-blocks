...
public class Wood91Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_91")
	public static final Block block = null;

	public Wood91Block(TextureBlocksModElements instance) {
		super(instance, 423);
	}
