...
public class Linoleum72Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_72")
	public static final Block block = null;

	public Linoleum72Block(TextureBlocksModElements instance) {
		super(instance, 824);
	}
