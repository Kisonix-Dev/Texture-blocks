...
public class Wallpapers22Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_22")
	public static final Block block = null;

	public Wallpapers22Block(TextureBlocksModElements instance) {
		super(instance, 1149);
	}
