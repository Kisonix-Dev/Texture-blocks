...
public class Marbletiles33Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_33")
	public static final Block block = null;

	public Marbletiles33Block(TextureBlocksModElements instance) {
		super(instance, 891);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_33");
		}
