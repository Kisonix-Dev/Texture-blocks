...
public class Sandstone80Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_80")
	public static final Block block = null;

	public Sandstone80Block(TextureBlocksModElements instance) {
		super(instance, 1334);
	}
