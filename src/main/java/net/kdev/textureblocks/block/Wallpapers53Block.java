...
public class Wallpapers53Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_53")
	public static final Block block = null;

	public Wallpapers53Block(TextureBlocksModElements instance) {
		super(instance, 1180);
	}
