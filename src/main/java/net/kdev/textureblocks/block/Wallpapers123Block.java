...
public class Wallpapers123Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_123")
	public static final Block block = null;

	public Wallpapers123Block(TextureBlocksModElements instance) {
		super(instance, 1250);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_123");
		}
