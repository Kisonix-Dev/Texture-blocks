...
public class Wallpapers73Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_73")
	public static final Block block = null;

	public Wallpapers73Block(TextureBlocksModElements instance) {
		super(instance, 1200);
	}
