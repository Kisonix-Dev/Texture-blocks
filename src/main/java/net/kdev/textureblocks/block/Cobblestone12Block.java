...
public class Cobblestone12Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_12")
	public static final Block block = null;

	public Cobblestone12Block(TextureBlocksModElements instance) {
		super(instance, 159);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_12");
		}
