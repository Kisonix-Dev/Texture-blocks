...
public class Laminate28Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_28")
	public static final Block block = null;

	public Laminate28Block(TextureBlocksModElements instance) {
		super(instance, 684);
	}
