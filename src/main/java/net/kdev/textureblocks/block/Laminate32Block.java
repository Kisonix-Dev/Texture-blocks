...
public class Laminate32Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_32")
	public static final Block block = null;

	public Laminate32Block(TextureBlocksModElements instance) {
		super(instance, 688);
	}
