...
public class Wallpapers21Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_21")
	public static final Block block = null;

	public Wallpapers21Block(TextureBlocksModElements instance) {
		super(instance, 1148);
	}
