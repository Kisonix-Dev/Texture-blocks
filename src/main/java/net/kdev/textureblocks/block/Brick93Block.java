...
public class Brick93Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_93")
	public static final Block block = null;

	public Brick93Block(TextureBlocksModElements instance) {
		super(instance, 624);
	}
