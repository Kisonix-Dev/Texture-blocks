...
public class Wood79Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_79")
	public static final Block block = null;

	public Wood79Block(TextureBlocksModElements instance) {
		super(instance, 411);
	}
