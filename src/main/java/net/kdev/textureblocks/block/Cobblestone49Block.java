...
public class Cobblestone49Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_49")
	public static final Block block = null;

	public Cobblestone49Block(TextureBlocksModElements instance) {
		super(instance, 196);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_49");
		}
