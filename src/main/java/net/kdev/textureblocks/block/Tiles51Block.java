...
public class Tiles51Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_51")
	public static final Block block = null;

	public Tiles51Block(TextureBlocksModElements instance) {
		super(instance, 1401);
	}
