...
public class Woodenplanks11Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_11")
	public static final Block block = null;

	public Woodenplanks11Block(TextureBlocksModElements instance) {
		super(instance, 439);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_11");
		}
