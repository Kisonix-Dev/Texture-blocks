...
public class Cobblestone94Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_94")
	public static final Block block = null;

	public Cobblestone94Block(TextureBlocksModElements instance) {
		super(instance, 241);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_94");
		}
