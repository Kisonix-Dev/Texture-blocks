...
public class Stone4Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:stone_4")
	public static final Block block = null;

	public Stone4Block(TextureBlocksModElements instance) {
		super(instance, 527);
	}
