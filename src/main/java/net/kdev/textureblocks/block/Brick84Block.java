...
public class Brick84Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_84")
	public static final Block block = null;

	public Brick84Block(TextureBlocksModElements instance) {
		super(instance, 615);
	}
