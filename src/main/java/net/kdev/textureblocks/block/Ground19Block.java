...
public class Ground19Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_19")
	public static final Block block = null;

	public Ground19Block(TextureBlocksModElements instance) {
		super(instance, 295);
	}
