...
public class Panels67Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_67")
	public static final Block block = null;

	public Panels67Block(TextureBlocksModElements instance) {
		super(instance, 1012);
	}
