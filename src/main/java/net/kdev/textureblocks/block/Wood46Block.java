...
public class Wood46Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_46")
	public static final Block block = null;

	public Wood46Block(TextureBlocksModElements instance) {
		super(instance, 378);
	}
