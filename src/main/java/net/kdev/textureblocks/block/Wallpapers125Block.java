...
public class Wallpapers125Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_125")
	public static final Block block = null;

	public Wallpapers125Block(TextureBlocksModElements instance) {
		super(instance, 1252);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_125");
		}
