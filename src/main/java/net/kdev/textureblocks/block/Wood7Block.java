...
public class Wood7Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_7")
	public static final Block block = null;

	public Wood7Block(TextureBlocksModElements instance) {
		super(instance, 339);
	}
