...
public class Marbletiles12Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_12")
	public static final Block block = null;

	public Marbletiles12Block(TextureBlocksModElements instance) {
		super(instance, 870);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_12");
		}
