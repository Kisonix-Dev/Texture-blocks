...
public class Wallpapers48Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_48")
	public static final Block block = null;

	public Wallpapers48Block(TextureBlocksModElements instance) {
		super(instance, 1175);
	}
