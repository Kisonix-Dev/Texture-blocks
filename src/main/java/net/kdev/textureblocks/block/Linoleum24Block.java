...
public class Linoleum24Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_24")
	public static final Block block = null;

	public Linoleum24Block(TextureBlocksModElements instance) {
		super(instance, 776);
	}
