...
public class Laminate15Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_15")
	public static final Block block = null;

	public Laminate15Block(TextureBlocksModElements instance) {
		super(instance, 671);
	}
