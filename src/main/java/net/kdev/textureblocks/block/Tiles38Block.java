...
public class Tiles38Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_38")
	public static final Block block = null;

	public Tiles38Block(TextureBlocksModElements instance) {
		super(instance, 1388);
	}
