...
public class Concrete88Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_88")
	public static final Block block = null;

	public Concrete88Block(TextureBlocksModElements instance) {
		super(instance, 140);
	}
