...
public class Laminate78Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_78")
	public static final Block block = null;

	public Laminate78Block(TextureBlocksModElements instance) {
		super(instance, 734);
	}
