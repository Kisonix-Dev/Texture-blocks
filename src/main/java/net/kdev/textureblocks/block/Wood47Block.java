...
public class Wood47Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_47")
	public static final Block block = null;

	public Wood47Block(TextureBlocksModElements instance) {
		super(instance, 379);
	}
