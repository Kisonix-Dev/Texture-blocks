...
public class Parquet90Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_90")
	public static final Block block = null;

	public Parquet90Block(TextureBlocksModElements instance) {
		super(instance, 1125);
	}
