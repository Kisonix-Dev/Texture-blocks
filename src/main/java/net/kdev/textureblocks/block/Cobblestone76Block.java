...
public class Cobblestone76Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_76")
	public static final Block block = null;

	public Cobblestone76Block(TextureBlocksModElements instance) {
		super(instance, 223);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_76");
		}
