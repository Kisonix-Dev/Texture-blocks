...
public class Panels62Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_62")
	public static final Block block = null;

	public Panels62Block(TextureBlocksModElements instance) {
		super(instance, 1007);
	}
