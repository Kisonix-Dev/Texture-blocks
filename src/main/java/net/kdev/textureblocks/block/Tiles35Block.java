...
public class Tiles35Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_35")
	public static final Block block = null;

	public Tiles35Block(TextureBlocksModElements instance) {
		super(instance, 1385);
	}
