...
public class Woodenplanks89Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_89")
	public static final Block block = null;

	public Woodenplanks89Block(TextureBlocksModElements instance) {
		super(instance, 517);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_89");
		}
