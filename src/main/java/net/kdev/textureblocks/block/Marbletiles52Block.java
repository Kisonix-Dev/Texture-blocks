...
public class Marbletiles52Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_52")
	public static final Block block = null;

	public Marbletiles52Block(TextureBlocksModElements instance) {
		super(instance, 910);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_52");
		}
