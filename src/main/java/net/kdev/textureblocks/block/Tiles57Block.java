...
public class Tiles57Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_57")
	public static final Block block = null;

	public Tiles57Block(TextureBlocksModElements instance) {
		super(instance, 1407);
	}
