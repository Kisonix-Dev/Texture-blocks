...
public class Sandstone67Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_67")
	public static final Block block = null;

	public Sandstone67Block(TextureBlocksModElements instance) {
		super(instance, 1321);
	}
