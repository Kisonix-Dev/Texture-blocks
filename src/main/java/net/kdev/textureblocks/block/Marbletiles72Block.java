...
public class Marbletiles72Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_72")
	public static final Block block = null;

	public Marbletiles72Block(TextureBlocksModElements instance) {
		super(instance, 930);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_72");
		}
