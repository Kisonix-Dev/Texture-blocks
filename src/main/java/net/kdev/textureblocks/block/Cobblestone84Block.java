...
public class Cobblestone84Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_84")
	public static final Block block = null;

	public Cobblestone84Block(TextureBlocksModElements instance) {
		super(instance, 231);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_84");
		}
