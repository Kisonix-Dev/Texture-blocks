...
public class Concrete57Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_57")
	public static final Block block = null;

	public Concrete57Block(TextureBlocksModElements instance) {
		super(instance, 109);
	}
