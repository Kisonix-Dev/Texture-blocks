...
public class Sandstone3Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_3")
	public static final Block block = null;

	public Sandstone3Block(TextureBlocksModElements instance) {
		super(instance, 1257);
	}
