...
public class Marbletiles42Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_42")
	public static final Block block = null;

	public Marbletiles42Block(TextureBlocksModElements instance) {
		super(instance, 900);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_42");
		}
