...
public class Cobblestone27Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_27")
	public static final Block block = null;

	public Cobblestone27Block(TextureBlocksModElements instance) {
		super(instance, 174);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_27");
		}
