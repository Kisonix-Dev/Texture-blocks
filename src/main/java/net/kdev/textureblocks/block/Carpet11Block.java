...
public class Carpet11Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_11")
	public static final Block block = null;

	public Carpet11Block(TextureBlocksModElements instance) {
		super(instance, 639);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOL).sound(SoundType.CLOTH).hardnessAndResistance(1.5f, 6f).setLightLevel(s -> 0));
			setRegistryName("carpet_11");
		}
