...
public class Tiles29Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_29")
	public static final Block block = null;

	public Tiles29Block(TextureBlocksModElements instance) {
		super(instance, 1379);
	}
