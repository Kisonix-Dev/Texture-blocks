...
public class Cobblestone33Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_33")
	public static final Block block = null;

	public Cobblestone33Block(TextureBlocksModElements instance) {
		super(instance, 180);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_33");
		}
