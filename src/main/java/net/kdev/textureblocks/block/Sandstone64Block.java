...
public class Sandstone64Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_64")
	public static final Block block = null;

	public Sandstone64Block(TextureBlocksModElements instance) {
		super(instance, 1318);
	}
