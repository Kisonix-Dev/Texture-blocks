...
public class Linoleum28Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_28")
	public static final Block block = null;

	public Linoleum28Block(TextureBlocksModElements instance) {
		super(instance, 780);
	}
