...
public class Concrete3Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_3")
	public static final Block block = null;

	public Concrete3Block(TextureBlocksModElements instance) {
		super(instance, 55);
	}
