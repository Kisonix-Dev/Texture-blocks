...
public class Cobblestone32Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_32")
	public static final Block block = null;

	public Cobblestone32Block(TextureBlocksModElements instance) {
		super(instance, 179);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_32");
		}
