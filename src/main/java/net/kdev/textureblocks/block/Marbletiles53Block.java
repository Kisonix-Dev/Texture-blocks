...
public class Marbletiles53Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_53")
	public static final Block block = null;

	public Marbletiles53Block(TextureBlocksModElements instance) {
		super(instance, 911);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_53");
		}
