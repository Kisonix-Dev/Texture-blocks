...
public class Sandstone35Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_35")
	public static final Block block = null;

	public Sandstone35Block(TextureBlocksModElements instance) {
		super(instance, 1289);
	}
