...
public class Wood78Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_78")
	public static final Block block = null;

	public Wood78Block(TextureBlocksModElements instance) {
		super(instance, 410);
	}
