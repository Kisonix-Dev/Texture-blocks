...
public class Tiles48Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_48")
	public static final Block block = null;

	public Tiles48Block(TextureBlocksModElements instance) {
		super(instance, 1398);
	}
