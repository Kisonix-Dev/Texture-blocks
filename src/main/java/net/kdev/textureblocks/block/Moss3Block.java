...
public class Moss3Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:moss_3")
	public static final Block block = null;

	public Moss3Block(TextureBlocksModElements instance) {
		super(instance, 848);
	}
