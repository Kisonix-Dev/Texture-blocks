...
public class Parquet18Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_18")
	public static final Block block = null;

	public Parquet18Block(TextureBlocksModElements instance) {
		super(instance, 1053);
	}
