...
public class Ground4Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_4")
	public static final Block block = null;

	public Ground4Block(TextureBlocksModElements instance) {
		super(instance, 280);
	}
