...
public class Panels44Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_44")
	public static final Block block = null;

	public Panels44Block(TextureBlocksModElements instance) {
		super(instance, 989);
	}
