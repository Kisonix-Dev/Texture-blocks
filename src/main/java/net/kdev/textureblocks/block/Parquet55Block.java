...
public class Parquet55Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_55")
	public static final Block block = null;

	public Parquet55Block(TextureBlocksModElements instance) {
		super(instance, 1090);
	}
