...
public class Tiles56Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_56")
	public static final Block block = null;

	public Tiles56Block(TextureBlocksModElements instance) {
		super(instance, 1406);
	}
