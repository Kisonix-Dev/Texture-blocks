...
public class Panels87Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_87")
	public static final Block block = null;

	public Panels87Block(TextureBlocksModElements instance) {
		super(instance, 1032);
	}
