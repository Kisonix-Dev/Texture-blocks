...
public class Wallpapers108Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_108")
	public static final Block block = null;

	public Wallpapers108Block(TextureBlocksModElements instance) {
		super(instance, 1235);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_108");
		}
