...
public class Tiles17Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_17")
	public static final Block block = null;

	public Tiles17Block(TextureBlocksModElements instance) {
		super(instance, 1367);
	}
