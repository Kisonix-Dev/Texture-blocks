...
public class Linoleum3Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_3")
	public static final Block block = null;

	public Linoleum3Block(TextureBlocksModElements instance) {
		super(instance, 755);
	}
