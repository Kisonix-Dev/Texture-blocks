...
public class Panels74Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_74")
	public static final Block block = null;

	public Panels74Block(TextureBlocksModElements instance) {
		super(instance, 1019);
	}
