...
public class Tiles5Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_5")
	public static final Block block = null;

	public Tiles5Block(TextureBlocksModElements instance) {
		super(instance, 1355);
	}
