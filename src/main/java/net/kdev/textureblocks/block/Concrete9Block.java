...
public class Concrete9Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_9")
	public static final Block block = null;

	public Concrete9Block(TextureBlocksModElements instance) {
		super(instance, 61);
	}
