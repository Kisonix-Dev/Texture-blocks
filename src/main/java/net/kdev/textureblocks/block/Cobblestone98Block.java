...
public class Cobblestone98Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_98")
	public static final Block block = null;

	public Cobblestone98Block(TextureBlocksModElements instance) {
		super(instance, 245);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_98");
		}
