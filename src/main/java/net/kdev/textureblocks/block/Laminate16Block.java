...
public class Laminate16Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_16")
	public static final Block block = null;

	public Laminate16Block(TextureBlocksModElements instance) {
		super(instance, 672);
	}
