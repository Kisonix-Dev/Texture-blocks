...
public class Ground38Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_38")
	public static final Block block = null;

	public Ground38Block(TextureBlocksModElements instance) {
		super(instance, 314);
	}
