...
public class Linoleum11Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_11")
	public static final Block block = null;

	public Linoleum11Block(TextureBlocksModElements instance) {
		super(instance, 763);
	}
