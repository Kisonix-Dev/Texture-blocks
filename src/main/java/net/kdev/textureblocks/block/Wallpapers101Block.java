...
public class Wallpapers101Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_101")
	public static final Block block = null;

	public Wallpapers101Block(TextureBlocksModElements instance) {
		super(instance, 1228);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_101");
		}
