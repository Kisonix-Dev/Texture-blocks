...
public class Woodenplanks53Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_53")
	public static final Block block = null;

	public Woodenplanks53Block(TextureBlocksModElements instance) {
		super(instance, 481);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_53");
		}
