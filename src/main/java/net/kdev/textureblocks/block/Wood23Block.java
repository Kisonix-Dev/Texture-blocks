...
public class Wood23Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_23")
	public static final Block block = null;

	public Wood23Block(TextureBlocksModElements instance) {
		super(instance, 355);
	}
