...
public class Wallpapers28Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_28")
	public static final Block block = null;

	public Wallpapers28Block(TextureBlocksModElements instance) {
		super(instance, 1155);
	}
