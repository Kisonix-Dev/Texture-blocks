...
public class Tiles3Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_3")
	public static final Block block = null;

	public Tiles3Block(TextureBlocksModElements instance) {
		super(instance, 1353);
	}
