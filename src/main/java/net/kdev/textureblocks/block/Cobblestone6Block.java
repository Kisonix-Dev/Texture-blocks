...
public class Cobblestone6Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_6")
	public static final Block block = null;

	public Cobblestone6Block(TextureBlocksModElements instance) {
		super(instance, 153);
	}
