...
public class Cobblestone43Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_43")
	public static final Block block = null;

	public Cobblestone43Block(TextureBlocksModElements instance) {
		super(instance, 190);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_43");
		}
