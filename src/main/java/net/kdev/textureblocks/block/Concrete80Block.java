...
public class Concrete80Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_80")
	public static final Block block = null;

	public Concrete80Block(TextureBlocksModElements instance) {
		super(instance, 132);
	}
