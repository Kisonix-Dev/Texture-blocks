...
public class Sandstone4Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_4")
	public static final Block block = null;

	public Sandstone4Block(TextureBlocksModElements instance) {
		super(instance, 1258);
	}
