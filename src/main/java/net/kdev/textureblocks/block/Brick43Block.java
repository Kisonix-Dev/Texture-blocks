...
public class Brick43Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_43")
	public static final Block block = null;

	public Brick43Block(TextureBlocksModElements instance) {
		super(instance, 574);
	}
