...
public class Wood4Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_4")
	public static final Block block = null;

	public Wood4Block(TextureBlocksModElements instance) {
		super(instance, 336);
	}
