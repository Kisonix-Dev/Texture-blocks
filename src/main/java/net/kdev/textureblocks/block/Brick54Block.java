...
public class Brick54Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_54")
	public static final Block block = null;

	public Brick54Block(TextureBlocksModElements instance) {
		super(instance, 585);
	}
