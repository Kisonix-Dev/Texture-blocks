...
public class Brick28Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_28")
	public static final Block block = null;

	public Brick28Block(TextureBlocksModElements instance) {
		super(instance, 559);
	}
