...
public class Laminate49Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_49")
	public static final Block block = null;

	public Laminate49Block(TextureBlocksModElements instance) {
		super(instance, 705);
	}
