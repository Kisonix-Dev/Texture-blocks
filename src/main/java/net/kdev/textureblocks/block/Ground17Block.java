...
public class Ground17Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_17")
	public static final Block block = null;

	public Ground17Block(TextureBlocksModElements instance) {
		super(instance, 293);
	}
