...
public class Woodenplanks22Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_22")
	public static final Block block = null;

	public Woodenplanks22Block(TextureBlocksModElements instance) {
		super(instance, 450);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_22");
		}
