...
public class Carpet4Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_4")
	public static final Block block = null;

	public Carpet4Block(TextureBlocksModElements instance) {
		super(instance, 632);
	}
