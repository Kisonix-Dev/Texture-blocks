...
public class Cobblestone53Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_53")
	public static final Block block = null;

	public Cobblestone53Block(TextureBlocksModElements instance) {
		super(instance, 200);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_53");
		}
