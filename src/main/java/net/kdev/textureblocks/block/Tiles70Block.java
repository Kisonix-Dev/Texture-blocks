...
public class Tiles70Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_70")
	public static final Block block = null;

	public Tiles70Block(TextureBlocksModElements instance) {
		super(instance, 1420);
	}
