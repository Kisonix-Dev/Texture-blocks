...
public class Tiles85Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_85")
	public static final Block block = null;

	public Tiles85Block(TextureBlocksModElements instance) {
		super(instance, 1435);
	}
