...
public class Wallpapers127Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_127")
	public static final Block block = null;

	public Wallpapers127Block(TextureBlocksModElements instance) {
		super(instance, 1254);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_127");
		}
