...
public class Cobblestone44Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_44")
	public static final Block block = null;

	public Cobblestone44Block(TextureBlocksModElements instance) {
		super(instance, 191);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_44");
		}
