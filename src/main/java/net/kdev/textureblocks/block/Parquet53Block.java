...
public class Parquet53Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_53")
	public static final Block block = null;

	public Parquet53Block(TextureBlocksModElements instance) {
		super(instance, 1088);
	}
