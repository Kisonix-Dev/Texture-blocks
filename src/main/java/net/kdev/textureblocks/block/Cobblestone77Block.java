...
public class Cobblestone77Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_77")
	public static final Block block = null;

	public Cobblestone77Block(TextureBlocksModElements instance) {
		super(instance, 224);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_77");
		}
