...
public class Wallpapers100Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_100")
	public static final Block block = null;

	public Wallpapers100Block(TextureBlocksModElements instance) {
		super(instance, 1227);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wallpapers_100");
		}
