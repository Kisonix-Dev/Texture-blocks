...
public class Sandstone71Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_71")
	public static final Block block = null;

	public Sandstone71Block(TextureBlocksModElements instance) {
		super(instance, 1325);
	}
