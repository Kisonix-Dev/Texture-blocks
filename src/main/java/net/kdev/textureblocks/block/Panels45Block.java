...
public class Panels45Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_45")
	public static final Block block = null;

	public Panels45Block(TextureBlocksModElements instance) {
		super(instance, 990);
	}
