...
public class Brick81Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_81")
	public static final Block block = null;

	public Brick81Block(TextureBlocksModElements instance) {
		super(instance, 612);
	}
