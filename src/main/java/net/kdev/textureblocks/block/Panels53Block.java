...
public class Panels53Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_53")
	public static final Block block = null;

	public Panels53Block(TextureBlocksModElements instance) {
		super(instance, 998);
	}
