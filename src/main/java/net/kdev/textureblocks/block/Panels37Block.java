...
public class Panels37Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_37")
	public static final Block block = null;

	public Panels37Block(TextureBlocksModElements instance) {
		super(instance, 982);
	}
