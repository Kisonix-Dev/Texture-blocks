...
public class Carpet26Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_26")
	public static final Block block = null;

	public Carpet26Block(TextureBlocksModElements instance) {
		super(instance, 654);
	}
