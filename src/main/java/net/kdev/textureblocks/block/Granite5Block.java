...
public class Granite5Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_5")
	public static final Block block = null;

	public Granite5Block(TextureBlocksModElements instance) {
		super(instance, 251);
	}
