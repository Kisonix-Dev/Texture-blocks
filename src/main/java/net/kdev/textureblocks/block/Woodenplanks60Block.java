...
public class Woodenplanks60Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_60")
	public static final Block block = null;

	public Woodenplanks60Block(TextureBlocksModElements instance) {
		super(instance, 488);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_60");
		}
