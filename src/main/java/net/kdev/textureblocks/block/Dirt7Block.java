...
public class Dirt7Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:dirt_7")
	public static final Block block = null;

	public Dirt7Block(TextureBlocksModElements instance) {
		super(instance, 329);
	}
