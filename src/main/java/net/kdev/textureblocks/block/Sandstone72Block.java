...
public class Sandstone72Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_72")
	public static final Block block = null;

	public Sandstone72Block(TextureBlocksModElements instance) {
		super(instance, 1326);
	}
