...
public class Cobblestone79Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_79")
	public static final Block block = null;

	public Cobblestone79Block(TextureBlocksModElements instance) {
		super(instance, 226);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_79");
		}
