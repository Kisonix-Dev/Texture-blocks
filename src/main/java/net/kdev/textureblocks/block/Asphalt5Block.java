...
public class Asphalt5Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_5_1")
	public static final Block block = null;

	public Asphalt5Block(TextureBlocksModElements instance) {
		super(instance, 6);
	}
