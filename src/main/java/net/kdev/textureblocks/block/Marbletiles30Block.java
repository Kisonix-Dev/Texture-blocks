...
public class Marbletiles30Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_30")
	public static final Block block = null;

	public Marbletiles30Block(TextureBlocksModElements instance) {
		super(instance, 888);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_30");
		}
