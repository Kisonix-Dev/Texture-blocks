...
public class Concrete75Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_75")
	public static final Block block = null;

	public Concrete75Block(TextureBlocksModElements instance) {
		super(instance, 127);
	}
