...
public class Wood67Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_67")
	public static final Block block = null;

	public Wood67Block(TextureBlocksModElements instance) {
		super(instance, 399);
	}
