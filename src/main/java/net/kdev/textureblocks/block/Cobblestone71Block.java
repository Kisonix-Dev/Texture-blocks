...
public class Cobblestone71Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_71")
	public static final Block block = null;

	public Cobblestone71Block(TextureBlocksModElements instance) {
		super(instance, 218);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_71");
		}
