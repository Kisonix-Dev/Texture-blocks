...
public class Concrete26Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_26")
	public static final Block block = null;

	public Concrete26Block(TextureBlocksModElements instance) {
		super(instance, 78);
	}
