...
public class Marbletiles46Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_46")
	public static final Block block = null;

	public Marbletiles46Block(TextureBlocksModElements instance) {
		super(instance, 904);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_46");
		}
