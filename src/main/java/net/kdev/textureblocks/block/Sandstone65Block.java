...
public class Sandstone65Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_65")
	public static final Block block = null;

	public Sandstone65Block(TextureBlocksModElements instance) {
		super(instance, 1319);
	}
