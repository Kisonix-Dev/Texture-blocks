...
public class Cobblestone92Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_92")
	public static final Block block = null;

	public Cobblestone92Block(TextureBlocksModElements instance) {
		super(instance, 239);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_92");
		}
