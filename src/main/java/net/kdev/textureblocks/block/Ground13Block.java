...
public class Ground13Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_13")
	public static final Block block = null;

	public Ground13Block(TextureBlocksModElements instance) {
		super(instance, 289);
	}
