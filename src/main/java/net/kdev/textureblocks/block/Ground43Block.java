...
public class Ground43Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_43")
	public static final Block block = null;

	public Ground43Block(TextureBlocksModElements instance) {
		super(instance, 319);
	}
