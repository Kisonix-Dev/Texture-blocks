...
public class Panels52Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_52")
	public static final Block block = null;

	public Panels52Block(TextureBlocksModElements instance) {
		super(instance, 997);
	}
