...
public class Wallpapers26Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_26")
	public static final Block block = null;

	public Wallpapers26Block(TextureBlocksModElements instance) {
		super(instance, 1153);
	}
