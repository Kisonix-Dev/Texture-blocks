...
public class Granite20Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_20")
	public static final Block block = null;

	public Granite20Block(TextureBlocksModElements instance) {
		super(instance, 266);
	}
