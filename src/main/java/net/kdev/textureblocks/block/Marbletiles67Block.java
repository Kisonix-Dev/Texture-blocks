...
public class Marbletiles67Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_67")
	public static final Block block = null;

	public Marbletiles67Block(TextureBlocksModElements instance) {
		super(instance, 925);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_67");
		}
