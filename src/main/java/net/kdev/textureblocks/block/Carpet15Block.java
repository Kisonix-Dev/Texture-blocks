...
public class Carpet15Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_15")
	public static final Block block = null;

	public Carpet15Block(TextureBlocksModElements instance) {
		super(instance, 643);
	}
