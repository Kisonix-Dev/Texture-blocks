...
public class Wood71Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_71")
	public static final Block block = null;

	public Wood71Block(TextureBlocksModElements instance) {
		super(instance, 403);
	}
