...
public class Carpet6Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_6")
	public static final Block block = null;

	public Carpet6Block(TextureBlocksModElements instance) {
		super(instance, 634);
	}
