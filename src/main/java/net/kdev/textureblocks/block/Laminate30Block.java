...
public class Laminate30Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_30")
	public static final Block block = null;

	public Laminate30Block(TextureBlocksModElements instance) {
		super(instance, 686);
	}
