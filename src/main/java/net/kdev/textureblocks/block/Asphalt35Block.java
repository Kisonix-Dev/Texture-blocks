...
public class Asphalt35Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_35_1")
	public static final Block block = null;

	public Asphalt35Block(TextureBlocksModElements instance) {
		super(instance, 38);
	}
