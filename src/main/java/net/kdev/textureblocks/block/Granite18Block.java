...
public class Granite18Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:granite_18")
	public static final Block block = null;

	public Granite18Block(TextureBlocksModElements instance) {
		super(instance, 264);
	}
