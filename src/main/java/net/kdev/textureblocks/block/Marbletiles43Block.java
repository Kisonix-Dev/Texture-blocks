...
public class Marbletiles43Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_43")
	public static final Block block = null;

	public Marbletiles43Block(TextureBlocksModElements instance) {
		super(instance, 901);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_43");
		}
