...
public class Tiles31Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_31")
	public static final Block block = null;

	public Tiles31Block(TextureBlocksModElements instance) {
		super(instance, 1381);
	}
