...
public class Brick19Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_19")
	public static final Block block = null;

	public Brick19Block(TextureBlocksModElements instance) {
		super(instance, 550);
	}
