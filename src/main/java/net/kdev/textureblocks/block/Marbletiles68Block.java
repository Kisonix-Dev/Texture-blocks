...
public class Marbletiles68Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_68")
	public static final Block block = null;

	public Marbletiles68Block(TextureBlocksModElements instance) {
		super(instance, 926);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_68");
		}
