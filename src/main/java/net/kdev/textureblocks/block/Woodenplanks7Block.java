...
public class Woodenplanks7Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_7")
	public static final Block block = null;

	public Woodenplanks7Block(TextureBlocksModElements instance) {
		super(instance, 435);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_7");
		}
