...
public class Woodenplanks3Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_3")
	public static final Block block = null;

	public Woodenplanks3Block(TextureBlocksModElements instance) {
		super(instance, 431);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_3");
		}
