...
public class Tiles27Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_27")
	public static final Block block = null;

	public Tiles27Block(TextureBlocksModElements instance) {
		super(instance, 1377);
	}
