...
public class Asphalt9Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_9_1")
	public static final Block block = null;

	public Asphalt9Block(TextureBlocksModElements instance) {
		super(instance, 10);
	}
