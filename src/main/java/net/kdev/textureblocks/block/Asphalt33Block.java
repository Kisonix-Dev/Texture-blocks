...
public class Asphalt33Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_33_1")
	public static final Block block = null;

	public Asphalt33Block(TextureBlocksModElements instance) {
		super(instance, 36);
	}
