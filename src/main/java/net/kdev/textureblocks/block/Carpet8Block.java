...
public class Carpet8Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:carpet_8")
	public static final Block block = null;

	public Carpet8Block(TextureBlocksModElements instance) {
		super(instance, 636);
	}
