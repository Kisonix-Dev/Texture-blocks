...
public class Wood83Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_83")
	public static final Block block = null;

	public Wood83Block(TextureBlocksModElements instance) {
		super(instance, 415);
	}
