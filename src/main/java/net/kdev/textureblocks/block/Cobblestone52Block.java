...
public class Cobblestone52Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_52")
	public static final Block block = null;

	public Cobblestone52Block(TextureBlocksModElements instance) {
		super(instance, 199);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_52");
		}
