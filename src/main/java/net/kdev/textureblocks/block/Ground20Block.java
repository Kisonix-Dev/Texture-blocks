...
public class Ground20Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_20")
	public static final Block block = null;

	public Ground20Block(TextureBlocksModElements instance) {
		super(instance, 296);
	}
