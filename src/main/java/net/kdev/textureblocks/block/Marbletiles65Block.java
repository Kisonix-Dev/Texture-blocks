...
public class Marbletiles65Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_65")
	public static final Block block = null;

	public Marbletiles65Block(TextureBlocksModElements instance) {
		super(instance, 923);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_65");
		}
