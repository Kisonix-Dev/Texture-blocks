...
public class Wallpapers29Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_29")
	public static final Block block = null;

	public Wallpapers29Block(TextureBlocksModElements instance) {
		super(instance, 1156);
	}
