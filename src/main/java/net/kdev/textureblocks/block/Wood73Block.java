...
public class Wood73Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_73")
	public static final Block block = null;

	public Wood73Block(TextureBlocksModElements instance) {
		super(instance, 405);
	}
