...
public class Woodenplanks49Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_49")
	public static final Block block = null;

	public Woodenplanks49Block(TextureBlocksModElements instance) {
		super(instance, 477);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_49");
		}
