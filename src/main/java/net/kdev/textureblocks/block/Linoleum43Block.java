...
public class Linoleum43Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_43")
	public static final Block block = null;

	public Linoleum43Block(TextureBlocksModElements instance) {
		super(instance, 795);
	}
