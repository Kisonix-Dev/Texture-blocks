...
public class Woodenplanks27Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_27")
	public static final Block block = null;

	public Woodenplanks27Block(TextureBlocksModElements instance) {
		super(instance, 455);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_27");
		}
