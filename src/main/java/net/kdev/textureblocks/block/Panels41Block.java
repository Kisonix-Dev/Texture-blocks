...
public class Panels41Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_41")
	public static final Block block = null;

	public Panels41Block(TextureBlocksModElements instance) {
		super(instance, 986);
	}
