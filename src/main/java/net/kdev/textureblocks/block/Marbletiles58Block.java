...
public class Marbletiles58Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_58")
	public static final Block block = null;

	public Marbletiles58Block(TextureBlocksModElements instance) {
		super(instance, 916);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_58");
		}
