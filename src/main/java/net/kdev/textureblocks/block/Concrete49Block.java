...
public class Concrete49Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_49")
	public static final Block block = null;

	public Concrete49Block(TextureBlocksModElements instance) {
		super(instance, 101);
	}
