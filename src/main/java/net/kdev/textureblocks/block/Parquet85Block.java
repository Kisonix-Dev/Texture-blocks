...
public class Parquet85Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_85")
	public static final Block block = null;

	public Parquet85Block(TextureBlocksModElements instance) {
		super(instance, 1120);
	}
