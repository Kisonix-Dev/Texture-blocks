...
public class Sandstone79Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_79")
	public static final Block block = null;

	public Sandstone79Block(TextureBlocksModElements instance) {
		super(instance, 1333);
	}
