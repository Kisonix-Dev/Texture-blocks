...
public class Woodenplanks59Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_59")
	public static final Block block = null;

	public Woodenplanks59Block(TextureBlocksModElements instance) {
		super(instance, 487);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_59");
		}
