...
public class Brick7Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_7")
	public static final Block block = null;

	public Brick7Block(TextureBlocksModElements instance) {
		super(instance, 538);
	}
