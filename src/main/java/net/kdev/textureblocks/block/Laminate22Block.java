...
public class Laminate22Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_22")
	public static final Block block = null;

	public Laminate22Block(TextureBlocksModElements instance) {
		super(instance, 678);
	}
