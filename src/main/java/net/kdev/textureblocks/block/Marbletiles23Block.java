...
public class Marbletiles23Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_23")
	public static final Block block = null;

	public Marbletiles23Block(TextureBlocksModElements instance) {
		super(instance, 881);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_23");
		}
