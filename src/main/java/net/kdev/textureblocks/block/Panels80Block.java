...
public class Panels80Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_80")
	public static final Block block = null;

	public Panels80Block(TextureBlocksModElements instance) {
		super(instance, 1025);
	}
