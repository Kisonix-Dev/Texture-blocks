...
public class Ground9Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_9")
	public static final Block block = null;

	public Ground9Block(TextureBlocksModElements instance) {
		super(instance, 285);
	}
