...
public class Tiles54Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_54")
	public static final Block block = null;

	public Tiles54Block(TextureBlocksModElements instance) {
		super(instance, 1404);
	}
