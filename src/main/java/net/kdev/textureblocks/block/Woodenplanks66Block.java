...
public class Woodenplanks66Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_66")
	public static final Block block = null;

	public Woodenplanks66Block(TextureBlocksModElements instance) {
		super(instance, 494);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_66");
		}
