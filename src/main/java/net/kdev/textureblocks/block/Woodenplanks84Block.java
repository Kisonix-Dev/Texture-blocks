...
public class Woodenplanks84Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_84")
	public static final Block block = null;

	public Woodenplanks84Block(TextureBlocksModElements instance) {
		super(instance, 512);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_84");
		}
