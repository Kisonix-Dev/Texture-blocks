...
public class Brick49Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_49")
	public static final Block block = null;

	public Brick49Block(TextureBlocksModElements instance) {
		super(instance, 580);
	}
