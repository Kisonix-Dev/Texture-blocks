...
public class Tiles67Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_67")
	public static final Block block = null;

	public Tiles67Block(TextureBlocksModElements instance) {
		super(instance, 1417);
	}
