...
public class Brick82Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_82")
	public static final Block block = null;

	public Brick82Block(TextureBlocksModElements instance) {
		super(instance, 613);
	}
