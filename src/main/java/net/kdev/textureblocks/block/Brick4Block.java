...
public class Brick4Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_4")
	public static final Block block = null;

	public Brick4Block(TextureBlocksModElements instance) {
		super(instance, 535);
	}
