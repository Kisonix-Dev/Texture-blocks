...
public class Parquet68Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_68")
	public static final Block block = null;

	public Parquet68Block(TextureBlocksModElements instance) {
		super(instance, 1103);
	}
