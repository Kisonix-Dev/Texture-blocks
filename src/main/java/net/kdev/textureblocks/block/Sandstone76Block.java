...
public class Sandstone76Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_76")
	public static final Block block = null;

	public Sandstone76Block(TextureBlocksModElements instance) {
		super(instance, 1330);
	}
