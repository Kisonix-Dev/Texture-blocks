...
public class Ground42Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:ground_42")
	public static final Block block = null;

	public Ground42Block(TextureBlocksModElements instance) {
		super(instance, 318);
	}
