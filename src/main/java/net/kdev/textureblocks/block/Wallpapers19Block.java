...
public class Wallpapers19Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_19")
	public static final Block block = null;

	public Wallpapers19Block(TextureBlocksModElements instance) {
		super(instance, 1146);
	}
