...
public class Tiles60Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:tiles_60")
	public static final Block block = null;

	public Tiles60Block(TextureBlocksModElements instance) {
		super(instance, 1410);
	}
