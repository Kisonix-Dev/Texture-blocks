...
public class Asphalt42Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:asphalt_42_1")
	public static final Block block = null;

	public Asphalt42Block(TextureBlocksModElements instance) {
		super(instance, 45);
	}
