...
public class Sandstone83Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_83")
	public static final Block block = null;

	public Sandstone83Block(TextureBlocksModElements instance) {
		super(instance, 1337);
	}
