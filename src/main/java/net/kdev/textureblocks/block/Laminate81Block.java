...
public class Laminate81Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_81")
	public static final Block block = null;

	public Laminate81Block(TextureBlocksModElements instance) {
		super(instance, 737);
	}
