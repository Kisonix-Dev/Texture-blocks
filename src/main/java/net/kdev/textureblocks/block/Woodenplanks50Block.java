...
public class Woodenplanks50Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_50")
	public static final Block block = null;

	public Woodenplanks50Block(TextureBlocksModElements instance) {
		super(instance, 478);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_50");
		}
