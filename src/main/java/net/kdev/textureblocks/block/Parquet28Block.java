...
public class Parquet28Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_28")
	public static final Block block = null;

	public Parquet28Block(TextureBlocksModElements instance) {
		super(instance, 1063);
	}
