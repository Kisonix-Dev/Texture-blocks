...
public class Marbletiles76Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_76")
	public static final Block block = null;

	public Marbletiles76Block(TextureBlocksModElements instance) {
		super(instance, 934);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_76");
		}
