...
public class Wallpapers49Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wallpapers_49")
	public static final Block block = null;

	public Wallpapers49Block(TextureBlocksModElements instance) {
		super(instance, 1176);
	}
