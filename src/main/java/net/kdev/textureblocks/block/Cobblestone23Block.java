...
public class Cobblestone23Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_23")
	public static final Block block = null;

	public Cobblestone23Block(TextureBlocksModElements instance) {
		super(instance, 170);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_23");
		}
