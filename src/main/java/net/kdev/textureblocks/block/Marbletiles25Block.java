...
public class Marbletiles25Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_25")
	public static final Block block = null;

	public Marbletiles25Block(TextureBlocksModElements instance) {
		super(instance, 883);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_25");
		}
