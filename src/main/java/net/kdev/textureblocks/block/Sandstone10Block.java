...
public class Sandstone10Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_10")
	public static final Block block = null;

	public Sandstone10Block(TextureBlocksModElements instance) {
		super(instance, 1264);
	}
