...
public class Woodenplanks68Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_68")
	public static final Block block = null;

	public Woodenplanks68Block(TextureBlocksModElements instance) {
		super(instance, 496);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_68");
		}
