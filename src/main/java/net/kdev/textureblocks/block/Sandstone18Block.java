...
public class Sandstone18Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_18")
	public static final Block block = null;

	public Sandstone18Block(TextureBlocksModElements instance) {
		super(instance, 1272);
	}
