...
public class Woodenplanks24Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_24")
	public static final Block block = null;

	public Woodenplanks24Block(TextureBlocksModElements instance) {
		super(instance, 452);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_24");
		}
