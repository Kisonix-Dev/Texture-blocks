...
public class Wood96Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_96")
	public static final Block block = null;

	public Wood96Block(TextureBlocksModElements instance) {
		super(instance, 428);
	}
