...
public class Cobblestone4Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_4")
	public static final Block block = null;

	public Cobblestone4Block(TextureBlocksModElements instance) {
		super(instance, 151);
	}
