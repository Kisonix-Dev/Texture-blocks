...
public class Sandstone74Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_74")
	public static final Block block = null;

	public Sandstone74Block(TextureBlocksModElements instance) {
		super(instance, 1328);
	}
