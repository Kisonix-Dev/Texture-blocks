...
public class Panels73Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_73")
	public static final Block block = null;

	public Panels73Block(TextureBlocksModElements instance) {
		super(instance, 1018);
	}
