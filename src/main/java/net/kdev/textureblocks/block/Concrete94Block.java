...
public class Concrete94Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_94")
	public static final Block block = null;

	public Concrete94Block(TextureBlocksModElements instance) {
		super(instance, 146);
	}
