...
public class Sandstone17Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_17")
	public static final Block block = null;

	public Sandstone17Block(TextureBlocksModElements instance) {
		super(instance, 1271);
	}
