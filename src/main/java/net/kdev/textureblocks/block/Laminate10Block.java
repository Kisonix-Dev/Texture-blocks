...
public class Laminate10Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_10")
	public static final Block block = null;

	public Laminate10Block(TextureBlocksModElements instance) {
		super(instance, 666);
	}
