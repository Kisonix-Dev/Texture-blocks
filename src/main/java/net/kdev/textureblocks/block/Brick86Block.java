...
public class Brick86Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:brick_86")
	public static final Block block = null;

	public Brick86Block(TextureBlocksModElements instance) {
		super(instance, 617);
	}
