...
public class Cobblestone9Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_9")
	public static final Block block = null;

	public Cobblestone9Block(TextureBlocksModElements instance) {
		super(instance, 156);
	}
