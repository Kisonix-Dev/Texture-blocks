...
public class Woodenplanks76Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:woodenplanks_76")
	public static final Block block = null;

	public Woodenplanks76Block(TextureBlocksModElements instance) {
		super(instance, 504);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woodenplanks_76");
		}
