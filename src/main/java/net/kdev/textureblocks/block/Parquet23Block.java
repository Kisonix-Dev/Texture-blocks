...
public class Parquet23Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_23")
	public static final Block block = null;

	public Parquet23Block(TextureBlocksModElements instance) {
		super(instance, 1058);
	}
