...
public class Panels88Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:panels_88")
	public static final Block block = null;

	public Panels88Block(TextureBlocksModElements instance) {
		super(instance, 1033);
	}
