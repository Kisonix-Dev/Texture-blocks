...
public class Cobblestone41Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:cobblestone_41")
	public static final Block block = null;

	public Cobblestone41Block(TextureBlocksModElements instance) {
		super(instance, 188);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_41");
		}
