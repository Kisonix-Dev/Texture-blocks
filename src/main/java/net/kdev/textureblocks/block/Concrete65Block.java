...
public class Concrete65Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_65")
	public static final Block block = null;

	public Concrete65Block(TextureBlocksModElements instance) {
		super(instance, 117);
	}
