...
public class Laminate77Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_77")
	public static final Block block = null;

	public Laminate77Block(TextureBlocksModElements instance) {
		super(instance, 733);
	}
