...
public class Linoleum35Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:linoleum_35")
	public static final Block block = null;

	public Linoleum35Block(TextureBlocksModElements instance) {
		super(instance, 787);
	}
