...
public class Concrete70Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_70")
	public static final Block block = null;

	public Concrete70Block(TextureBlocksModElements instance) {
		super(instance, 122);
	}
