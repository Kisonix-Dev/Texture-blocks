...
public class Marbletiles75Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_75")
	public static final Block block = null;

	public Marbletiles75Block(TextureBlocksModElements instance) {
		super(instance, 933);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletiles_75");
		}
