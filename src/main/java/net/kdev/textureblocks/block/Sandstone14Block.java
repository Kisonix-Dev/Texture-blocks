...
public class Sandstone14Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_14")
	public static final Block block = null;

	public Sandstone14Block(TextureBlocksModElements instance) {
		super(instance, 1268);
	}
