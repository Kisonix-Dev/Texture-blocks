...
public class Laminate63Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:laminate_63")
	public static final Block block = null;

	public Laminate63Block(TextureBlocksModElements instance) {
		super(instance, 719);
	}
