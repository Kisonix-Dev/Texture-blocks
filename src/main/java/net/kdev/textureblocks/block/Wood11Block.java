...
public class Wood11Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:wood_11")
	public static final Block block = null;

	public Wood11Block(TextureBlocksModElements instance) {
		super(instance, 343);
	}
