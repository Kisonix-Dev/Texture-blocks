...
public class Concrete71Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:concrete_71")
	public static final Block block = null;

	public Concrete71Block(TextureBlocksModElements instance) {
		super(instance, 123);
	}
