...
public class Marbletiles1Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_1")
	public static final Block block = null;

	public Marbletiles1Block(TextureBlocksModElements instance) {
		super(instance, 859);
	}
