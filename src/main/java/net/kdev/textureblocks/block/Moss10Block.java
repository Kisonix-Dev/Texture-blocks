...
public class Moss10Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:moss_10")
	public static final Block block = null;

	public Moss10Block(TextureBlocksModElements instance) {
		super(instance, 855);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ORGANIC).sound(SoundType.GROUND).hardnessAndResistance(1.5f, 6f).setLightLevel(s -> 0)
					.harvestLevel(1).harvestTool(ToolType.SHOVEL));
			setRegistryName("moss_10");
		}
