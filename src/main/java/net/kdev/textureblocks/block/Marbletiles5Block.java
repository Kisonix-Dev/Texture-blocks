...
public class Marbletiles5Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:marbletiles_5")
	public static final Block block = null;

	public Marbletiles5Block(TextureBlocksModElements instance) {
		super(instance, 863);
	}
