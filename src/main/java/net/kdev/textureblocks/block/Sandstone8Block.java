...
public class Sandstone8Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:sandstone_8")
	public static final Block block = null;

	public Sandstone8Block(TextureBlocksModElements instance) {
		super(instance, 1262);
	}
