...
public class Parquet71Block extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:parquet_71")
	public static final Block block = null;

	public Parquet71Block(TextureBlocksModElements instance) {
		super(instance, 1106);
	}
