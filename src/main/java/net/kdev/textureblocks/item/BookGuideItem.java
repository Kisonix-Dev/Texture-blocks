...
import net.kdev.textureblocks.gui.GuideGuiGuiWindow;
import net.kdev.textureblocks.gui.GuideGuiGui;
...
public class BookGuideItem extends TextureBlocksModElements.ModElement {
	@ObjectHolder("texture_blocks:book_guide")
	public static final Item block = null;

	public BookGuideItem(TextureBlocksModElements instance) {
		super(instance, 1);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof GuideGuiGuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(TextureBlocksItemGroup.tab).maxStackSize(1).rarity(Rarity.EPIC));
			setRegistryName("book_guide");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Book Guide");
					}
